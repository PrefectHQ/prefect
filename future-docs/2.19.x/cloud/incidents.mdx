...
![Incidents in the Prefect Cloud UI](/images/incidents1.png)
...
![An active incident in the Prefect Cloud UI](/images/incidents2.png)
...
3.  **Via an [automation](https://docs.prefect.io/concepts/automations/):**
...
See [Event Triggers](https://docs.prefect.io/concepts/automations/#custom-triggers) for more information on custom triggers, and check out your Event Feed to see the event types emitted by your incidents and other resources (i.e. events that you can react to).
</Tip>
