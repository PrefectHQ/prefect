...
*   Prefect [installed](https://docs.prefect.io/getting-started/installation/)
*   Authenticated with [Prefect Cloud](https://docs.prefect.io/cloud/cloud-quickstart/) (or self-hosted [Prefect server](https://docs.prefect.io/guides/host/) instance)
