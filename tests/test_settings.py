...
SUPPORTED_SETTINGS = {
    ...
    "PREFECT_SERVER_SERVICES_DOCKET_CONCURRENCY": {"test_value": 10},
    "PREFECT_SERVER_SERVICES_DOCKET_URL": {"test_value": "memory://"},
    "PREFECT_SERVER_SERVICES_DOCKET_WORKERS": {"test_value": 2},
