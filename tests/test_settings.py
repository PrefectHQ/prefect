...
SUPPORTED_SETTINGS = {
    ...
    "PREFECT_SERVER_SERVICES_WORKER_CLEANUP_QUEUE_BATCH_SIZE": {"test_value": 10},
    "PREFECT_SERVER_SERVICES_WORKER_CLEANUP_QUEUE_ENABLED": {"test_value": True},
    "PREFECT_SERVER_SERVICES_WORKER_CLEANUP_QUEUE_LOOP_SECONDS": {"test_value": 10.0},
