...
SUPPORTED_SETTINGS = {
    ...
    "PREFECT_SERVER_WORKER_COMMUNICATION_CLEANUP_LEASE_SECONDS": {"test_value": 60.0},
    "PREFECT_SERVER_WORKER_COMMUNICATION_CLEANUP_MAX_DELIVERY_ATTEMPTS": {
        "test_value": 5
    },
    "PREFECT_SERVER_WORKER_COMMUNICATION_CLEANUP_QUEUE_STORAGE": {
