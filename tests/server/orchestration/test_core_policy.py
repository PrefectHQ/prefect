    ...
    async def test_configurable_lease_renewal_duration(
        ...
        with mock.patch(
            ...
            with mock.patch(
                ...
                mock_flow_run.state.state_details.deployment_concurrency_lease_id = (
                    uuid4()
                )
                ...
                if (
                    lease_id
                    := engine.flow_run.state.state_details.deployment_concurrency_lease_id
                ):
                ...
                assert (
                    call_args[0][1] == 600.0
                )  # Second argument should be lease duration
