...
from prefect._internal.metrics import RunMetrics, _resolve_metrics_endpoint
...
class TestRunMetrics:
    ...
    def test_noop_when_no_endpoint(self, flow_run: MagicMock, flow: MagicMock):
        ...
        with (
            ...
            patch(
                "prefect._internal.metrics._resolve_metrics_endpoint",
...
class TestEngineIntegration:
    def test_engine_imports_run_metrics(self):
        ...
        assert "from prefect._internal.metrics import RunMetrics" in source
