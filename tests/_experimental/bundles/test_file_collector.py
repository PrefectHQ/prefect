...
from prefect.bundles._file_collector import (
    CollectionResult,
    FileCollector,
)
...
class TestLargeFileWarning:
    ...
    def test_large_file_warning_emitted(self, tmp_path, caplog):
        ...
        from prefect.bundles._file_collector import LARGE_FILE_THRESHOLD
...
class TestPreviewCollection:
    ...
    def test_preview_returns_files_list(self, tmp_path):
        ...
        from prefect.bundles._file_collector import preview_collection
    ...
    def test_preview_exported_in_all(self):
        ...
        from prefect.bundles import _file_collector
