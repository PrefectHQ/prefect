...
class TestParseBoolEnv:
    ...
    def test_truthy_values(self, monkeypatch):
        ...
        truthy_values = ["1", "true", "True", "TRUE", "t", "T", "yes", "Yes", "YES", "y", "Y", "on", "On", "ON"]
        
        for value in truthy_values:
            monkeypatch.setenv("TEST_FLAG", value)
            assert parse_bool_env("TEST_FLAG") is True, f"Expected {value!r} to be truthy"
    ...
    def test_falsy_values(self, monkeypatch):
        ...
        for value in falsy_values:
            monkeypatch.setenv("TEST_FLAG", value)
            assert parse_bool_env("TEST_FLAG") is False, f"Expected {value!r} to be falsy"
    ...
    def test_unknown_values_default_to_false(self, monkeypatch):
        ...
        for value in unknown_values:
            monkeypatch.setenv("TEST_FLAG", value)
            assert parse_bool_env("TEST_FLAG") is False, f"Expected {value!r} to default to False"
    ...
    def test_case_insensitive(self, monkeypatch):
        ...
        for value, expected in test_cases:
            monkeypatch.setenv("TEST_FLAG", value)
            assert parse_bool_env("TEST_FLAG") is expected, f"Expected {value!r} to be {expected}"
