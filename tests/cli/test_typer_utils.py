...
class TestPrefectTyper:
    ...
    app.add_typer(singular_subcommand, no_args_is_help=True)
    app.add_typer(pluralized_subcommand, no_args_is_help=True)
    app.add_typer(
        pluralized_subcommand,
        name="pluralized-subcommands",
        hidden=True,
    ...
    def test_unpluralized_subcommands_have_one_invocation(self):
        ...
        app.add_typer(self.singular_subcommand)
        app.add_typer(
            self.singular_subcommand,
            name="singular-subcommands",
            hidden=True,
            no_args_is_help=True,
        )
