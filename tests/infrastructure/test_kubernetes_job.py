        ...
        "properties": {
            ...
            "finished_job_ttl": {
                ...
                "description": (
                    ...
                    " finished jobs will be cleaned up by Kubernetes after the given"
                    " delay. If not set, jobs will be retained indefinitely."
                ),
                "type": "integer",
            },
            "job_watch_timeout_seconds": {
                ...
                "description": (
                    ...
                    " timing out. If not set, the worker will wait for each event"
                    " indefinitely."
                ),
                "type": "integer",
            },
