...
=== "Google Cloud Run"
    ...
    ![Configuring service account permissions in GCP](/2.11/img/guides/gcr-service-account-setup.png)
...
=== "Google Cloud Run"
    ...
    ![Configuring GCP Credentials block for use in cloud run push work pools](/2.11/img/guides/gcp-creds-block-setup.png)
...
=== "Google Cloud Run"
    ...
    Each step has several optional fields that are detailed in the [work pools](/2.11/concepts/work-pools/) documentation. For our purposes, select the block you created under the GCP Credentials field. This will allow Prefect Cloud to securely interact with your GCP project.

=== "AWS ECS"
      
    Each step has several optional fields that are detailed in the [work pools](/2.11/concepts/work-pools/) documentation. For our purposes, select the block you created under the AWS Credentials field. This will allow Prefect Cloud to securely interact with your ECS cluster.
...
![A flow running on a cloud run push work pool](/2.11/img/guides/push-flow-running.png)
