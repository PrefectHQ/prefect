...
3. [Install](/2.11/getting-started/installation/) Python and Prefect
...
The [`prefect.yaml`](/2.11/concepts/deployments/#managing-deployments) file is used by the `prefect deploy` command to deploy our flows.
