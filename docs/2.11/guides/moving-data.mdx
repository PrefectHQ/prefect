...
- Prefect [installed](/2.11/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.11/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.11/guides/host/) instance)
...
We can create [blocks](/2.11/concepts/blocks/) via the UI or Python code.
