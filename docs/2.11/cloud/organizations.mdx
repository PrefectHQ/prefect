...
- Expanded and customizable [Flow Run Retention Policy](/2.11/ui/flow-runs/#flow-run-retention-policy).
- [Single Sign-on (SSO)](/2.11/ui/sso/) authentication using your identity provider (Enterprise plans).
...
![Select the Organizations icon in Prefect Cloud.](/2.11/img/ui/organizations.png)
...
**Workspaces** shows you a list of [workspaces you can access within the organization](/2.11/ui/workspaces/). If you have been given the organization Admin role, you can create and manage workspaces here.

![Viewing the Organization workspaces page in Prefect Cloud.](/2.11/img/ui/org-workspaces.png)
...
![Viewing the Organization member page in Prefect Cloud.](/2.11/img/ui/org-members.png)
...
![Invite new members to an organization in Prefect Cloud.](/2.11/img/ui/org-invite-members.png)
...
[Service accounts](/2.11/ui/service-accounts/) enable you to create a Prefect Cloud API key that is not associated with a user account. Service accounts are typically used to configure API access for running agents or executing flow runs on remote infrastructure.
...
![Organization workspace sharing in Prefect Cloud.](/2.11/img/ui/org-workspace-sharing.png)
...
See the [Workspace sharing](/2.11/ui/workspaces/#workspace-sharing) documentation for more information.

## Organization and workspace roles

Prefect Cloud enables you to configure both [organization and workspace roles](/2.11/ui/roles/) for users.
...
![Organization roles in Prefect Cloud.](/2.11/img/ui/org-roles.png)
...
See the [Roles (RBAC)](/2.11/ui/roles/) documentation for more information on default and custom role permissions.

## Single Sign-on (SSO) <span class="badge enterprise"></span>

Prefect Cloud's [Organization and Enterprise plans](https://www.prefect.io/pricing) offer [single sign-on (SSO)](/2.11/ui/sso/) authentication integration with your team’s identity provider. SSO integration can bet set up with identity providers that support OIDC and SAML.

See the [Single Sign-on (SSO)](/2.11/ui/sso/) documentation for more information on default and custom role permissions.