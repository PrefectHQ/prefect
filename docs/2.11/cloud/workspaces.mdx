...
![Viewing a workspace dashboard in the Prefect Cloud UI.](/2.11/img/ui/cloud-new-workspace.png)

Select the **Workspaces Icon** to see all of the workspaces you can access. 

![Viewing all available workspaces in the Prefect Cloud UI.](/2.11/img/ui/all-workspaces.png)
...
- Workspaces in an [organization](/2.11/ui/organizations/) to which you've been invited and have been given access to organization workspaces.

!!! cloud-ad "Workspace-specific features"
    Each workspace keeps track of its own:

    - [Flow runs](/2.11/ui/flow-runs/) and task runs executed in an environment that is [syncing with the workspace](/2.11/ui/cloud/#workspaces)
    - [Flows](/2.11/concepts/flows/) associated with flow runs or deployments observed by the Prefect Cloud API
    - [Deployments](/2.11/concepts/deployments/)
    - [Work pools](/2.11/concepts/work-pools/)
    - [Blocks](/2.11/ui/blocks/) and [Storage](/2.11/concepts/storage/)
    - [Automations](../automations/)

Your user permissions within workspaces may vary. [Organizations](/2.11/ui/organizations/) can assign roles and permissions at the workspace level.
...
![Creating a new workspace in the Prefect Cloud UI.](/2.11/img/ui/create-workspace.png)
...
![Managing a workspace in the Prefect Cloud UI.](/2.11/img/ui/workspace-settings.png)
...
![Managing collaborators in a workspace in the Prefect Cloud UI.](/2.11/img/ui/workspace-collaborators.png)
...
Within a Prefect Cloud [organization](/2.11/ui/organizations/), Admins and workspace Owners may invite users and [service accounts](/2.11/ui/service-accounts/) to work in an organization workspace. In addition to giving the user access to the workspace, the Admin or Owner assigns a [workspace role](/2.11/ui/roles/) to the user. The role specifies the scope of permissions for the user within the workspace.
...
![Managing sharing in a workspace in the Prefect Cloud UI.](/2.11/img/ui/workspace-sharing.png)
...
![Initiating a workspace transfer in the Prefect Cloud UI.](/2.11/img/ui/workspace-transfer.png)
...
![Selecting a workspace transfer target in the Prefect Cloud UI.](/2.11/img/ui/workspace-transfer-options.png)
