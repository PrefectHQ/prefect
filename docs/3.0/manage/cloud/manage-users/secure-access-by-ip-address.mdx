...
IP allowlisting is an available upgrade on certain [Enterprise plans](https://www.prefect.io/pricing). 
IP allowlisting enables account admins to restrict access to Prefect Cloud APIs and UI at the network level. 
To learn more, please contact your account manager or reach the Prefect team at sales@prefect.io.
