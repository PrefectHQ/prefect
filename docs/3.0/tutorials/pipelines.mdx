...
- Your API requests run too slowly because you execute them in serial.
- Your API requests run too quickly and you get rate limited.
- You waste time and energy running the same task multiple times.
...
As an additional optimization, you can run multiple API requests in parallel.
