...
Some complexities related to READMEs specifically (these are domain specific and aren't of primary interest in this tutorial):

- How to deal with repositories that lack a README or that have multiple READMEs.
