...
In this quickstart, you will use Prefect to convert a Python script to a deployable workflow.

The following script takes a list of GitHub repositories and prints the number of stars each repository has:
...
This will create a [flow](/3.0/develop/write-flows/) and corresponding [tasks](/3.0/develop/write-tasks/). 
...
08:21:32.119 | INFO    | Flow run 'attentive-kestrel' - tensorflow/tensorflow: 186318 stars
