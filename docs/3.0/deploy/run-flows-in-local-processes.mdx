...
You can serve a flow loaded from remote storage with the same [`serve`](#serv3-a-flow) method as a local flow:
...
Learn more about work-pool based deployments in the [Configure dynamic infrastructure with work pools page](/3.0/deploy/infrastructure-concepts/work-pools)