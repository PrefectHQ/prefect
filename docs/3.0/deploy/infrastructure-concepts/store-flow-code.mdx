...
<Tabs>
  ...
  <Tab title="Azure Blob Storage container">
    ...
    if __name__ == "__main__":
        flow.from_source(
            source="azure://my-container/my-folder",  TK check format
            entrypoint="my_file.py:my_flow",
        ).deploy(
    ...
    if __name__ == "__main__":
        ...
        source = AzureBlobStorage.load("my-code-storage-block")
  ...
  <Tab title="GCP GCS bucket">
    ...
    if __name__ == "__main__":
        flow.from_source(
            source="gcs://my-bucket/my-folder",  TK check format
            entrypoint="my_file.py:my_flow",
        ).deploy(
    ...
    if __name__ == "__main__":
        ...
        source = GCSBucket.load("my-code-storage-block")
