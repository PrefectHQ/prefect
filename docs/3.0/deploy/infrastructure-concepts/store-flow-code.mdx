...
All Python-based deployment creation requires 
...
For a public repository, you can use the repository repository URL directly.
...
<Tabs>
  <Tab title="GitHub">
    ...
    ```python my_gh_repo_deploy_no_credentials_passed_explicitly.py
  ...
  <Tab title="Bitbucket">
    ...
    ```python my_bb_repo_deploy_no_credentials_passed_explicitly.py
    from prefect import flow
