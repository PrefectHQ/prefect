...
### Create a deployment in Python with a local `serve` method

This is a great way to get started with deployments.
...
The process runs locally and waits to pick up scheduled flow runs from the server.
...
Data platform teams find work pools especially useful for managing infrastructure configuration across teams.
