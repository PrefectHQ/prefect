---
title: Contributing
description: Thanks for considering contributing to Prefect!
---
...
Migrations will be generated for whatever database type `PREFECT_API_DATABASE_CONNECTION_URL` is set to. See [here](/2.10.21/concepts/database/#configuring-the-database)
