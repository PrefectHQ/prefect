---
title: Filesystems
description: A filesystem block is an object that allows you to read and write data from paths. Prefect provides multiple built-in file system types that cover a wide range of use cases. 
---
...
Additional file system types are available in [Prefect Collections](/2.10.21/collections/catalog/).
