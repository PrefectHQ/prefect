...
After you grant approval to connect, you'll be redirected to the CLI and the API key will be saved to your local [Prefect profile](/3.0rc/cloud/configure-client/).
...
See the [service accounts](/3.0rc/cloud/manage-users/service-accounts/) documentation for more information about creating and managing service accounts in Prefect Cloud.
