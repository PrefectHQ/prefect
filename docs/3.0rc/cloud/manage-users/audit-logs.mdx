...
Audit logs can identify changes in:
...
![Viewing audit logs for an account in the Prefect Cloud UI.](/3.0rc/img/ui/audit-log.png)
...
You may also filter audit logs by date range. Audit log retention period varies by [Prefect Cloud plan](https://www.prefect.io/pricing).
