...
[configure an execution environment](/3.0rc/cloud/connect-to-cloud/#configure-a-local-execution-environment) 
...
[added to a workspace](/3.0rc/cloud/workspaces/#workspace-sharing).
</Note>
