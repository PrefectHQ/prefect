...
![Viewing all available workspaces in the Prefect Cloud UI.](/3.0rc/img/ui/all-workspaces.png)
...
!!! cloud-ad "Workspace-specific features"
    ...
    - [Flow runs](/3.0rc/cloud/flow-runs/) and task runs executed in an environment that is [syncing with the workspace](/3.0rc/cloud/cloud/#workspaces)
    - [Flows](/3.0rc/concepts/flows/) associated with flow runs or deployments observed by the Prefect Cloud API
    - [Deployments](/3.0rc/concepts/deployments/)
    - [Work pools](/3.0rc/concepts/work-pools/)
    - [Blocks](/3.0rc/cloud/blocks/)
    - [Automations](/3.0rc/concepts/automations/)
...
![Creating a new workspace in the Prefect Cloud UI.](/3.0rc/img/ui/create-workspace.png)
...
![Managing a workspace in the Prefect Cloud UI.](/3.0rc/img/ui/workspace-settings.png)
...
Within a Prefect Cloud Pro or Custom tier account, Workspace Owners can invite other people to be members and provision [service accounts](/3.0rc/cloud/service-accounts/) to a workspace.
In addition to giving the user access to the workspace, a Workspace Owner assigns a [workspace role](/3.0rc/cloud/roles/) to the user.
...
![Managing sharing in a workspace in the Prefect Cloud UI.](/3.0rc/img/ui/workspace-sharing.png)
...
![Initiating a workspace transfer in the Prefect Cloud UI.](/3.0rc/img/ui/workspace-transfer.png)
