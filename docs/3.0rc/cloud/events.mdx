...
Events enable observability into your data stack via the [event feed](/3.0rc/ui/events/#event-feed), and the configuration of Prefect's reactivity via [automations](/3.0rc/concepts/automations/).
