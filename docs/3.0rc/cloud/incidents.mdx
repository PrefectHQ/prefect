...
![Incidents in the Prefect Cloud UI](/3.0rc/img/ui/incidents-dashboard.png)
...
![An active incident in the Prefect Cloud UI](/3.0rc/img/ui/incidents-active.png)
...
3. **Via an [automation](/3.0rc/concepts/automations/):**
...
!!! tip "Building custom triggers"
    ...
    See [Event Triggers](/3.0rc/concepts/automations/#custom-triggers) for more information on custom triggers, and check out your Event Feed to see the event types emitted by your incidents and other resources (i.e. events that you can react to).
