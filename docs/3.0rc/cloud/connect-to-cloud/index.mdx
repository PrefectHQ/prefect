...
You can log in with either an [API key](/3.0rc/cloud/manage-users/api-keys/) or through a browser.
...
See [Settings](/3.0rc/cloud/configure-client/) for details.

<Note>
**Environment variables**

You can set `PREFECT_API_URL` and `PREFECT_API_KEY` just like any other environment variable. 
See [Overriding defaults with environment variables](/3.0rc/cloud/configure-client/#overriding-defaults-with-environment-variables) 
