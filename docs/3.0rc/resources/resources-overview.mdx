---
title: Overview
description: Learn how to do other things with Prefect.
---

The **Resources** section contains helpful examples for specific operations.
...
- [Access third-party secrets](/3.0rc/resources/secrets) demonstrates how to access third-party secrets without storing credentials in blocks.