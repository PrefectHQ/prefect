...
Use the Prefect CLI you to execute and schedule shell commands as Prefect flows. 
This guide explains how to use the `watch` and `serve` commands with the CLI for automation tasks, 
including how to:
...
[deployment](/3.0rc/deploy/serve-workflows/) for regular execution. 
...
[concurrency limits](/3.0rc/develop/control-workflows/global-concurrency-limits/), 
