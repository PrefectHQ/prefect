...
State changes and logs in the Prefect UI are now eventually consistent, this trade-off enables the substantial performance gains and increased workflow scale that Prefect 3 delivers.
