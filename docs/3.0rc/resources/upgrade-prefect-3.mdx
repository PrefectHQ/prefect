...
Some modules have been renamed, reorganized, or removed for clarity. Objects imported from changed modules will continue to work until their six month deprecation period ends, but will raise deprecation warnings. Here are the corresponding modules in Prefect 3:
