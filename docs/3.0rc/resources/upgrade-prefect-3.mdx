...
Some modules have been renamed, reorganized, or removed for clarity. If you use a module that has changed, it will continue to work, but it will raise deprecation warnings. 
You will need to update these modules before the six month deprecation period ends:
