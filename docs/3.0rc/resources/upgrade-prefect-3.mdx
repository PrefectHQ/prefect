...
The notifications feature in Prefect 2 has been vastly expanded to enable all kinds of “if this, then that” logic that can be defined and executed by a Prefect server instance or Prefect Cloud
...
We reccomend using the extras on the `prefect` package to ensure that you install the version (e.g. `pip install prefect[aws]`) of the integration that corresponds to your Prefect version.
