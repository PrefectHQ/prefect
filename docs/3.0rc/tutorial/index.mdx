...
1. [Create a flow](/3.0rc/develop/write-workflows/)
2. [Add tasks to it](/3.0rc/develop/write-tasks/)
3. [Deploy and run the flow locally](/3.0rc/deploy/serve-workflows/)
4. [Create a work pool and run the flow on remote infrastructure](/3.0rc/tutorial/work-pools/)
5. [Create a worker-based deployment](/3.0rc/deploy/dynamic-infra/push-runs-remote/) (For advanced users who need more governance.)
...
See the [install guide](/3.0rc/get-started/install/) for more detailed instructions.
...
1. Use the `prefect cloud login` CLI command to [authenticate to Prefect Cloud](/3.0rc/cloud/manage-users/api-keys/) from your environment.
...
As an alternative to using Prefect Cloud, you can self-host a [Prefect server instance](/3.0rc/cloud/self-host/).
If you choose this option, run `prefect server start` to start a local Prefect server instance.

## First steps: Flows

Learn how to create your first [Prefect flow](/3.0rc/develop/write-workflows/).
