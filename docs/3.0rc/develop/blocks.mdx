...
| Discord Webhook                                                | Calls Discord webhooks.                                                |                                  |
| Kubernetes Cluster Config   | <span class="no-wrap">`kubernetes-cluster-config`</span> | Stores configuration for interaction with Kubernetes clusters.                                 |
