...
### Slot decay
To implement rate limiting, you can configures"slot decay", which determines how rapidly used slots are freed up for new tasks.
...
Choose a decay rate that balances your needed frequency of task execution with the acceptable limit of overall system load. This allows you to fine-tune your workflow's performance and resource usage.
