...
All three of these steps can be configured.

### Result storage

You can configure the system of record for your results through the `result_storage` keyword argument.
This keyword accepts any [filesystem block](blocks) or a block document slug. 
...
This can also be configured as an environment variable:
...
You can configure how results are serialized to disk using result serializers.
