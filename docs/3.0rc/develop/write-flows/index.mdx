...
These arguments defined on your flow function are called [parameters](/3.0rc/develop/write-flows/#parameters) and are stored by the Prefect orchestration engine on the flow run object.
