...
- Use automatic [logging](/3.0rc/develop/observe-flows/logging/) to capture runtime details, tags, 
and final state
...
This concurrency greatly enhances the efficiency and performance of your flows.
...
If you just need the result from a task, call the task from your flow. For most flows, 
