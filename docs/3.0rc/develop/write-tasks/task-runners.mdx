...
description: Learn how to use Prefect task runners for concurrent, parallel or distributed execution of tasks.
---
...
Execution of a task function blocks execution of its flow until the task completes. 
