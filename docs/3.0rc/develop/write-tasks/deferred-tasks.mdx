...
This document focuses on how to use deferred task execution. Prefect tasks also support other advanced use cases, such as running tasks in parallel on Ray or Dask clusters, caching return values, configuring automatic retries, and building workflows with task dependencies.
