...
application and distribute concurrent execution across across multiple processes or machines.
...
flows. For example, by calling `my_task.delay()` within a web application.
</Note>
