...
Caching allows you to efficiently reuse [results of tasks](results) that may be expensive to compute
...
See [managing results](results) for more details on managing your result configuration, and
