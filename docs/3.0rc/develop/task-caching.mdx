...
Caching allows you to efficiently reuse [results of tasks](/3.0rc/develop/results/) that may be expensive to compute
...
See [managing results](/3.0rc/develop/results/) for more details on managing your result configuration, and
[settings](/3.0rc/manage/settings-and-profiles) for more details on managing Prefect settings.
</Warning>
