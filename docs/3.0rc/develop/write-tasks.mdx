...
See all possible options in the [Python SDK API docs](https://prefect-python-sdk-docs.netlify.app/prefect/tasks/#prefect.tasks.task).
...
These can be set using the `cache_policy` keyword on the [task decorator](https://prefect-python-sdk-docs.netlify.app/prefect/tasks/#prefect.tasks.task):
