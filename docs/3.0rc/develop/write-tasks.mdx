...
<<<<<<< HEAD:docs/3.0rc/develop/write-tasks/index.mdx
```python hl_lines="6 11" continuation
=======
```python 
>>>>>>> main:docs/3.0rc/develop/write-tasks.mdx
def get_open_issues(repo_name: str, open_issues_count: int, per_page: int = 100):
    issues = []
    pages = range(1, -(open_issues_count // -per_page) + 1)
    for page in pages:
...
<<<<<<< HEAD:docs/3.0rc/develop/write-tasks/index.mdx
```python hl_lines="1" continuation
=======
```python 
>>>>>>> main:docs/3.0rc/develop/write-tasks.mdx
...
<<<<<<< HEAD:docs/3.0rc/develop/write-tasks/index.mdx
```python hl_lines="4" continuation
=======
```python 
>>>>>>> main:docs/3.0rc/develop/write-tasks.mdx
from prefect import task
