...
Override any logging configuration by setting an environment variable or [Prefect Profile](/3.0rc/cloud/configure-client/) setting using the syntax `PREFECT_LOGGING_[PATH]_[TO]_[KEY]`, with `[PATH]_[TO]_[KEY]` corresponding to the nested address of any setting.
