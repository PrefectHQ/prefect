---
title: Get information for runtime context
...
This works for runtime attributes of basic types (`bool`, `int`, `float` and `str`) and `pendulum.DateTime`. 
...
See the [runtime API reference](/3.0rc/api-ref/prefect/runtime/flow_run/) for a full list of available attributes.
