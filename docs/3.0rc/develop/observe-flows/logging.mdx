...
Prefect server with `prefect server start`. View and filter logs in the [UI](/3.0rc/cloud/flow-runs/#inspect-a-flow-run) or 
...
See logs for a flow run in the UI by navigating to the [**Flow runs**](/3.0rc/cloud/flow-runs/#inspect-a-flow-run) 
...
Prefect provides several settings to configure [logging level and loggers](/3.0rc/develop/observe-flows/logging/).
...
Override any logging configuration by setting an environment variable or [Prefect profile](/3.0rc/cloud/configure-client/) 
...
[Settings](/3.0rc/cloud/configure-client/) for more details about how to use settings.
