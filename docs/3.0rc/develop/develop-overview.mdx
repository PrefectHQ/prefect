...
This section of the docs discusses how to write code with Prefect objects to create workflows you can trust. 
...
- [Run taks in the background](/develop/task-runners/) explains how you can use tasks to execute small, discrete units of work quickly, obviating the need for a full flow or a tool such as Celery.
- [Log run activity](/develop/logging/) shows you how to Ccpture fine-grained information about flows and tasks for monitoring, troubleshooting, and auditing.
...
The **Manage concurrency** section discusses speeding up your workflows and limiting them with concurrency.
...
Finally, [Test workflows](/develop/test-workflows/) discusses conveniences for testing workflows.