...
These pages explains how to develop Prefect workflows. 

The **Write and run workflows** section contains information for getting started with Prefect's core objects.

- [Write and run flows](/3.0rc/write-flows/) introduces the most central Prefect object, the `flow`. 
- [Write and run tasks](/3.0rc/write-tasks/) shows you how to create `task` decorated functions that represent a discrete unit of work in a Prefect workflow.
