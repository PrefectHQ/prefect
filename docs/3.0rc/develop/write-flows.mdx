...
- Each [state](/3.0rc/develop/manage-states/) the flow enters is recorded. This
allows you to observe and [act upon each transition](/3.0rc/develop/manage-states#execute-code-on-state-changes) in the flow's execution.
