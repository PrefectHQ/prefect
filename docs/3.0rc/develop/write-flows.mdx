...
- Have [installed Prefect](/3.0rc/get-started/install)
- Have [connected to Prefect Cloud](/3.0rc/manage/cloud/connect-to-cloud) or a [self-hosted server instance](/3.0rc/manage/self-host)
</Tip>
...
You can create a flow run by calling a flow manually.
...
There are no rigid rules for what code you include within a flow definition. 
All valid Python is acceptable.
...
Each task should represent a single logical step of your workflow. 
