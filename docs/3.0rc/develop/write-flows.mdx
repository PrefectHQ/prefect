...
Prefect enables you to log a variety of useful information about your flow runs. 
You can [log run metadata](/3.0rc/develop/logging) for monitoring, troubleshooting, and auditing purposes.
</Tip>
