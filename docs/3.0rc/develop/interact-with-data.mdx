---
title: Read and write data with a cloud provider
...
- Authenticated with [Prefect Cloud](/3.0rc/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/3.0rc/cloud/self-host/) instance)
