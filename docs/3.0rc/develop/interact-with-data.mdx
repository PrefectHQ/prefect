...
Check out the [`prefect-aws`](/ntegrations/prefect-aws/), [`prefect-azure`](/integrations/prefect-azure/), and [`prefect-gcp`](/integrations/prefect-gcp/) docs to see additional methods for interacting with cloud storage providers.
