...
[block-based deployment](/3.0rc/deploy/prefect-yaml/#block-based-deployments) YAML files.
...
You can add one or more schedules to any [served or deployed](/3.0rc/deploy/static-infra/push-runs-remote/) flow.
...
[block-based deployment](/3.0rc/deploy/prefect-yaml/#block-based-deployments) YAML file:
...
For example, the following RRule schedule in a [block-based deployment](/3.0rc/deploy/prefect-yaml/#block-based-deployments) 
