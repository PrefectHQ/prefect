...
You can add one or more schedules to any [served or deployed](/3.0rc/deploy/static-infra/index) flow.
...
my_flow.serve(name="flowing", schedule=IntervalSchedule(interval=timedelta(minutes=10), anchor_date=datetime(2026, 1, 1, 0, 0), 
