...
[block-based deployment](/3.0rc/deploy/dynamic-infra/prefect-deploy/#block-based-deployments) YAML files.

Support for multiple schedules in `flow.serve`, `flow.deploy`, `serve`, and [worker-based deployments](/3.0rc/deploy/dynamic-infra/workers/) 
with `prefect deploy` will arrive soon.
</Tip>

Schedules automatically create new flow runs for deployed or served flows. 
You can add one or more schedules to any [served or deployed](/3.0rc/deploy/dynamic-infra/prefect-deploy/) flow.
...
[block-based deployment](/3.0rc/deploy/dynamic-infra/prefect-deploy/#block-based-deployments) YAML file:
...
For example, the following RRule schedule in a [block-based deployment](/3.0rc/deploy/dynamic-infra/prefect-deploy/#block-based-deployments) 
...
- If using [worker-based deployments](/3.0rc/deploy/dynamic-infra/workers/)
...
If you are using [worker-based deployments](/3.0rc/deploy/dynamic-infra/workers/), you can create a schedule through the 
...
See the [Settings docs](/3.0rc/manage/configure-client/) for more information on altering your settings.
