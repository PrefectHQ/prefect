...
You can add one or more schedules to any [served or deployed](/3.0rc/deploy/run-flows-in-local-processes) flow.
...
- If using [worker-based deployments](/3.0rc/deploy/infrastructure-concepts/workers/)
