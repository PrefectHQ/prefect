...
Support for multiple schedules in `flow.serve`, `flow.deploy`, `serve`, and [worker-based deployments](/3.0rc/deploy/workers/) 
...
- If using [worker-based deployments](/3.0rc/deploy/workers/)
...
If you are using [worker-based deployments](/3.0rc/deploy/workers/), you can create a schedule through the 
