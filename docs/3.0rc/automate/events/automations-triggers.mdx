...
This example shows how to use triggers to schedule a downstream deployment when an upstream deployment completes.
...
First, start the `serve` process to listen for scheduled runs of your deployments:
