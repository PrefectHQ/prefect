...
[events](/3.0rc/react/understand-events/) for use in [automations](/3.0rc/react/understand-events/automations-triggers/).
...
[authentication methods](/3.0rc/cloud/connect-to-cloud#manually-configure-prefect-api-settings) you use with Prefect
Cloud.
...
As with the [templates available in Prefect Cloud Automation](/3.0rc/react/understand-events/automations-triggers) for
...
this phase, lean upon the [event feed](/3.0rc/react/understand-events/#event-feed) in the UI to see events as they happen.
