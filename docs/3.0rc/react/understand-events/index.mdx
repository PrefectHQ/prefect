---
title: Events
# TODO: Idealy "Understand events" loads this page directly
---
...
Generally, events have a consistent and informative grammar&mdash;an event describes a resource and an action that the resource took or that was taken on that resource. For example, events emitted by Prefect objects take the form of:
