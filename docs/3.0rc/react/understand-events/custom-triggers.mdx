---
title: Use custom triggers for automations
...
Event triggers are the most common types of trigger. They are intended to react to the presence or absence of an event 
...
You may compose any type of trigger into higher-order composite triggers, including proactive event triggers and metric 
