...
Cloud](/3.0rc/cloud/connect-to-cloud#manually-configure-prefect-api-settings).
...
this phase, you may find the [Event Feed](/3.0rc/react/understand-events/#event-feed) in the UI to be
