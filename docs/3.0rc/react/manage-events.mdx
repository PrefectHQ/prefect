...
# TODO: Rename file as incidents.mdx
---
...
Incidents are formal declarations of disruptions to a workspace. With [automations](#incident-automations), activity in a workspace can be paused when an incident is created and resumed when the incident is resolved.
...
Incorporating incidents into your Prefect workflow facilitates many common needs:
