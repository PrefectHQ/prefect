...
3. **Via an [automation](/3.0rc/react/understand-events/automations-triggers/):**
...
!!! tip "Building custom triggers"
    ...
    See [Event Triggers](/3.0rc/react/understand-events/automations-triggers/#custom-triggers) for more information on custom triggers, and check out your Event Feed to see the event types emitted by your incidents and other resources (i.e. events that you can react to).
