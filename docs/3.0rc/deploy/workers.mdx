...
See how to [daemonize a Prefect worker](/3.0rc/deploy/static-infra/push-runs-remote/).

See more information on [overriding a work pool's job variables](/3.0rc/deploy/customize).
