...
Prefect Cloud provides a Prefect Managed work pool option that is the simplest way to run flows remotely.
...
If you need more control over your infrastructure, want to run your flows in Kubernetes, or are running a self-hosted Prefect 
