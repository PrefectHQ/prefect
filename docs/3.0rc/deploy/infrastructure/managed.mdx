---
title: Run flows on Prefect Managed infra
...
1. With your [CLI authenticated to your Prefect Cloud workspace](/3.0rc/manage/cloud/manage-users/api-keys/), run the script to create your deployment:
...
Read more about creating deployments in the [deployment guide](/3.0rc/deploy/infrastructure/docker/).

For more control over your infrastructure, such as the ability to run 
custom Docker images, [serverless push work pools](/3.0rc/deploy/infrastructure/serverless/) 
