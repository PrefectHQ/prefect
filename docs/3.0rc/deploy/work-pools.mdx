...
[Serve flows](/3.0rc/deploy/static-infra/index/) shows how to create a deployment with a long-running process using `.serve`, 
and how to move to a [work pool deployment](/3.0rc/deploy/static-infra/push-runs-remote/) setup with `.deploy`.
