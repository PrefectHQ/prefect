...
[Deployments](/3.0rc/deploy/infrastructure/docker/) are server-side representations of flows. 
...
- dynamically provision infrastructure using [workers](/3.0rc/deploy/infrastructure/docker)
...
Options for [serverless work pools](/3.0rc/deploy/infrastructure/serverless/) allow you to 
scale to zero when workflows aren't running.
Prefect even provides you with the ability to 
[provision cloud infrastructure via a single CLI command](/3.0rc/deploy/infrastructure/serverless/#automatically-create-a-new-push-work-pool-and-provision-infrastructure), 
