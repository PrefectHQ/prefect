...
[provision cloud infrastructure via a single CLI command](/3.0rc/deploy/dynamic-infra/push-runs-serverless/#automatically-create-a-new-push-work-pool-and-provision-infrastructure), 
