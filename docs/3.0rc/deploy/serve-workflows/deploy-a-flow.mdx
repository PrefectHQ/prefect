...
Because this deployment has no schedule or triggering automation, you must use the UI or API to create 
runs for it.
...
Because deployments are nothing more than metadata, you can create runs at anytime.
...
anytime the flow or task runs, allowing you to audit your changes.
</Tip>
