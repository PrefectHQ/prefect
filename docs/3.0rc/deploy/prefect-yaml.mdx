...
| `triggers`                                  | An optional array of [triggers](/3.0rc/automate/events/automations-triggers/#custom-triggers) to assign to the deployment |
...
| `job_variables`                                | Values used to override the default values in the specified work pool's [base job template](/3.0rc/deploy/work-pools/#base-job-template). Maps directly to a created deployments `infra_overrides` attribute. |
...
- [Push work pools](/3.0rc/deploy/infrastructure-examples/serverless/)
- [Kubernetes work pools](/3.0rc/deploy/infrastructure-examples/kubernetes/)
- [Serverless hybrid work pools](/3.0rc/deploy/infrastructure-examples/docker/)
