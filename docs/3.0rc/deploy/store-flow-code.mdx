...
To create deployments with Python code, see the [work pools and workers guide](/3.0rc/deploy/static-infra/push-runs-remote/#creating-work-pool-based-deployments-with-deploy).
...
Another authentication option is to give the [worker](/3.0rc/deploy/workers/) access 
