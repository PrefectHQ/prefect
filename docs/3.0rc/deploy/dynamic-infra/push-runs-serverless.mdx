---
title: Deploy to serverless infrastructure
...
Push [work pools](/3.0rc/deploy/dynamic-infra/work-pools/) are a special type of work pool. They allow 
...
<Tabs>
  <Tab title="AWS ECS">
    ...
    Each step has several optional fields that are detailed in the
     [work pools documentation](/3.0rc/deploy/dynamic-infra/work-pools/). 
 ...
 <Tab title="Google Cloud Run">
    ...
    Each step has several optional fields that are detailed in the 
    [work pools guide](/3.0rc/deploy/dynamic-infra/work-pools/). 
...
You need to configure your [deployment](/3.0rc/deploy/dynamic-infra/prefect-deploy/) to send flow runs to your push work pool.
...
pools and workers](/3.0rc/deploy/dynamic-infra/prefect-deploy/#creating-work-pool-based-deployments-with-deploy) guide.
