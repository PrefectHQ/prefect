...
You need to configure your [deployment](/3.0rc/deploy/dynamic-infra/push-runs-remote/) to send flow runs to your push work pool.
...
Learn about installing dependencies at runtime or baking them into your Docker image in the [Deploy to Docker](/3.0rc/deploy/dynamic-infra/push-runs-remote#automatically-build-a-custom-docker-image-with-a-local-dockerfile) guide.
