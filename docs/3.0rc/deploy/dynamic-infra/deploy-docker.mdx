...
The [Deployments](/3.0rc/deploy/dynamic-infra/prefect-deploy/) guide showed how to serve a flow on a schedule.
...
deployment from the [Deployments](/3.0rc/deploy/dynamic-infra/prefect-deploy/) guide.
...
from the [Deployments](/3.0rc/deploy/dynamic-infra/prefect-deploy/) guide in it.
...
See the [Work pool deployment guide](/3.0rc/deploy/dynamic-infra/prefect-deploy) 
to build custom images with dependencies specified in a `requirements.txt` file.

By default, Prefect [work pools](/3.0rc/deploy/dynamic-infra/work-pools) 
...
- To learn more about deploying flows, check out the [Deployments](/3.0rc/deploy/dynamic-infra/prefect-deploy/) 
concept doc.
- For advanced infrastructure requirements, such as executing each flow run within its own dedicated 
Docker container, learn more in the [Work pool deployment guide](/3.0rc/deploy/dynamic-infra/prefect-deploy).
