...
Prefect builds a custom Docker image containing your workflow code. The worker can use it to dynamically spawn Docker 
...
Learn more about [workers and work pools](/3.0rc/deploy/dynamic-infra/control-runs/).

Learn about installing dependencies at runtime or baking them into your Docker image in the 
[work pools and workers guide](/3.0rc/guides/prefect-deploy/#creating-work-pool-based-deployments-with-deploy).
