...
!!! note "Push work pools don't require a worker"
    ...
    Read more in the [Serverless Push Work Pool Guide](/3.0rc/guides/deployment/push-work-pools/).
...
Learn more about workers and work pools in the [Prefect concept documentation](/3.0rc/concepts/work-pools/).
...
We will leverage systemd and see how to automatically start a [Prefect worker](/3.0rc/concepts/work-pools/#worker-overview) or long-lived [`serve` process](/3.0rc/concepts/flows/#serving-a-flow) when Linux starts.
...
* If daemonizing a worker, you'll need a Prefect [deployment](/3.0rc/concepts/deployments/) with a [work pool](/3.0rc/concepts/work-pools/) your worker can connect to.
