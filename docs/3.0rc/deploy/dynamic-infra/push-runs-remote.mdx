...
default values in the specified work pool's [base job template](/3.0rc/deploy/work-pools/#base-job-template).
...
- [Deploy flows on serverless infrastructure](/3.0rc/deploy/static-infra/push-runs-remote/)
