...
3. [Install](/3.0rc/getting-started/installation/) Python and Prefect
...
[Work pools](/3.0rc/concepts/work-pools/) allow you to manage deployment infrastructure.
...
To learn about the Python deployment creation method with `flow.deploy` refer to the [Workers & Work Pools tutorial page](/3.0rc/tutorial/workers/).

The [`prefect.yaml`](/3.0rc/concepts/deployments/#managing-deployments) file is used by the `prefect deploy` command to deploy our flows.
