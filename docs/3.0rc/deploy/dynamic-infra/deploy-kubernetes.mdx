...
[Work pools](3.0rc/deploy/dynamic-infra/work-pools/) allow you to manage deployment 
infrastructure.
...
[Workers](/3.0rc/deploy/static-infra/push-runs-remote/).

The [`prefect.yaml`](/3.0rc/deploy/dynamic-infra/prefect-deploy/#managing-deployments) file is used 
