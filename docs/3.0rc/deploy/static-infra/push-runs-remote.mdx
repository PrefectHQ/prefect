...
Different [worker types](/3.0rc/deploy/dynamic-infra/workers/#worker-types) create different types of flow run 
infrastructure.
</Tip>
...
There are [work pool types](/3.0rc/deploy/dynamic-infra/work-pools/#work-pool-types) for serverless computing 
...
default values in the specified work pool's [base job template](/3.0rc/deploy/dynamic-infra/work-pools/#base-job-template).
...
- Learn how to configure deployments in YAML with [`prefect.yaml`](/3.0rc/deploy/dynamic-infra/prefect-deploy/).
...
- [Deploy flows on serverless infrastructure](/3.0rc/deploy/duynamic-infra/push-runs-serverless/)
...
Learn more about [work pools](/3.0rc/deploy/dynamic-infra/work-pools/) and [workers](/3.0rc/deploy/dynamic-infra/workers/).

Learn about installing dependencies at runtime or baking them into your Docker image in the 
[work pools and workers guide](/3.0rc/deploy/dynamic-infra/prefect-deploy/#creating-work-pool-based-deployments-with-deploy).
