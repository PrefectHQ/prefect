...
Push [work pools](/3.0rc/deploy/work-pools/) are a special type of work pool. They allow 
...
<Tabs>
  <Tab title="AWS ECS">
    ...
    Each step has several optional fields that are detailed in the
     [work pools documentation](/3.0rc/deploy/work-pools/). 
 ...
 <Tab title="Google Cloud Run">
    ...
    Each step has several optional fields that are detailed in the 
    [work pools guide](/3.0rc/deploy/work-pools/). 
...
Learn more about [work pools](/3.0rc/deploy/work-pools/) and [workers](/3.0rc/deploy/workers/).
