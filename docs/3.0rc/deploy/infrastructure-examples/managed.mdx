...
Managed execution requires that you run the official Prefect Docker image: `prefecthq/prefect:3rc-latest`. 
...
Read more about creating deployments in [Run flows in Docker containers](/3.0rc/deploy/infrastructure-examples/docker/).

For more control over your infrastructure, such as the ability to run 
custom Docker images, [serverless push work pools](/3.0rc/deploy/infrastructure-examples/serverless/) 
