...
You can use [Prefect Cloud](/3.0rc/cloud/cloud/) as your API server or [host your own Prefect server instance](/3.0rc/guides/host/) backed by [PostgreSQL](/3.0rc/concepts/database/#configuring_a_postgresql_database).
...
<Note>
    Note that in production we recommend using [Prefect Cloud](/3.0rc/cloud/cloud/) as your API server or [hosting your own Prefect server instance](/3.0rc/guides/host/) backed by [PostgreSQL](/3.0rc/concepts/database/#configuring_a_postgresql_database).
</Note>
<Info>
