...
The `PREFECT_API_KEY` value specifies the [API key](/3.0rc/ui/cloud-api-keys/#create-an-api-key) used to authenticate with Prefect Cloud.
...
If running a self-hosted Prefect server instance, there are several [database configuration settings](/3.0rc/host/) to consider.

### Logging settings

Prefect provides several [logging configuration settings](/3.0rc/concepts/logs/).
