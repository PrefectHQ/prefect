...
View and filter logs in the [UI](/3.0rc/ui/flow-runs/#inspect-a-flow-run) or access log records through the API.
...
See logs for a flow run in the UI by navigating to the [**Flow Runs**](/3.0rc/ui/flow-runs/#inspect-a-flow-run) page and selecting a specific flow run to inspect.
...
Prefect provides several settings to configure [logging level and loggers](/3.0rc/concepts/logs/).
