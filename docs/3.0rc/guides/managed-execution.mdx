...
With your [CLI authenticated to your Prefect Cloud workspace](/3.0rc/cloud/manage-users/api-keys/), run the script to create your deployment:
...
Read more about creating deployments in the [deployment guide](/3.0rc/guides/prefect-deploy/).
...
Read more [here](/3.0rc/deploy/dynamic-infra/push-runs-serverless/).
