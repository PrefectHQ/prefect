...
With your [CLI authenticated to your Prefect Cloud workspace](/3.0rc/cloud/users/api-keys/), run the script to create your deployment:
...
Read more [here](/3.0rc/guides/deployment/push-work-pools/).
