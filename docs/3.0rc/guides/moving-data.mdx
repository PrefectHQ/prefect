...
- Authenticated with [Prefect Cloud](/3.0rc/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/3.0rc/guides/host/) instance)
...
You can create [blocks](/3.0rc/concepts/blocks/) through the UI or Python code.
