...
[events](/3.0rc/cloud/events/) for use in [automations](/3.0rc/cloud/automations/).
...
Cloud](/3.0rc/cloud/connecting#manually-configure-prefect-api-settings).

### Through Prefect Cloud

You can create and manage webhooks from the Prefect Cloud UI.

![Managing a webhook in the Prefect Cloud UI.](/3.0rc/img/ui/webhook.png)
...
As with the [templates available in Prefect Cloud Automation](/3.0rc/cloud/automations) for
...
this phase, you may find the [Event Feed](/3.0rc/cloud/events/#event-feed) in the UI to be
