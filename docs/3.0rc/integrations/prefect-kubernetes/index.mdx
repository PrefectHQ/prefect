...
This library is most commonly used to installation with a Kubernetes worker. See the [Kubernetes guide](https://docs.prefect.io/latest/deploy/dynamic-infra/deploy-kubernetes/) to learn how to create and run deployments in Kubernetes.
