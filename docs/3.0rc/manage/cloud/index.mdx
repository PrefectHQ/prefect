...
Prefect Cloud is a hosted workflow application platform with all the capabilities of Prefect server plus additional features, such as:
...
- [Audit Logs](/3.0rc/cloud/manage-users/audit-logs/) &mdash; a record of user activities to monitor security and compliance.
...
See the [Workspaces](/3.0rc/cloud/workspaces/) page for more information about configuring and using workspaces.
