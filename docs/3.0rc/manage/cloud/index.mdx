...
success "Getting Started with Prefect Cloud"
    Ready to jump right in and start running with Prefect Cloud? See the [Quickstart](/3.0rc/get-started/quickstart/) and follow the instructions on the **Cloud** tabs to write and deploy your first Prefect Cloud-monitored flow run.

![Viewing a workspace dashboard in the Prefect Cloud UI](/3.0rc/img/ui/cloud-dashboard.png)
...
- [Workspaces](/3.0rc/cloud/workspaces/) &mdash; isolated environments to organize your flows, deployments, and flow runs.
- [Automations](/3.0rc/react/understand-events/automations-triggers/) &mdash; configure triggers, actions, and notifications in response to real-time monitoring events.
- [Email notifications](/3.0rc/react/understand-events/automations-triggers/) &mdash; send email alerts from Prefect's server based on automation triggers.
- [Service accounts](/3.0rc/cloud/manage-users/service-accounts/) &mdash; configure API access for running workers or executing flow runs on remote infrastructure.
- [Custom role-based access controls (RBAC)](/3.0rc/cloud/manage-users/manage-roles/) &mdash; assign users granular permissions to perform certain activities within an account or a workspace.
- [Single Sign-on (SSO)](/3.0rc/cloud/manage-users/configure-sso/) &mdash; authentication using your identity provider.
- [Audit Log](/3.0rc/cloud/manage-users/audit-logs/) &mdash; a record of user activities to monitor security and compliance.
...
- [Push work pools](/3.0rc/deploy/dynamic-infra/push-runs-serverless/) &mdash; run flows on your serverless infrastructure without running a worker.
...
Custom plans have [object-level access control lists](/3.0rc/cloud/manage-users/object-access-control-lists/), [custom roles](/3.0rc/cloud/manage-users/manage-roles/), [teams](/3.0rc/cloud/manage-users/manage-teams/), and [single sign-on (SSO)](#single-sign-on-(sso) with [Directory Sync/SCIM provisioning](/3.0rc/cloud/manage-users/configure-sso/#scim-provisioning).
...
See the [Workspaces](/3.0rc/cloud/workspaces/) documentation for more information about configuring and using workspaces.
...
- [Automations](/3.0rc/react/understand-events/automations-triggers/)
- [Incidents](/3.0rc/react/manage-events/)

![Viewing a workspace dashboard in the Prefect Cloud UI.](/3.0rc/img/ui/cloud-new-workspace.png)
...
See the [service accounts](/3.0rc/cloud/manage-users/service-accounts/) documentation for more information about creating and managing service accounts.
...
See the [role-based access controls (RBAC)](/3.0rc/cloud/manage-users/manage-roles/) documentation for more information about managing user roles in a Prefect Cloud account.

## Single Sign-on (SSO) <span class="badge pro"></span> <span class="badge custom"></span>

Prefect Cloud's [Pro and Custom plans](https://www.prefect.io/pricing) offer [single sign-on (SSO)](/3.0rc/cloud/manage-users/configure-sso/) authentication integration with your team’s identity provider.
...
Prefect Cloud's [Pro and Custom plans](https://www.prefect.io/pricing) offer [Audit Logs](/3.0rc/cloud/manage-users/audit-logs/) for compliance and security.
...
Then follow the steps in the UI to deploy your first Prefect Cloud-monitored flow run. For more details, see the [Prefect Quickstart](/3.0rc/get-started/quickstart/) and follow the instructions on the **Cloud** tabs.
