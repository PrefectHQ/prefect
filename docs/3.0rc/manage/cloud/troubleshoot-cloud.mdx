---
title: Troubleshooting Prefect Cloud
...
[Service accounts](/3.0rc/cloud/manage-users/service-accounts/) (sometimes referred to as bots),  
...
Actors can be members of [workspaces](/3.0rc/cloud/workspaces/). An actor attempting an action in a 
...
an actor has a [role](/3.0rc/cloud/manage-users/manage-roles/) which grants them certain permissions. 
