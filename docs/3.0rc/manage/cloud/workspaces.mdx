...
<Note>
Workspaces are available with [Prefect Cloud](/3.0rc/manage/cloud/connect-to-cloud) only.
</Note>

## Get started with workspaces

When you first log into Prefect Cloud, you are prompted to create your own initial workspace. 
After you create your workspace, you can view flow runs, flows, deployments, and other workspace-specific features in the Prefect Cloud UI.
...
Each workspace keeps track of its own:
    ...
    - [Flow runs](https://docs.prefect.io/ui/flow-runs/) and task runs executed in an environment that is [syncing with the workspace](https://docs.prefect.io/ui/cloud/#workspaces)
    - [Flows](https://docs.prefect.io/concepts/flows/) associated with flow runs or deployments observed by the Prefect Cloud API
    - [Deployments](https://docs.prefect.io/concepts/deployments/)
    - [Work pools](https://docs.prefect.io/concepts/work-pools/)
    - [Blocks](https://docs.prefect.io/ui/blocks/) and [Storage](https://docs.prefect.io/concepts/storage/)
...
![Managing a workspace in the Prefect Cloud UI.](/images/workspaces4.png)
...
Within a Prefect Cloud Pro or Custom tier account, Workspace Owners can invite other people as members, and provision [service accounts](https://docs.prefect.io/ui/service-accounts/) to a workspace. 
