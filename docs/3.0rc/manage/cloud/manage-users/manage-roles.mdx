...
Prefect Cloud's [Pro and Custom tiers](https://www.prefect.io/pricing) allow you to set team member 
...
Custom account Admins can create custom roles for users to give users access to functionality 
...
![Creating a custom role for a workspace using inherited permissions in Prefect Cloud](/3.0rc/img/ui/org-inherited-role.png)
