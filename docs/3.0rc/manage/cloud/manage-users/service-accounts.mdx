...
- Prefect Cloud [API keys](/3.0rc/manage/cloud/manage-users/api-keys/)
- [Roles](/3.0rc/manage/cloud/manage-users/manage-roles/) and permissions

With service account credentials, you can 
[configure an execution environment](/3.0rc/manage/cloud/connect-to-cloud/#configure-a-local-execution-environment) 
...
See [workspace sharing](/3.0rc/manage/cloud/workspaces/#workspace-sharing) for more information.
...
[added to a workspace](/3.0rc/manage/cloud/workspaces/#workspace-sharing).
</Note>
