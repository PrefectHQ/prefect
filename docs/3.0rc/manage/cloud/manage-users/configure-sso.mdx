...
Once you complete SSO configuration, your users must authenticate through your identity provider when accessing account resources, giving you full control over app access.
...
When a user is unassigned from the Prefect Cloud app in your identity provider, they automatically lose access to 
