...
See [Settings](/3.0rc/manage/configure-client/) for details.

<Note>
**Environment variables**

You can set `PREFECT_API_URL` and `PREFECT_API_KEY` just like any other environment variable. 
See [Overriding defaults with environment variables](/3.0rc/manage/configure-client/#overriding-defaults-with-environment-variables) 
