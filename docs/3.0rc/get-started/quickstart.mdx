...
In this quickstart, you will convert the following Python script to a schedulable, observable, resilient, and deployable workflow.
...
<Tabs>
  <Tab title="Cloud">
You can create a [managed work pool](/3.0rc/deploy/serve-flows/index) in the UI or from the CLI.
...
You can view your new work pool on the **Work Pools** page of the UI.
  ...
  <Tab title="OSS">
You can create a worker-based work pool using the CLI.
...
- Work pool target (for example, `my-managed-pool`)
