...
Running a flow locally is a good start, but most use cases require a remote environment.
...
* [Cloud and server](/3.0rc/manage)
* [Manage infrastructure with work pools](/3.0rc/deploy/infrastructure-concepts/work-pools) to learn about running workflows on Kubernetes, Docker, and serverless infrastructure.
