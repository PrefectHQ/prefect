...
Potential triggers include the occurrence of events from changes in a flow run's state - or the absence of such events. You can even define your own custom trigger to fire based on an [event](/3.0rc/cloud/events/) created from a webhook or a custom event defined in Python code.
...
!!! cloud-ad "Automations are only available in Prefect Cloud"
    [Notifications](/3.0rc/concepts/notifications/) in an open-source Prefect server provide a subset of the notification message-sending features available in Automations.
...
- [flow_run](/3.0rc/api-ref/server/schemas/core/#prefect.server.schemas.core.FlowRun)
- [flow](/3.0rc/api-ref/server/schemas/core/#prefect.server.schemas.core.Flow)
- [deployment](/3.0rc/api-ref/server/schemas/core/#prefect.server.schemas.core.Deployment)
- [work_queue](/3.0rc/api-ref/server/schemas/core/#prefect.server.schemas.core.WorkQueue)
- [work_pool](/3.0rc/api-ref/server/schemas/core/#prefect.server.schemas.core.WorkPool)
