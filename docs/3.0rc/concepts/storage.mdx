...
![Viewing the new block library in the Prefect UI](/3.0rc/img/ui/block-library.png)
...
![Configuring an S3 storage block in the Prefect UI](/3.0rc/img/concepts/s3-block-configuration.png)
