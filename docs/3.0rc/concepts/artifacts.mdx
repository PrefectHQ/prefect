...
Progress artifacts indicate the progress of long-running tasks. They render dynamically on the flow run graph in the Prefect UI, providing a visually rich indicator of a task run's progress.
