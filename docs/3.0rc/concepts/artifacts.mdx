...
Note that progress artifacts are updated using a separate `update_progress_artifact()` function. Prefect updates a progress artifact in place, rather than versioning it.
