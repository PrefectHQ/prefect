...
States are rich objects that contain information about the status of a particular [task](/3.0rc/concepts/tasks) run or [flow](/3.0rc/concepts/flows/) run. While you don't need to know the details of the states to use Prefect, you can give your workflows superpowers by taking advantage of it.
...
See the [Final state determination](/3.0rc/concepts/flows/#final-state-determination) section of the [Flows](/3.0rc/concepts/flows/) documentation for further details and examples.
...
- [Send a notification when a flow run fails](/3.0rc/guides/state-change-hooks/#send-a-notification-when-a-flow-run-fails)
- [Delete a Cloud Run job when a flow crashes](/3.0rc/guides/state-change-hooks/#delete-a-cloud-run-job-when-a-flow-crashes)
