...
!!! tip "Blocks and parameters"
    ...
    For configuration that will change between flow runs, we recommend using [parameters](/3.0rc/concepts/flows/#parameters).
...
Note that blocks can also be created and updated via the [Prefect UI](/3.0rc/ui/blocks/).
