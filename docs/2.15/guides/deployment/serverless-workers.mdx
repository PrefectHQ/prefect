...
![Work pool options](/2.15/2.15/img/ui/work-pools.png)
...
!!! note "Push work pools don't require a worker"
    ...
    Read more in the [Serverless Push Work Pool Guide](/2.15/guides/deployment/push-work-pools/).
...
Learn more about workers and work pools in the [Prefect concept documentation](/2.15/concepts/work-pools/).
