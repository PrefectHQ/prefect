...
As an additional step, you may want to use an [automation](/2.15/concepts/automations) or [notification](/2.15/concepts/notifications/) to alert the user to the error.
