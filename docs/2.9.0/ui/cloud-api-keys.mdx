...
See [Configure Local Environments](/2.9.0/ui/cloud-local-environment/) for details on setting up access to Prefect Cloud from a local development environment or remote execution environment.
...
Service accounts are a feature of Prefect Cloud [organizations](/2.9.0/ui/organizations/) that enable you to create a Prefect Cloud API key that is not associated with a user account. 
