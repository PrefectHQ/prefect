...
!!! cloud-ad "Automations are only available in Prefect Cloud"
    [Notifications](/2.9.0/ui/notifications/) in the open-source Prefect server provide a subset of the notification message-sending features avaiable in Automations.
...
- [flow_run](/2.9.0/api-ref/server/schemas/core/#prefect.server.schemas.core.FlowRun)
- [flow](/2.9.0/api-ref/server/schemas/core/#prefect.server.schemas.core.Flow)
- [deployment](/2.9.0/api-ref/server/schemas/core/#prefect.server.schemas.core.Deployment)
- [work_queue](/2.9.0/api-ref/server/schemas/core/#prefect.server.schemas.core.WorkQueue)
