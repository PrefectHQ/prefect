...
2. [Install Prefect](/2.9.0/getting-started/installation/) in the environment in which you want to execute flow runs.
...
You can also log in by providing a [Prefect Cloud API key](/2.9.0/ui/cloud-api-keys/).
