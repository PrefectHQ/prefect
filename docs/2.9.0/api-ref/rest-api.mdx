...
The Prefect REST API documentation for locally run open-source Prefect servers is available in the [Prefect REST API Reference](/2.9.0/api-ref/rest-api-reference/).
