...
With your [CLI authenticated to your Prefect Cloud workspace](/2.19/cloud/users/api-keys/), run the script to create your deployment:
...
Read more about creating deployments in the [deployment guide](/2.19/guides/prefect-deploy/).
...
Read more [here](/2.19/guides/deployment/push-work-pools/).
