...
![Work pool options](/2.19/img/ui/work-pools.png)
...
**Push work pools don't require a worker**
    ...
    Read more in the [Serverless Push Work Pool Guide](/2.19/guides/deployment/push-work-pools/).
...
- [Azure Container Instances guide](/2.19/integrations/prefect-azure/aci_worker/)
