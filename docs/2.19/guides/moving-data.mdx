...
- Prefect [installed](/2.19/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.19/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.19/guides/host/) instance)
...
We can create [blocks](/2.19/concepts/blocks/) via the UI or Python code.
