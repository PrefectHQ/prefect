...
After you grant approval to connect, you'll be redirected to the CLI and the API key will be saved to your local [Prefect profile](/2.19/guides/settings/).
...
![Viewing and editing API keys in the Cloud UI.](/2.19/img/ui/cloud-api-keys.png)

Select the **+** button to create a new API key.
Provide a name for the key and an expiration date.

![Creating an API key in the Cloud UI.](/2.19/img/ui/cloud-new-api-key.png)
...
See the [service accounts](/2.19/cloud/users/service-accounts/) documentation for more information about creating and managing service accounts in Prefect Cloud.
