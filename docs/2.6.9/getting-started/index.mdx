...
!!! help "Looking for Prefect 1 Core and Server?"
    Prefect 2 is now available for general use. See our [Migration Guide](/2.6.9/migration-guide/) to move your flows from Prefect 1 to Prefect 2.
...
- [scheduling](/2.6.9/concepts/schedules/)
- [retries](/2.6.9/concepts/tasks/#task-arguments)
- [logging](/2.6.9/concepts/logs/)
- [caching](/2.6.9/concepts/tasks/#caching)
- [notifications](/2.6.9/ui/notifications/)
- [observability](/2.6.9/ui/overview/)
...
Begin by [installing Prefect 2](/2.6.9/getting-started/installation/) on your machine, then follow one of our [friendly tutorials](/2.6.9/tutorials/first-steps/) to learn by example. See our [Quick Start](/2.6.9/getting-started/overview/) guide for details if you're ready to jump right in.
...
Learn more about Prefect 2's features and design by reading our in-depth [concept docs](/2.6.9/concepts/overview/). The concept docs are intended to introduce the building blocks of Prefect, build up to orchestration and deployment, and finally cover some of the advanced use cases that Prefect makes possible.

**Prefect UI & Prefect Cloud**

See how [Prefect's UI and cloud hosted functionality](/2.6.9/ui/overview/) can make coordinating dataflows a joy.

**Collections**

Prefect integrates with the other tools of the modern data stack. In our [collections docs](/2.6.9/collections/catalog/) learn about our pre-built integrations and see how to add your own.

**Frequently asked questions**

Prefect 2 represents a fundamentally new way of building and orchestrating dataflows. You can find responses to common questions by reading our [FAQ](/2.6.9/faq/) and checking out the [Prefect Discourse](https://discourse.prefect.io/).

**API reference**

Prefect 2 provides a number of programmatic workflow interfaces, each of which is documented in the [API Reference](/2.6.9/api-ref/overview). This section is where you can learn how a specific function works, or see the expected payload for a REST endpoint.

**Contributing**

Learn how [you can get involved](/2.6.9/contributing/overview/).
...
Prefect has [integrations](/2.6.9/collections/catalog/) for all the major cloud providers and modern data tools such as Snowflake, Databricks, dbt, and Airbyte. 
...
Prefect is often used with [Docker and Kubernetes](/2.6.9/concepts/deployments/). 
...
In the [Prefect Orion UI](/2.6.9/ui/overview/) you can quickly set up notifications, visualize run history, and schedule your dataflows.  
