...
Prefect integrations are organized into collections of pre-built [tasks](/2.6.9/concepts/tasks/), [flows](/2.6.9/concepts/flows/), [blocks](/2.6.9/concepts/blocks/) and more that are installable as PyPI packages. We affectionately call these groups of integrations **Prefect Collections**.
