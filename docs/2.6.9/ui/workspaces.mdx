...
![Viewing all available workspaces in the Prefect Cloud UI.](/2.6.9/img/ui/all-workspaces.png)
...
- Workspaces in an [organization](/2.6.9/ui/organizations/) to which you've been invited and have been given access to organization workspaces.
...
!!! info "Workspace-specific features"
    ...
    - [Flows](/2.6.9/concepts/flows/) associated with flow runs or deployments observed by the Prefect Cloud API
...
Your user permissions within workspaces may vary. [Organizations](/2.6.9/ui/organizations/) can assign roles and permissions at the workspace level.
...
![Creating a new workspace in the Prefect Cloud UI.](/2.6.9/img/ui/create-workspace.png)
...
![Managing a workspace in the Prefect Cloud UI.](/2.6.9/img/ui/workspace-settings.png)

This page enables you to copy the configuration string to [set up a local development or execution environment](/2.6.9/ui/cloud-getting-started/#configure-execution-environment) to work this workspace.
...
![Managing collaborators in a workspace in the Prefect Cloud UI.](/2.6.9/img/ui/workspace-collaborators.png)
...
Within a Prefect Cloud [organization](/2.6.9/ui/organizations/), Admins and workspace Owners may invite users and [service accounts](/2.6.9/ui/service-accounts/) to work in an organization workspace. In addition to giving the user access to the workspace, the Admin or Owner assigns a [workspace role](/2.6.9/ui/roles/) to the user. The role specifies the scope of permissions for the user within the workspace.
...
![Managing sharing in a workspace in the Prefect Cloud UI.](/2.6.9/img/ui/workspace-sharing.png)
