...
[Organizations](/2.6.9/ui/organizations/) in Prefect Cloud let you give people in your organization access to the appropriate Prefect functionality within your organization and within specific workspaces. 
...
| Role | Abilities |
| --- | --- |
| Owner |  Run flows. <br/>  View and delete flow runs within a workspace. <br/>  Create, view, edit, and delete deployments within a workspace. <br/>  Create, view, edit, and delete work queues within a workspace. <br/>  Create, view, edit, and delete blocks within a workspace. <br/>  Create, view, edit, and delete notifications within a workspace. <br/>  Add and remove organization members, and set their role within a workspace. <br/>  Set the workspace’s default workspace role for all users in the organization. <br/>  Set, view, edit workspace settings. |
| Collaborator |  Run flows within a workspace. <br/>  View and delete flow runs within a workspace. <br/>  Create, view, edit, and delete deployments within a workspace. <br/>  Create, view, edit, and delete work queues within a workspace. <br/>  Create, view, edit, and delete all blocks within a workspace. <br/>  Create, view, edit, and delete notifications within a workspace. <br/>  View workspace setting within a workspace. |
| Read-only collaborator |  View flow runs within a workspace. <br/>  View deployments within a workspace. <br/>  View all Work Queues. <br/>  View all Blocks. <br/>  View all Notifications. <br/>  View workspace settings (handle & description currently). |
...
![Creating a custom role for a workspace using inherited permissions in Prefect Cloud](/2.6.9/img/ui/org-inherited-role.png)
