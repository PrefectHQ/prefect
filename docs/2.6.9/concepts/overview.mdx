...
The fundamental building blocks of Prefect are [flows](/2.6.9/concepts/flows/) and [tasks](/2.6.9/concepts/tasks/).  We recommend all readers begin by understanding these concepts first. 

## Deployment and Orchestration 

If you are looking to configure the rules that govern your tasks' state transitions, or better understand how runs are orchestrated in the backend, then diving into [states](/2.6.9/concepts/states/), [logs](/2.6.9/concepts/logs/) and the [Prefect UI](/2.6.9/ui/overview/) or [Prefect Cloud](/2.6.9/ui/cloud/) should help orient you.
