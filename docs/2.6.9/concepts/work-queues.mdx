---
title: Agents and Work Queues
sidebarTitle: Agents & Work Queues
---



Agents and work queues bridge the Prefect Orion _orchestration environment_ with a user’s _execution environment_. When a [deployment](/2.6.9/concepts/deployments/) creates a flow run, it is submitted to a specific work queue for scheduling. Agents running in the execution environment poll their respective work queues for new runs to execute.
...
- Prefect UI [**Work Queues**](/2.6.9/ui/work-queues/) page
- Prefect CLI commands
- Prefect Python API

![Creating a new work queue in the Orion UI](/2.6.9/img/ui/work-queue-create.png)
...
![The UI displays a list of configured work queues](/2.6.9/img/ui/work-queue-list.png)
