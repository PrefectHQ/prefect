...
- Prefect [installed](/2.14/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.14/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.14/guides/host/) instance)
...
We can create [blocks](/2.14/concepts/blocks/) via the UI or Python code.
