...
As an additional step, you may want to use an [automation](/2.14/concepts/automations) or [notification](/2.14/concepts/notifications/) to alert the user to the error.
