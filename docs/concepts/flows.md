...
Paused flows can be resumed by clicking the **Resume** button in the Prefect UI or Prefect Cloud or by calling the resume flow run utility in another process.
