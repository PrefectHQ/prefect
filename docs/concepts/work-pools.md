...
You can override each of these attributes on a per-deployment basis. When making deployments, you can specify these overrides in the `work_pool.job_variables` section of a `deployment.yaml`.
