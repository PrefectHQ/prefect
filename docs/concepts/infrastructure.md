...
Learn about the different types of Prefect images available and how to choose the right image for your deployment in the [Docker Images](/guides/deployment/docker-images/) guide.
