...
<div style="border-radius: 20px; border: 1px solid #27b1ff; padding: 1em;">
Looking for the latest <a href="https://docs.prefect.io/v2">Prefect 2.0</a> release? <a href="https://docs.prefect.io/v2">Prefect 2.0</a> and <a href="https://app.prefect.cloud">Prefect Cloud 2.0</a> have been released for General Availability. See <a href="https://docs.prefect.io/v2">https://docs.prefect.io/v2</a> for details.
</div>
