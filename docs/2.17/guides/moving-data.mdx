...
- Prefect [installed](/2.17/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.17/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.17/guides/host/) instance)
...
We can create [blocks](/2.17/concepts/blocks/) via the UI or Python code.
