...
Each organization has their own unique CI/CD setup, but a common pattern is to use CI/CD to manage Prefect [deployments](/2.17/concepts/deployments).
...
![Creating a GitHub Actions secret](/2.17/img/guides/github-secrets.png)
...
![A GitHub Action triggered via push](/2.17/img/guides/github-actions-trigger.png)
