...
![Work pool options](/2.17/img/ui/work-pools.png)
...
!!! note "Push work pools don't require a worker"
    ...
    Read more in the [Serverless Push Work Pool Guide](/2.17/guides/deployment/push-work-pools/).
...
Learn more about workers and work pools in the [Prefect concept documentation](/2.17/concepts/work-pools/).

Learn about installing dependencies at runtime or baking them into your Docker image in the [Deploying Flows to Work Pools and Workers guide](/2.17/guides/prefect-deploy/#creating-work-pool-based-deployments-with-deploy).
