...
![Markdown artifact sales report screenshot](/2.17/img/ui/md-artifact-info.png)
...
![Link artifact details with multiple versions](/2.17/img/ui/link-artifact-info.png)
...
![Markdown sales report screenshot](/2.17/img/ui/md-artifact-info.png)
...
![Table artifact with customer info](/2.17/img/ui/table-artifact-info.png)
