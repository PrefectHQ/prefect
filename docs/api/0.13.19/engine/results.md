...
<p class="methods">Reads a result from S3, reads it and returns a new `Result` object with the corresponding value.<br><br>**Args**:     <ul class="args"><li class="args">`location (str)`: the S3 URI to read from</li></ul> **Returns**:     <ul class="args"><li class="args">`Any`: the read result</li></ul></p>|
 | <div class='method-sig' id='prefect-engine-results-s3-result-s3result-write'><p class="prefect-class">prefect.engine.results.s3_result.S3Result.write</p>(value_, **kwargs)<span class="source"><a href="https://github.com/PrefectHQ/prefect/blob/master/src/prefect/engine/results/s3_result.py#L83">[source]</a></span></div>
