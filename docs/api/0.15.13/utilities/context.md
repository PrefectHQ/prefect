...
| `config` | the complete [Prefect configuration](https://docs.prefect.io/v2/core/concepts/configuration.html) object that is being used during this run |
...
the [Context concept
doc](https://docs.prefect.io/v2/core/concepts/execution.html#context).
 ## Context
