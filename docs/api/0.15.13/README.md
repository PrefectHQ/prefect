...
Read the [docs](https://docs-v1.prefect.io); get the [code](#installation); ask us [anything](https://www.prefect.io/slack)!
...
**Tip:** Check our [troubleshooting guide](/orchestration/server/troubleshooting.html) if you run into any issues starting the server.
...
Finally, to [register any flow](/orchestration/concepts/flows.html#registration) with the server, call `flow.register(project_name="<project_name>")` within your flow using the name of your project. For more detail, please see the [orchestration docs](/orchestration/).
