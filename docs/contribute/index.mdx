...
Before opening a non-trivial pull request, open or join the relevant GitHub issue so maintainers and contributors can align on scope.
If you use AI tools while contributing, verify the output yourself and make sure your issue or pull request clearly explains the problem, approach, tradeoffs, and tests.
See [Develop on Prefect](/contribute/dev-contribute) for the full code contribution workflow.
