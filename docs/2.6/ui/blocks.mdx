...
Blocks are the underlying components behind familiar Prefect concepts like [deployments](/2.6/concepts/deployments/) and [storage](/2.6/concepts/storage/). To learn more about creating and using blocks programmatically, see the [Blocks](/2.6/concepts/blocks/) documentation.
...
![Viewing configured blocks in the Prefect UI](/2.6/img/ui/orion-blocks.png)
...
![Configuring a Slack Webhook block in the Prefect UI](/2.6/img/ui/orion-blocks-slack.png)

The [Blocks](/2.6/concepts/blocks/) documentation provides further detail on using blocks in your Prefect flows.