...
![Adding an email domain for single sign-on in the Prefect Cloud UI.](/2.6/img/ui/cloud-sso.png)
...
![Generating a configuration link for single sign-on in the Prefect Cloud UI.](/2.6/img/ui/cloud-sso-provider.png)
...
![Opening the Identity Provider Configuration dashboard.](/2.6/img/ui/cloud-sso-dashboard.png)
