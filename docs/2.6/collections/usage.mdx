...
Once the Prefect Collection is installed, [register the blocks](/2.6/concepts/blocks/#registering-blocks-for-use-in-the-prefect-ui) within the collection to view them in the Prefect Cloud UI:
...
**Note**, to use the load method on Blocks, you must already have a block document [saved](/2.6/concepts/blocks/#saving-blocks) through code or saved through the UI.
