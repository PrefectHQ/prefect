...
![Deployment flow run on the Flow Runs page of the Prefect UI](../img/my-first-deployment.png)
...
![The Deployments page displays a list of deployments created in Prefect](../img/deployments.png)

Now select **log-flow/log-simple** to see details for the deployment you just created.

![Viewing details of a single deployment](../img/deployment-details.png)

Select **Parameters** to see the default parameters you specified in the deployment definition.

![Viewing deployment parameters](../img/deployment-parameters.png)
...
![Deployment run options in the UI](../img/deployment-run-options.png)
...
![Configuring custom flow run settings](../img/custom-flow-run.png)
...
![Configuring custom flow run settings](../img/custom-parameter.png)
...
![The deployment flow run is shown in the UI run history](../img/deployment-run.png)
...
![The flow run logs show the expected Hello Trillian! log message](../img/dep-flow-logs.png)
