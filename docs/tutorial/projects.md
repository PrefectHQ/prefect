...
You can experiment by importing and running this flow in your favorite REPL; let's now elevate this flow to a [deployment](/concepts/deployments.md) via the `prefect deploy` CLI command:
