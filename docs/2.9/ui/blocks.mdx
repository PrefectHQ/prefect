...
Blocks are the underlying components behind familiar Prefect concepts like [deployments](/2.9/concepts/deployments/) and [storage](/2.9/concepts/storage/). To learn more about creating and using blocks programmatically, see the [Blocks](/2.9/concepts/blocks/) documentation.
...
The [Blocks](/2.9/concepts/blocks/) documentation provides further detail on using blocks in your Prefect flows.