...
- Prefect [installed](/2.16.9/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.16.9/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.16.9/guides/host/) instance)
...
We can create [blocks](/2.16.9/concepts/blocks/) via the UI or Python code.
