...
From the [Automations concept page](/2.16.9/concepts/automations/), we saw what an automation can do and how to configure one within the UI. 
...
- Python installed
- Prefect installed (follow the [installation guide](/2.16.9/getting-started/installation/))
- Authenticated to a [Prefect Cloud workspace](/2.16.9/getting-started/quickstart/#step-2-connect-to-prefects-api/)
- A [work pool](/2.16.9/concepts/work-pools/) set up to handle the deployments
...
![Notification block in automation](/2.16.9/img/guides/notify-auto-block.png)
...
![Final notification](/2.16.9/img/guides/final-automation.png)
...
![webhook-simple](/2.16.9/img/guides/webhook-simple.png)
...
![Webhook created](/2.16.9/img/guides/webhook-created.png)

Let us go into the event feed, and we can automate straight from this event. 
![Webhook automate](/2.16.9/img/guides/webhook-automate.png)
...
![Automation custom](/2.16.9/img/guides/automation-custom.png)
...
To learn more about events that can act as automation triggers, see the [events docs](/2.16.9/concepts/events/).  To learn more about event webhooks in particular, see the [webhooks guide](/2.16.9/guides/webhooks/).
