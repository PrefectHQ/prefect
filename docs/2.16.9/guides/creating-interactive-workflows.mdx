...
As an additional step, you may want to use an [automation](/2.16.9/concepts/automations) or [notification](/2.16.9/concepts/notifications/) to alert the user to the error.
