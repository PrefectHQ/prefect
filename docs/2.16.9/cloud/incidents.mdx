...
![Incidents in the Prefect Cloud UI](/2.16.9/img/ui/incidents-dashboard.png)
...
![An active incident in the Prefect Cloud UI](/2.16.9/img/ui/incidents-active.png)
...
3. **Via an [automation](/2.16.9/concepts/automations/):**
...
!!! tip "Building custom triggers"
    ...
    See [Event Triggers](/2.16.9/concepts/automations/#custom-triggers) for more information on custom triggers, and check out your Event Feed to see the event types emitted by your incidents and other resources (i.e. events that you can react to).
