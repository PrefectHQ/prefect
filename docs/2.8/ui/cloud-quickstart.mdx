...
[Install Prefect](/2.8/getting-started/installation/) in the environment in which you want to execute flow runs.
...
!!! note "Installation requirements"
    Prefect requires Python 3.7 or later. If you have any questions about Prefect installations requirements or dependencies in your preferred development environment, check out the [Installation](/2.8/getting-started/installation/) documentation.
...
Okay, you're all set to run a local flow with Prefect Cloud. Notice that everything works just like [running local flows](/2.8/tutorials/first-steps/). However, because you logged into Prefect Cloud locally, your local flow runs show up in Prefect Cloud!
...
If you're new to Prefect, learn more about writing and running flows in the [Prefect Flows First Steps](/2.8/tutorials/first-steps/) tutorial. If you're already familiar with Prefect flows and want to try creating deployments and kicking off flow runs with Prefect Cloud, check out the [Deployments](/2.8/tutorials/deployments/) and [Storage and Infrastructure](/2.8/tutorials/storage/) tutorials.

Want to learn more about the features available in Prefect Cloud? Start with the [Prefect Cloud Overview](/2.8/ui/cloud/).
