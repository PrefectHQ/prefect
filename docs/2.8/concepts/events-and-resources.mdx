...
Emitted events will appear in the [event feed](/2.8/ui/events/) where you can visualize activity in context and configure [automations](/2.8/ui/automations/) to react to the presence or absence of it in the future.
