...
As a last step, let's add some visbility into the results of your flow. You can add a task that creates a markdown artifact to view the results in the Prefect Cloud UI.
