...
* A forever-free [Prefect Cloud account](https://app.prefect.cloud) and an API key
...
### Provision AWS resources and create webhooks

This tutorial uses AWS S3 and EventBridge to store data and emit events, and Prefect webhooks to trigger your flows.
We'll use Terraform so you don't have to manually provision these resources.
...
#### Alternative: create AWS resources manually
