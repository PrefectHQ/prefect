...
<Note>
When you're ready to permanently delete these resources, empty the `prefect-ml-data` and `prefect-model` buckets from the AWS Console and then run `terraform destroy`.
</Note>
