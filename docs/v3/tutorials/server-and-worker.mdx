...
<Expandable title="Deploy withDefault Values / No Auth">
...
<Expandable title="Deploy with Custom Values / With Auth">
...
<Expandable title="Deploy with Default Values / No Auth">
