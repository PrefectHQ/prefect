...
There are also so key differenes when it comes to task execution, resource control, data passing, and parallelism. We'll cover these in more detail below.
...
- [Configurating logging](/v3/develop/logging)
- [Debugging](/v3/tutorials/debug)
- [Tracking activity](/v3/automate/events/events)
...
![MarvinAI](/v3/img/ui/marvin-ai.png)
...
- [Vist Prefect's GitHub](https://github.com/PrefectHQ/prefect)
