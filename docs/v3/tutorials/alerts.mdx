...
In this tutorial, you'll learn how to set up an email alert which proactively notifies your team about failures.
...
> Subject: Prefect flow run notification<br/><br/>
...
In this tutorial, you successfully used Prefect Cloud automations to set up an email alert.
