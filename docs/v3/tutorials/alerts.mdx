...
Next, specify the trigger for the alert.
...
Next, specify the action to take when the trigger condition is met.
...
Finally, give the automation a name and description.
...
You can click the URL to view the flow run in Prefect Cloud.
