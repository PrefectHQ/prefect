...
Prefect recommends having one workspace per development environment.
...
Next, you need to create a second workspace for workflows in staging:
...
In the next tutorial, learn how to [automate deployments with CI/CD](/v3/tutorials/cicd).
