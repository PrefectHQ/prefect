...
<div style={{
  ...
  <iframe
    src="https://demo.arcade.software/XYwssAx9RdPJ1EcPcsCd?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true"
    title="Mastering Deployment Scheduling for Optimal Performance"
    frameborder="0"
    loading="lazy"
