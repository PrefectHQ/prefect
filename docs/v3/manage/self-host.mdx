...
You can save the API server address in a [Prefect profile](/v3/manage/settings-and-profiles/). Whenever that profile is 
active, the API endpoint is at that address.

See [Profiles and configuration](/v3/manage/settings-and-profiles/) for more information on profiles and configurable Prefect settings.
