...
Prefect will match your pending connection to the information provided, and once approved accept the connection.
...
To configure the Prefect client, and/or workers to use the endpoint, `PREFECT_API_URL` and `PREFECT_CLOUD_API_URL` should be set to the endpoint provided by Prefect.
