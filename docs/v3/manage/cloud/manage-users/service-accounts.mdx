...
- Prefect Cloud [API keys](manage/cloud/manage-users/api-keys/)
- [Roles](manage/cloud/manage-users/manage-roles/) and permissions

With service account credentials, you can 
[configure an execution environment](manage/cloud/connect-to-cloud/#configure-a-local-execution-environment) 
...
See [workspace sharing](manage/cloud/workspaces/#workspace-sharing) for more information.
...
[added to a workspace](manage/cloud/workspaces/#workspace-sharing).
</Note>
