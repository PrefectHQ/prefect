...
1. Prefect [installed](get-started/install)
...
<Note>
If using self-hosted Prefect server, you must register the block types in the 
newly installed modules before you can create blocks.
</Note>
...
Now you can turn your flow into a [deployment](deploy/infrastructure-examples/docker/) so you and your team 
