...
As an additional step, you can use an [automation](automate/events/automations-triggers) to alert the user to the error.
...
Consider using a [block](develop/blocks/), such as a `JSONBlock`.
