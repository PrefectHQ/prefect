...
Caching allows you to efficiently reuse [results of tasks](develop/results/) that may be expensive to compute
...
This behavior can be configured - see [customizing the cache](develop/write-tasks#customizing-the-cache) below.
...
See [managing results](develop/results/) for more details on managing your result configuration, and
[settings](manage/settings-and-profiles) for more details on managing Prefect settings.
</Warning>
...
a single [_transaction_](develop/transactions).
...
Read more about [transactions](develop/transactions). 
...
See [settings](manage/settings-and-profiles) for more details on managing Prefect settings.
