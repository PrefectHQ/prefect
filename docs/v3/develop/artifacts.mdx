...
![Progress artifact example](img/ui/progress-artifact-example.png)
...
![Image artifact example](img/ui/image-artifact-example.png)
...
Create, read, or delete artifacts programmatically through the [Prefect REST API](api-ref/rest-api/).
...
See the [Prefect REST API documentation](api-ref/rest-api/) on artifacts for more information.
