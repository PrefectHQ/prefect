...
<Note>
The V2 UI is the default for browsers without a saved preference. Users can still switch to the V1 UI per browser, and operators can restore V1 as the default by setting `PREFECT_SERVER_UI_V2_ENABLED=false`.
</Note>
