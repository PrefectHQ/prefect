...
search:
  boost: 2
keywords: ["CI/CD", "GitHub Actions", "deployment", "automation", "continuous delivery"]
---
...
This [example repository](https://github.com/kevingrismore/cicd-example-workspaces) addresses each of these
