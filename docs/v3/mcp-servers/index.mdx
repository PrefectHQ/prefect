...
The Prefect MCP server supports two main use cases:
...
<CardGroup cols={2}>
  ...
  >
    Access Prefect documentation through your AI assistant. Get instant answers about concepts, APIs, and best practices.
  </Card>
  <Card
