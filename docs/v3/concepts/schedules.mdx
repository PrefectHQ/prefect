...
keywords: ["schedule", "cron", "interval", "rrule", "recurring", "automated"]
---
...
```bash
PREFECT_SERVER_SERVICES_SCHEDULER_DEPLOYMENT_BATCH_SIZE='100'
PREFECT_SERVER_SERVICES_SCHEDULER_ENABLED='True'
PREFECT_SERVER_SERVICES_SCHEDULER_INSERT_BATCH_SIZE='500'
PREFECT_SERVER_SERVICES_SCHEDULER_LOOP_SECONDS='60.0'
PREFECT_SERVER_SERVICES_SCHEDULER_MIN_RUNS='3'
PREFECT_SERVER_SERVICES_SCHEDULER_MAX_RUNS='100'
PREFECT_SERVER_SERVICES_SCHEDULER_MIN_SCHEDULED_TIME='PT1H'
PREFECT_SERVER_SERVICES_SCHEDULER_MAX_SCHEDULED_TIME='P100D'
```

<Note>
The older `PREFECT_API_SERVICES_SCHEDULER_*` environment variable names are still accepted as legacy aliases.
</Note>
