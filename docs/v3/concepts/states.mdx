...
For examples on how to use state change hooks, see the [How to respond to state changes guide](/v3/how-to-guides/workflows/state-change-hooks) section of this page.
