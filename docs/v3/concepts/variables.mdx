---
title: Variables
description: Variables are dynamically-named, mutable JSON values that can be used to store and reuse non-sensitive bits of data.
keywords: ["variable", "configuration", "dynamic", "key-value", "reusable"]
---
...
- Only contain lowercase letters, numbers, underscores (_), or dashes (-). Spaces are not allowed.
- Be unique

Values can be any JSON-serializable value and must serialize to 5000 characters or fewer.
