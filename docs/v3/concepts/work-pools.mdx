...
keywords: ["work pool", "infrastructure", "dynamic provisioning", "worker", "execution environment"]
---
...
- Allow work pools to prioritize (or limit) flow runs through the use of [work queues](/v3/concepts/work-pools#work-queues).
...
* Learn more about [workers](/v3/concepts/workers) and how they interact with work pools
* Learn how to [deploy flows](/v3/how-to-guides/deployments/prefect-yaml) that run in work pools
