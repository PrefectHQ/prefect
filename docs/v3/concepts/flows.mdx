...
From the perspective of a Prefect server and its clients, a flow run should eventually reach a terminal state. If it doesn't for one of the above reasons, it is called a ["zombie" flow run](/v3/how-to-guides/automations/detect-zombie-flows/).
...
Flows are convenient for composition and deployment - building foolproof APIs for your workflows.
