...
## 3.4.13 - Redis Dead Redemption

*Released on August 14, 2025*

**Enhancements ➕➕**

* Add Redis-based `ConcurrencyLeaseStorage` implementation by [@desertaxle](https://github.com/desertaxle) in [#18646](https://github.com/PrefectHQ/prefect/pull/18646)
...
* only delete groups that start with `ephemeral` by [@zzstoatzz](https://github.com/zzstoatzz) in [#18704](https://github.com/PrefectHQ/prefect/pull/18704)
...
* Bump minimum `prefect` version in `prefect-redis` by [@desertaxle](https://github.com/desertaxle) in [#18709](https://github.com/PrefectHQ/prefect/pull/18709)
...
* Update use-integrations.mdx to reflect removal of setup.py by [@alastairtree](https://github.com/alastairtree) in [#18689](https://github.com/PrefectHQ/prefect/pull/18689)
* Fix typos in "Use integrations" documentation by [@desertaxle](https://github.com/desertaxle) in [#18690](https://github.com/PrefectHQ/prefect/pull/18690)
* docs: note on common github pat gotcha by [@rcash](https://github.com/rcash) in [#18696](https://github.com/PrefectHQ/prefect/pull/18696)
* Add event replication to `ECSWorker` by [@desertaxle](https://github.com/desertaxle) in [#18681](https://github.com/PrefectHQ/prefect/pull/18681)
