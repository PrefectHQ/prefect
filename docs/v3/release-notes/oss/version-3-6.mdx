...
* Add build-time configuration support for UI v2 by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20411](https://github.com/PrefectHQ/prefect/pull/20411)
...
* Migrate git integrations from `@sync_compatible` to `@async_dispatch` by [@zzstoatzz](https://github.com/zzstoatzz) in [#20407](https://github.com/PrefectHQ/prefect/pull/20407)
