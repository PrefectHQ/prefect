...
* Add `extra_cli_args` passthrough to `run_build()` in prefect-dbt by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20770](https://github.com/PrefectHQ/prefect/pull/20770)
* Add `DbtCloudExecutor` for per-node dbt Cloud orchestration by [@desertaxle](https://github.com/desertaxle) in [#20784](https://github.com/PrefectHQ/prefect/pull/20784)
* Add optional DB vacuum service in Docket by [@tom21100227](https://github.com/tom21100227) in [#20746](https://github.com/PrefectHQ/prefect/pull/20746)
* Improve state color consistency in UI by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20809](https://github.com/PrefectHQ/prefect/pull/20809)
...
* Fix observer pod event handling to use camelCase keys from Kubernetes API by [@chuqCTC](https://github.com/chuqCTC) in [#20786](https://github.com/PrefectHQ/prefect/pull/20786)
...
* Fix FastAPI 0.132.0 compatibility (content-type and ORJSONResponse) by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20822](https://github.com/PrefectHQ/prefect/pull/20822)

**Development & Tidiness 🧹**

* Add Docker image build and publish workflows for `prefect-gcp` and `prefect-azure` by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20771](https://github.com/PrefectHQ/prefect/pull/20771)
...
* Add release notes for `prefect-dbt==0.7.18` and fix integration API ref generation by [@desertaxle](https://github.com/desertaxle) in [#20789](https://github.com/PrefectHQ/prefect/pull/20789)
