...
* Refactor deployment steps to use `AwsCredentials.get_s3_client()` by [@bdalpe](https://github.com/bdalpe) in [#20140](https://github.com/PrefectHQ/prefect/pull/20140)
...
* Fix `DockerRegistryCredentials` and `DockerHost` to fallback to standard logger by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20105](https://github.com/PrefectHQ/prefect/pull/20105)
