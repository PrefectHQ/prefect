...
* Standardize null indicators to `None`, concurrency display to `∞`, and fix parameter table overflow by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20872](https://github.com/PrefectHQ/prefect/pull/20872)
* Apply locale formatting to all count and pagination displays by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20873](https://github.com/PrefectHQ/prefect/pull/20873)

**Development & Tidiness 🧹**

* Make `cyclopts` the sole CLI, remove toggle and delegation machinery by [@zzstoatzz](https://github.com/zzstoatzz) in [#20821](https://github.com/PrefectHQ/prefect/pull/20821)
