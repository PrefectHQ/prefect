...
* Fix ECS observer incorrectly crashing suspended flow runs by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20682](https://github.com/PrefectHQ/prefect/pull/20682)
* Fix Kubernetes observer incorrectly crashing suspended flow runs by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20683](https://github.com/PrefectHQ/prefect/pull/20683)
* Handle orphan Redis pending entries in consumer by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#20696](https://github.com/PrefectHQ/prefect/pull/20696)
