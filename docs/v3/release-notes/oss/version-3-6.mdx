...
* Fix anyio fail_after usage - async with was removed in recent version by [@saschwartz](https://github.com/saschwartz) in [#19583](https://github.com/PrefectHQ/prefect/pull/19583)
* Unify definition of EventBeingProcessed type in prefect redis by [@saschwartz](https://github.com/saschwartz) in [#19585](https://github.com/PrefectHQ/prefect/pull/19585)
...
* Use parameterized queries in Snowflake SPCS worker by [@ColeMurray](https://github.com/ColeMurray) in [#19507](https://github.com/PrefectHQ/prefect/pull/19507)
...
* Fix task caching bug in get_dbt_cloud_run_info for polling loops by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#19597](https://github.com/PrefectHQ/prefect/pull/19597)
...
* Add release notes for `prefect-redis==0.2.7` by [@zzstoatzz](https://github.com/zzstoatzz) in [#19561](https://github.com/PrefectHQ/prefect/pull/19561)
* Add release notes for prefect-dbt by [@zzstoatzz](https://github.com/zzstoatzz) in [#19603](https://github.com/PrefectHQ/prefect/pull/19603)
