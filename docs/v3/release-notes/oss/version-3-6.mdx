...
* Add `TriggerStep` component shell for automations wizard by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#19977](https://github.com/PrefectHQ/prefect/pull/19977)
* Add `FlowRunSubflows` component for displaying child flow runs by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#19978](https://github.com/PrefectHQ/prefect/pull/19978)
* Add conditional visibility for SubflowRuns tab when flow run is `PENDING` by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#19980](https://github.com/PrefectHQ/prefect/pull/19980)
* Add `FlowRunGraph` component to `FlowRunDetailsPage` by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#19982](https://github.com/PrefectHQ/prefect/pull/19982)
* Add Flow Run State Trigger Form components for automation wizard by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#19983](https://github.com/PrefectHQ/prefect/pull/19983)
* Fix flakey `flow-run-details-page` test by using overridden state by [@devin-ai-integration](https://github.com/devin-ai-integration)[bot] in [#19984](https://github.com/PrefectHQ/prefect/pull/19984)
