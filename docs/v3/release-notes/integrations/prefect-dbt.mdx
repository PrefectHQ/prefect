...
- Add `AGENTS.md` for prefect-dbt core hooks and execution engine [#21737](https://github.com/PrefectHQ/prefect/pull/21737) by [@app/github-actions](https://github.com/app/github-actions)
- Fix `DbtHookContext` field availability for `error` and `node_ids` in core `AGENTS.md` [#21742](https://github.com/PrefectHQ/prefect/pull/21742) by [@app/github-actions](https://github.com/app/github-actions)
