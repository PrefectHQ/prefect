...
- Support dbt unit tests in `PrefectDbtRunner` — unit test nodes are now reflected as Prefect task runs when running `dbt build` or `dbt unit-test` [#21989](https://github.com/PrefectHQ/prefect/pull/21989) by [@desertaxle](https://github.com/desertaxle)
