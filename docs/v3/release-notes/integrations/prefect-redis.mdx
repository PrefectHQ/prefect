...
- Preserve explicit falsy `prefect-redis` client overrides [#22974](https://github.com/PrefectHQ/prefect/pull/22974) by [@qdivan](https://github.com/qdivan)
- Cache Redis messaging URL lookup [#22950](https://github.com/PrefectHQ/prefect/pull/22950) by [@chuqCTC](https://github.com/chuqCTC)
- Avoid treating a missing Redis stream as a connection error when trimming [#22722](https://github.com/PrefectHQ/prefect/pull/22722) by [@app/devin-ai-integration](https://github.com/app/devin-ai-integration)
...
- Make Redis concurrency leases cluster-slot safe [#22560](https://github.com/PrefectHQ/prefect/pull/22560) by [@zzstoatzz](https://github.com/zzstoatzz)
...
- Add optional `key_ttl` to `RedisDatabase` [#22395](https://github.com/PrefectHQ/prefect/pull/22395) by [@brks-rssll](https://github.com/brks-rssll)
- Add Redis Cluster URL and key groundwork [#22211](https://github.com/PrefectHQ/prefect/pull/22211) by [@zzstoatzz](https://github.com/zzstoatzz)
- Add backend observability for worker channel and cleanup queue [#22310](https://github.com/PrefectHQ/prefect/pull/22310) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)

**Bug Fixes 🐞**

- Use `XREAD` for Redis ephemeral subscriptions [#22201](https://github.com/PrefectHQ/prefect/pull/22201) by [@zzstoatzz](https://github.com/zzstoatzz)
...
- Add redis-py 8 compatible connection defaults [#22189](https://github.com/PrefectHQ/prefect/pull/22189) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
