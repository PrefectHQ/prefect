...
- Scope `pull_from_s3` listing to the requested folder [#22647](https://github.com/PrefectHQ/prefect/pull/22647) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
- Merge Prefect secrets into existing ECS container secrets instead of overwriting them [#22675](https://github.com/PrefectHQ/prefect/pull/22675) by [@peterbygrave](https://github.com/peterbygrave)

**Maintenance**

- Suppress CloudFormation validation warnings in ECS worker CDK synthesis so template generation passes in `--strict` mode [#22715](https://github.com/PrefectHQ/prefect/pull/22715) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Fix ECS observer leaving runs `PENDING` when capacity provider can't place task [#22417](https://github.com/PrefectHQ/prefect/pull/22417) by [@goingforstudying-ctrl](https://github.com/goingforstudying-ctrl)

**Documentation**

- Replace legacy `PREFECT_API_DATABASE_*` examples with `PREFECT_SERVER_DATABASE_*` names [#22471](https://github.com/PrefectHQ/prefect/pull/22471) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Document CDK-generated ECS templates and regeneration workflow in `prefect-aws` `AGENTS.md` [#21980](https://github.com/PrefectHQ/prefect/pull/21980) by [@github-actions](https://github.com/apps/github-actions)
...
- Add exponential backoff retries for ECS task definition registration [#21354](https://github.com/PrefectHQ/prefect/pull/21354) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
- Log ECS task ARN after task creation [#21342](https://github.com/PrefectHQ/prefect/pull/21342) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Make ECS worker task creation retry settings configurable [#20846](https://github.com/PrefectHQ/prefect/pull/20846) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Fix ECS observer incorrectly crashing suspended flow runs [#20682](https://github.com/PrefectHQ/prefect/pull/20682) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)

**Documentation**

- Set up automatic `prefect-aws` API reference docs via mdxify [#20679](https://github.com/PrefectHQ/prefect/pull/20679) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Replace `skipif(sys.platform != 'win32')` with `[@pytest](https://github.com/pytest).mark.windows` and remove `skipif(sys.platform == 'win32')` [#20327](https://github.com/PrefectHQ/prefect/pull/20327) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
