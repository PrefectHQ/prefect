...
- Preserve cursor reset errors when closing `SnowflakeConnector` [#22800](https://github.com/PrefectHQ/prefect/pull/22800) by [@noron12234](https://github.com/noron12234)
...
- Set SF_PARTNER in SPCS flow-run containers for Snowflake partner attribution [#22881](https://github.com/PrefectHQ/prefect/pull/22881) by [@bdalpe](https://github.com/bdalpe)
