...
- Add configurable base directory for included files [#22855](https://github.com/PrefectHQ/prefect/pull/22855) by [@desertaxle](https://github.com/desertaxle)

**Bug Fixes**

- Deduplicate Kubernetes observer state checks and diagnosis logs for unchanged Pending pods [#22965](https://github.com/PrefectHQ/prefect/pull/22965) by [@app/devin-ai-integration](https://github.com/app/devin-ai-integration)

**Documentation**

- Drop Args entries for parameters that do not exist [#22843](https://github.com/PrefectHQ/prefect/pull/22843) by [@muhzuhaib](https://github.com/muhzuhaib)

**Enhancements**

- Capture Kubernetes job pod logs once the job is terminal [#22883](https://github.com/PrefectHQ/prefect/pull/22883) by [@app/devin-ai-integration](https://github.com/app/devin-ai-integration)
...
- Expose Kubernetes pod-failure diagnosis as the `kubernetes.diagnosis` event label [#22577](https://github.com/PrefectHQ/prefect/pull/22577) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)

**Bug Fixes**

- Catch `Abort` when marking a flow run as `Crashed` in the Kubernetes observer to keep the Jobs watcher alive [#22555](https://github.com/PrefectHQ/prefect/pull/22555) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
- Relinquish evicted flow runs to infrastructure retry when `backoffLimit` is not 0 [#22622](https://github.com/PrefectHQ/prefect/pull/22622) by [@chuqCTC](https://github.com/chuqCTC)

**Maintenance**

- Bump `prefect` lower bound to `>=3.8.1`
...
- Store generated environment variables in per-job Kubernetes Secret [#22301](https://github.com/PrefectHQ/prefect/pull/22301) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Preserve casing of Kubernetes label keys [#21259](https://github.com/PrefectHQ/prefect/pull/21259) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Add `include_files` support to the `@kubernetes` infrastructure decorator [#21178](https://github.com/PrefectHQ/prefect/pull/21178) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Add CPU and memory resource fields to Kubernetes work pool [#21116](https://github.com/PrefectHQ/prefect/pull/21116) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Allow customization of tenacity retry parameters in `_create_job` [#20848](https://github.com/PrefectHQ/prefect/pull/20848) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Fix Kubernetes observer incorrectly crashing suspended flow runs [#20683](https://github.com/PrefectHQ/prefect/pull/20683) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)

**Documentation**

- Set up automatic `prefect-kubernetes` API reference docs via `mdxify` [#20718](https://github.com/PrefectHQ/prefect/pull/20718) by [@devin-ai-integration](https://github.com/apps/devin-ai-integration)
...
- Migrate `prefect-kubernetes` from `sync_compatible` to `async_dispatch` [#20414](https://github.com/PrefectHQ/prefect/pull/20414) by [@zzstoatzz](https://github.com/zzstoatzz)
