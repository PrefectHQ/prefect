...
[events](automate/events/) for use in [automations](automate/events/automations-triggers/).
...
[authentication methods](manage/cloud/connect-to-cloud#manually-configure-prefect-api-settings) you use with Prefect
Cloud.
...
As with the [templates available in Prefect Cloud Automation](automate/events/automations-triggers) for
...
this phase, lean upon the [event feed](automate/events/#event-feed) in the UI to see events as they happen.
