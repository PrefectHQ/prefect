...
<Note>Prefect Client Version 3.1.12 or later is required to use SLAs.</Note>
...
To define an SLA you can add them to the Deployment either through the `prefect.yaml` file, through using `.deploy` or the CLI.
