...
## Associating parameters with schedules
...
```
Note our flow has a default `message` parameter, but we've overridden it for the second schedule.
...
deployments:
  ...
  schedules:
    - cron: "0 8 * * *"
      parameters:
        to: "jim.halpert@dundermiflin.com"
    - cron: "5 8 * * *"
      parameters:
        to: "dwight.schrute@dundermiflin.com"
        message: "Stop goofing off! You're assistant _to_ the regional manager!"
