...
### `resolve_variables` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/templating/__init__.py#L409" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
