...
### `is_client_retryable_exception` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L199" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
is_client_retryable_exception(exc: Exception) -> bool
```

### `replace_placeholder_string_in_files` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L228" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `copy_directory` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L255" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
copy_directory(directory: str, path: str) -> None
```

### `create_api_app` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L312" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `create_ui_app` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L427" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
create_ui_app(ephemeral: bool) -> FastAPI
```

### `create_app` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L585" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `SPAStaticFiles` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L135" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `RequestLimitMiddleware` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L150" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `SubprocessASGIServer` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L771" target="_blank"><Icon icon="github" size="14" /></a></sup>

**Methods:**

#### `find_available_port` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L793" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
find_available_port(self) -> int
```

#### `is_port_available` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L803" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
is_port_available(port: int) -> bool
```

#### `address` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L814" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
address(self) -> str
```

#### `api_url` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L818" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
api_url(self) -> str
```

#### `start` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L821" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `stop` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/api/server.py#L915" target="_blank"><Icon icon="github" size="14" /></a></sup>
