...
### `init` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/cli/deploy.py#L121" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `deploy` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/cli/deploy.py#L238" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
