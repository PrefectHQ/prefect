...
### `BaseJobConfiguration` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L99" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `BaseVariables` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L369" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `BaseWorkerResult` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L420" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

### `BaseWorker` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L435" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

**Methods:**

#### `client` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L511" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
client(self) -> PrefectClient
```

#### `get_all_available_worker_types` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L578" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `get_and_submit_flow_runs` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L962" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
get_and_submit_flow_runs(self) -> list['FlowRun']
```

#### `get_default_base_job_template` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L547" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
get_default_base_job_template(cls) -> dict[str, Any]
```

#### `get_description` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L543" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
get_description(cls) -> str
```

#### `get_documentation_url` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L535" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
get_documentation_url(cls) -> str
```

#### `get_flow_run_logger` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L591" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
get_flow_run_logger(self, flow_run: 'FlowRun') -> PrefectLogAdapter
```

#### `get_logo_url` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L539" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
get_logo_url(cls) -> str
```

#### `get_name_slug` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L588" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
get_name_slug(self) -> str
```

#### `get_status` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L1324" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `get_worker_class_from_type` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L565" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `is_worker_still_polling` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L933" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `limiter` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L527" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
limiter(self) -> anyio.CapacityLimiter
```

#### `run` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L686" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `setup` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L895" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `start` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L607" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `submit` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L718" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `sync_with_backend` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L1084" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `teardown` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L915" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `work_pool` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/workers/base.py#L519" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
