...
### `method_paths_from_routes` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/utilities/server.py#L15" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `PrefectAPIRoute` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/utilities/server.py#L30" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `get_route_handler` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/utilities/server.py#L42" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
get_route_handler(self) -> Callable[[Request], Coroutine[Any, Any, Response]]
```

### `PrefectRouter` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/utilities/server.py#L59" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `add_api_route` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/utilities/server.py#L68" target="_blank"><Icon icon="github" size="14" /></a></sup>
