...
### `MemoryLockManager` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L27" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `aacquire_lock` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L117" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `acquire_lock` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L64" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `await_for_lock` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L211" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `is_lock_holder` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L189" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `is_locked` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L186" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `release_lock` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L172" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `wait_for_lock` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/locking/memory.py#L197" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
