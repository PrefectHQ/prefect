...
### `get_call_parameters` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L43" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `get_parameter_defaults` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L83" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `explode_variadic_parameter` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L100" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `collapse_variadic_parameters` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L134" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `parameters_to_args_kwargs` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L178" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `call_with_parameters` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L201" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `cloudpickle_wrapped_call` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L213" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `parameter_docstrings` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L254" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `process_v1_params` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L282" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
process_v1_params(param: inspect.Parameter) -> tuple[str, Any, Any]
```

### `create_v1_schema` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L313" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
create_v1_schema(name_: str, model_cfg: type[Any], model_fields: Optional[dict[str, Any]] = None) -> dict[str, Any]
```

### `parameter_schema` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L331" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `parameter_schema_from_entrypoint` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L357" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `generate_parameter_schema` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L391" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `raise_for_reserved_arguments` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L447" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `expand_mapping_parameters` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L661" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `ParameterSchema` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L238" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `model_dump_for_openapi` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L247" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
model_dump_for_openapi(self) -> dict[str, Any]
```

### `ModelConfig` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/callables.py#L419" target="_blank"><Icon icon="github" size="14" /></a></sup>
