...
### `consume_process_output` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/processutils/__init__.py#L456" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `stream_text` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/processutils/__init__.py#L476" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
stream_text(source: TextReceiveStream, *sinks: Optional[TextSink[str]]) -> None
```

### `forward_signal_handler` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/processutils/__init__.py#L507" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `setup_signal_handlers_server` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/processutils/__init__.py#L542" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `setup_signal_handlers_agent` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/processutils/__init__.py#L561" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `setup_signal_handlers_worker` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/processutils/__init__.py#L579" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `get_sys_executable` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/processutils/__init__.py#L599" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
