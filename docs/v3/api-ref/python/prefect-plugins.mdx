...
### `safe_load_entrypoints` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/plugins.py#L20" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `load_prefect_collections` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/plugins.py#L43" target="_blank"><Icon icon="github" size="14" /></a></sup>
