...
### `start` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/cli/worker.py#L45" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `InstallPolicy` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/cli/worker.py#L37" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
