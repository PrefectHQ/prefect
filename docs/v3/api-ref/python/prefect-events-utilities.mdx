...
### `emit_event` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/events/utilities.py#L28" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
