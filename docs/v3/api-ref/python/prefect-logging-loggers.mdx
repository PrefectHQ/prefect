...
### `get_logger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L74" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `get_run_logger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L101" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `flow_run_logger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L188" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
flow_run_logger(flow_run: 'FlowRun | None' = None, flow: 'Flow[Any, Any] | None' = None, flow_run_id: UUID | None = None, **kwargs: Any) -> PrefectLogAdapter
```
...
### `task_run_logger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L233" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `get_worker_logger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L277" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `disable_logger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L303" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `disable_run_logger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L323" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `print_as_log` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L333" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `patch_print` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L391" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `PrefectLogAdapter` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L35" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `getChild` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L51" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
getChild(self, suffix: str, extra: dict[str, Any] | None = None) -> 'PrefectLogAdapter'
```

#### `process` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L45" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
process(self, msg: str, kwargs: MutableMapping[str, Any]) -> tuple[str, MutableMapping[str, Any]]
```

### `LogEavesdropper` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L406" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `emit` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L459" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `text` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/logging/loggers.py#L463" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
