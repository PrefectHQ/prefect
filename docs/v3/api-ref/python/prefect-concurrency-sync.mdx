...
### `concurrency` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/concurrency/sync.py#L73" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `rate_limit` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/concurrency/sync.py#L171" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
