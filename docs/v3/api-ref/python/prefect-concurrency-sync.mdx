...
### `concurrency` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/concurrency/sync.py#L49" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `rate_limit` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/concurrency/sync.py#L109" target="_blank"><Icon icon="github" size="14" /></a></sup>
