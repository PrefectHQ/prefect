...
### `exit_with_error_if_not_editable_install` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/cli/dev.py#L43" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
exit_with_error_if_not_editable_install() -> None
```

### `build_docs` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/cli/dev.py#L57" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `build_ui` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/cli/dev.py#L86" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
build_ui(no_install: bool = False)
```

### `build_image` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/cli/dev.py#L227" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `container` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/cli/dev.py#L296" target="_blank"><Icon icon="github" size="14" /></a></sup>
