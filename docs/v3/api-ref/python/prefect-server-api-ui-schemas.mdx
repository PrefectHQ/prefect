...
### `validate_obj` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/server/api/ui/schemas.py#L29" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
