...
### `get_current_settings` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/settings/context.py#L10" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `temporary_settings` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/settings/context.py#L25" target="_blank"><Icon icon="github" size="14" /></a></sup>
