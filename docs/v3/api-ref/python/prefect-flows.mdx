...
### `bind_flow_to_infrastructure` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2243" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `select_flow` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2278" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `load_flow_from_entrypoint` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2324" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `load_function_and_convert_to_flow` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2376" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `serve` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2399" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `load_placeholder_flow` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2687" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `safe_load_flow_from_entrypoint` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2722" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `load_flow_arguments_from_entrypoint` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2892" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `is_entrypoint_async` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2972" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `FlowStateHook` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L120" target="_blank"><Icon icon="github" size="14" /></a></sup>


A callable that is invoked when a flow enters a given state.


### `Flow` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L144" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `ismethod` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L407" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
ismethod(self) -> bool
```

#### `isclassmethod` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L411" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
isclassmethod(self) -> bool
```

#### `isstaticmethod` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L415" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
isstaticmethod(self) -> bool
```

#### `with_options` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L439" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `validate_parameters` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L577" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `serialize_parameters` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L653" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `to_deployment` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L831" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `on_completion` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L975" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
on_completion(self, fn: FlowStateHook[P, R]) -> FlowStateHook[P, R]
```

#### `on_cancellation` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L979" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
on_cancellation(self, fn: FlowStateHook[P, R]) -> FlowStateHook[P, R]
```

#### `on_crashed` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L983" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
on_crashed(self, fn: FlowStateHook[P, R]) -> FlowStateHook[P, R]
```

#### `on_running` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L987" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
on_running(self, fn: FlowStateHook[P, R]) -> FlowStateHook[P, R]
```

#### `on_failure` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L991" target="_blank"><Icon icon="github" size="14" /></a></sup>

```python
on_failure(self, fn: FlowStateHook[P, R]) -> FlowStateHook[P, R]
```

#### `serve` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L995" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `from_source` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L1264" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `FlowDecorator` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L1766" target="_blank"><Icon icon="github" size="14" /></a></sup>

### `InfrastructureBoundFlow` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2026" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `submit` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2142" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `with_options` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/flows.py#L2185" target="_blank"><Icon icon="github" size="14" /></a></sup>
