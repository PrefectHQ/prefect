...
### `materialize` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/assets/materialize.py#L17" target="_blank"><Icon icon="github" size="14" /></a></sup>
