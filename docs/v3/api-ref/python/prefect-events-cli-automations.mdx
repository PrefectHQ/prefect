...
### `requires_automations` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/events/cli/automations.py#L32" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
requires_automations(func: Callable[..., Any]) -> Callable[..., Any]
```

### `ls` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/events/cli/automations.py#L47" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `inspect` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/events/cli/automations.py#L106" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
