...
### `watch` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/cli/flow_run.py#L661" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `execute` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/cli/flow_run.py#L693" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
