...
### `generate_slug` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/names.py#L29" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `obfuscate` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/names.py#L45" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `obfuscate_string` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/prefect/utilities/names.py#L55" target="_blank"><Icon icon="github" size="14" /></a></sup>
