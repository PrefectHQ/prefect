...
### `BaseOrchestrationPolicy` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/orchestration/policies.py#L30" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `priority` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/orchestration/policies.py#L41" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
#### `compile_transition_rules` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/orchestration/policies.py#L51" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `TaskRunOrchestrationPolicy` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/orchestration/policies.py#L69" target="_blank"><Icon icon="github" size="14" /></a></sup>

### `FlowRunOrchestrationPolicy` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/orchestration/policies.py#L75" target="_blank"><Icon icon="github" size="14" /></a></sup>

### `GenericOrchestrationPolicy` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/orchestration/policies.py#L81" target="_blank"><Icon icon="github" size="14" /></a></sup>
