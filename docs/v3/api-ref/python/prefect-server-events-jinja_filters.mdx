...
### `ui_url` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/events/jinja_filters.py#L33" target="_blank"><Icon icon="github" size="14" /></a></sup>
...
### `ui_resource_events_url` <sup><a href="https://github.com/prefecthq/prefect/blob/main/src/prefect/server/events/jinja_filters.py#L39" target="_blank"><Icon icon="github" size="14" /></a></sup>
