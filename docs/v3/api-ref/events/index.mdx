...
| `prefect.work-pool.created` | Work pool created | [Work pool and queue events](/v3/api-ref/events/work-pool-queue-events) |
| `prefect.work-pool.deleted` | Work pool deleted | [Work pool and queue events](/v3/api-ref/events/work-pool-queue-events) |
...
| `prefect.work-queue.created` | Work queue created | [Work pool and queue events](/v3/api-ref/events/work-pool-queue-events) |
| `prefect.work-queue.deleted` | Work queue deleted | [Work pool and queue events](/v3/api-ref/events/work-pool-queue-events) |
...
| Event | Description | Page |
|-------|-------------|------|
| `prefect.artifact-collection.created` | Artifact collection created | [Artifact and asset events](/v3/api-ref/events/artifact-asset-events) |
| `prefect.artifact-collection.updated` | Artifact collection latest version changed | [Artifact and asset events](/v3/api-ref/events/artifact-asset-events) |
| `prefect.artifact-collection.deleted` | Artifact collection deleted | [Artifact and asset events](/v3/api-ref/events/artifact-asset-events) |
| `prefect.artifact.created` | Individual artifact created | [Artifact and asset events](/v3/api-ref/events/artifact-asset-events) |
| `prefect.artifact.updated` | Individual artifact updated | [Artifact and asset events](/v3/api-ref/events/artifact-asset-events) |
...
| Event | Description | Page |
|-------|-------------|------|
| `prefect.concurrency-limit.created` | Concurrency limit created | [Concurrency events](/v3/api-ref/events/concurrency-events) |
| `prefect.concurrency-limit.updated` | Concurrency limit configuration changed | [Concurrency events](/v3/api-ref/events/concurrency-events) |
| `prefect.concurrency-limit.deleted` | Concurrency limit deleted | [Concurrency events](/v3/api-ref/events/concurrency-events) |
...
| Event | Description | Page |
|-------|-------------|------|
| `prefect.automation.created` | Automation created | [Automation events](/v3/api-ref/events/automation-events) |
| `prefect.automation.updated` | Automation updated | [Automation events](/v3/api-ref/events/automation-events) |
| `prefect.automation.deleted` | Automation deleted | [Automation events](/v3/api-ref/events/automation-events) |
