---
title: " "
sidebarTitle: prefect main flows
---
...
```command
prefect main flows [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main flows ls`



```command
prefect main flows ls [OPTIONS]
```
...
## `prefect main flows serve`



```command
prefect main flows serve [OPTIONS] ENTRYPOINT
```
