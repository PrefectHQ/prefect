---
title: " "
sidebarTitle: prefect main work-pool
---


# `prefect main work-pool`



```command
prefect main work-pool [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main work-pool create`



```command
prefect main work-pool create [OPTIONS] NAME
```
...
## `prefect main work-pool ls`



```command
prefect main work-pool ls [OPTIONS]
```
...
## `prefect main work-pool inspect`



```command
prefect main work-pool inspect [OPTIONS] NAME
```
...
## `prefect main work-pool pause`



```command
prefect main work-pool pause [OPTIONS] NAME
```
...
## `prefect main work-pool resume`



```command
prefect main work-pool resume [OPTIONS] NAME
```
...
## `prefect main work-pool update`



```command
prefect main work-pool update [OPTIONS] NAME
```
...
## `prefect main work-pool provision-infrastructure`



```command
prefect main work-pool provision-infrastructure [OPTIONS] NAME
```
...
## `prefect main work-pool provision-infra`



```command
prefect main work-pool provision-infra [OPTIONS] NAME
```
...
## `prefect main work-pool delete`



```command
prefect main work-pool delete [OPTIONS] NAME
```
...
## `prefect main work-pool set-concurrency-limit`



```command
prefect main work-pool set-concurrency-limit [OPTIONS] NAME CONCURRENCY_LIMIT
```
...
## `prefect main work-pool clear-concurrency-limit`



```command
prefect main work-pool clear-concurrency-limit [OPTIONS] NAME
```
...
## `prefect main work-pool get-default-base-job-template`



```command
prefect main work-pool get-default-base-job-template [OPTIONS]
```
...
## `prefect main work-pool preview`



```command
prefect main work-pool preview [OPTIONS] [NAME]
```
