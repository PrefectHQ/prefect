---
title: " "
sidebarTitle: prefect main task-run
---


# `prefect main task-run`



```command
prefect main task-run [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main task-run inspect`



```command
prefect main task-run inspect [OPTIONS] ID
```
...
## `prefect main task-run ls`



```command
prefect main task-run ls [OPTIONS]
```
...
## `prefect main task-run logs`



```command
prefect main task-run logs [OPTIONS] ID
```
