...
```command
prefect main gcl [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main gcl inspect`



```command
prefect main gcl inspect [OPTIONS] NAME
```
...
## `prefect main gcl delete`



```command
prefect main gcl delete [OPTIONS] NAME
```
...
## `prefect main gcl enable`



```command
prefect main gcl enable [OPTIONS] NAME
```
...
## `prefect main gcl disable`



```command
prefect main gcl disable [OPTIONS] NAME
```
...
## `prefect main gcl update`



```command
prefect main gcl update [OPTIONS] NAME
```
...
## `prefect main gcl create`



```command
prefect main gcl create [OPTIONS] NAME
```
