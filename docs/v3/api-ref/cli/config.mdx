---
title: " "
sidebarTitle: prefect main config
---
...
```command
prefect main config [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main config set`



```command
prefect main config set [OPTIONS] SETTINGS...
```
...
## `prefect main config validate`



```command
prefect main config validate [OPTIONS]
```
...
## `prefect main config unset`



```command
prefect main config unset [OPTIONS] SETTING_NAMES...
```
...
## `prefect main config view`



```command
prefect main config view [OPTIONS]
```
