---
title: " "
sidebarTitle: prefect main flow-run
---


# `prefect main flow-run`



```command
prefect main flow-run [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main flow-run inspect`



```command
prefect main flow-run inspect [OPTIONS] ID
```
...
## `prefect main flow-run ls`



```command
prefect main flow-run ls [OPTIONS]
```
...
## `prefect main flow-run delete`



```command
prefect main flow-run delete [OPTIONS] ID
```
...
## `prefect main flow-run cancel`



```command
prefect main flow-run cancel [OPTIONS] ID
```
...
## `prefect main flow-run logs`



```command
prefect main flow-run logs [OPTIONS] ID
```
...
## `prefect main flow-run execute`



```command
prefect main flow-run execute [OPTIONS] [ID]
```
