---
title: " "
sidebarTitle: prefect main deployment
---


# `prefect main deployment`



```command
prefect main deployment [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main deployment inspect`



```command
prefect main deployment inspect [OPTIONS] NAME
```
...
## `prefect main deployment ls`



```command
prefect main deployment ls [OPTIONS]
```
...
## `prefect main deployment run`



```command
prefect main deployment run [OPTIONS] [NAME]
```
...
## `prefect main deployment delete`



```command
prefect main deployment delete [OPTIONS] [NAME]
```
...
## `prefect main deployment schedule`



```command
prefect main deployment schedule [OPTIONS] COMMAND [ARGS]...
```
...
### `prefect main deployment schedule create`



```command
prefect main deployment schedule create [OPTIONS] NAME
```
...
### `prefect main deployment schedule delete`



```command
prefect main deployment schedule delete [OPTIONS] DEPLOYMENT_NAME SCHEDULE_ID
```
...
### `prefect main deployment schedule pause`



```command
prefect main deployment schedule pause [OPTIONS] DEPLOYMENT_NAME SCHEDULE_ID
```
...
### `prefect main deployment schedule resume`



```command
prefect main deployment schedule resume [OPTIONS] DEPLOYMENT_NAME SCHEDULE_ID
```
...
### `prefect main deployment schedule ls`



```command
prefect main deployment schedule ls [OPTIONS] DEPLOYMENT_NAME
```
...
### `prefect main deployment schedule clear`



```command
prefect main deployment schedule clear [OPTIONS] DEPLOYMENT_NAME
```
