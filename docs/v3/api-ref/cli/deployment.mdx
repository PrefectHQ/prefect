...
```command
prefect deployment schedule pause [OPTIONS] [ARGS]
```
...
```command
prefect deployment schedule resume [OPTIONS] [ARGS]
```
...
```command
prefect deployment ls [OPTIONS] [ARGS]
```
...
<Accordion title="Arguments" defaultOpen>
<ResponseField name="FLOW_NAME" type="string">
...
```command
prefect deployment run [OPTIONS] [ARGS]
```
...
<ResponseField name="--job-variable">
...
```command
prefect deployment delete [OPTIONS] [ARGS]
```
