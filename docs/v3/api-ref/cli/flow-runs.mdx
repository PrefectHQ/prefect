---
title: " "
sidebarTitle: prefect main flow-runs
---


# `prefect main flow-runs`



```command
prefect main flow-runs [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main flow-runs inspect`



```command
prefect main flow-runs inspect [OPTIONS] ID
```
...
## `prefect main flow-runs ls`



```command
prefect main flow-runs ls [OPTIONS]
```
...
## `prefect main flow-runs delete`



```command
prefect main flow-runs delete [OPTIONS] ID
```
...
## `prefect main flow-runs cancel`



```command
prefect main flow-runs cancel [OPTIONS] ID
```
...
## `prefect main flow-runs logs`



```command
prefect main flow-runs logs [OPTIONS] ID
```
...
## `prefect main flow-runs execute`



```command
prefect main flow-runs execute [OPTIONS] [ID]
```
