---
title: " "
sidebarTitle: prefect main shell
---
...
```command
prefect main shell [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main shell watch`



```command
prefect main shell watch [OPTIONS] COMMAND
```
...
## `prefect main shell serve`



```command
prefect main shell serve [OPTIONS] COMMAND
```
