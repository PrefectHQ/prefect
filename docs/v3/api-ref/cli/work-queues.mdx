---
title: " "
sidebarTitle: prefect main work-queues
---


# `prefect main work-queues`



```command
prefect main work-queues [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main work-queues create`



```command
prefect main work-queues create [OPTIONS] NAME
```
...
## `prefect main work-queues set-concurrency-limit`



```command
prefect main work-queues set-concurrency-limit [OPTIONS] NAME LIMIT
```
...
## `prefect main work-queues clear-concurrency-limit`



```command
prefect main work-queues clear-concurrency-limit [OPTIONS] NAME
```
...
## `prefect main work-queues pause`



```command
prefect main work-queues pause [OPTIONS] NAME
```
...
## `prefect main work-queues resume`



```command
prefect main work-queues resume [OPTIONS] NAME
```
...
## `prefect main work-queues inspect`



```command
prefect main work-queues inspect [OPTIONS] [NAME]
```
...
## `prefect main work-queues ls`



```command
prefect main work-queues ls [OPTIONS]
```
...
## `prefect main work-queues preview`



```command
prefect main work-queues preview [OPTIONS] [NAME]
```
...
## `prefect main work-queues delete`



```command
prefect main work-queues delete [OPTIONS] NAME
```
...
## `prefect main work-queues read-runs`



```command
prefect main work-queues read-runs [OPTIONS] NAME
```
