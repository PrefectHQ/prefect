---
title: " "
sidebarTitle: prefect main flow
---
...
```command
prefect main flow [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main flow ls`



```command
prefect main flow ls [OPTIONS]
```
...
## `prefect main flow serve`



```command
prefect main flow serve [OPTIONS] ENTRYPOINT
```
