---
title: " "
sidebarTitle: prefect main concurrency-limit
---


# `prefect main concurrency-limit`



```command
prefect main concurrency-limit [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main concurrency-limit create`



```command
prefect main concurrency-limit create [OPTIONS] TAG CONCURRENCY_LIMIT
```
...
## `prefect main concurrency-limit inspect`



```command
prefect main concurrency-limit inspect [OPTIONS] TAG
```
...
## `prefect main concurrency-limit ls`



```command
prefect main concurrency-limit ls [OPTIONS]
```
...
## `prefect main concurrency-limit reset`



```command
prefect main concurrency-limit reset [OPTIONS] TAG
```
...
## `prefect main concurrency-limit delete`



```command
prefect main concurrency-limit delete [OPTIONS] TAG
```
