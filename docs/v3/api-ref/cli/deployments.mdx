...
```command
prefect deployments schedule pause [OPTIONS] [ARGS]
```
...
```command
prefect deployments schedule resume [OPTIONS] [ARGS]
```
...
```command
prefect deployments ls [OPTIONS] [ARGS]
```
...
```command
prefect deployments run [OPTIONS] [ARGS]
```
...
```command
prefect deployments delete [OPTIONS] [ARGS]
```
