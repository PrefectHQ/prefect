---
title: " "
sidebarTitle: prefect main deployments
---


# `prefect main deployments`



```command
prefect main deployments [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main deployments inspect`



```command
prefect main deployments inspect [OPTIONS] NAME
```
...
## `prefect main deployments ls`



```command
prefect main deployments ls [OPTIONS]
```
...
## `prefect main deployments run`



```command
prefect main deployments run [OPTIONS] [NAME]
```
...
## `prefect main deployments delete`



```command
prefect main deployments delete [OPTIONS] [NAME]
```
...
## `prefect main deployments schedule`



```command
prefect main deployments schedule [OPTIONS] COMMAND [ARGS]...
```
...
### `prefect main deployments schedule create`



```command
prefect main deployments schedule create [OPTIONS] NAME
```
...
### `prefect main deployments schedule delete`



```command
prefect main deployments schedule delete [OPTIONS] DEPLOYMENT_NAME SCHEDULE_ID
```
...
### `prefect main deployments schedule pause`



```command
prefect main deployments schedule pause [OPTIONS] DEPLOYMENT_NAME SCHEDULE_ID
```
...
### `prefect main deployments schedule resume`



```command
prefect main deployments schedule resume [OPTIONS] DEPLOYMENT_NAME SCHEDULE_ID
```
...
### `prefect main deployments schedule ls`



```command
prefect main deployments schedule ls [OPTIONS] DEPLOYMENT_NAME
```
...
### `prefect main deployments schedule clear`



```command
prefect main deployments schedule clear [OPTIONS] DEPLOYMENT_NAME
```
