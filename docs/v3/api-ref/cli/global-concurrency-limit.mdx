---
title: " "
sidebarTitle: prefect main global-concurrency-limit
---


# `prefect main global-concurrency-limit`



```command
prefect main global-concurrency-limit [OPTIONS] COMMAND [ARGS]...
```
...
## `prefect main global-concurrency-limit ls`



```command
prefect main global-concurrency-limit ls [OPTIONS]
```
...
## `prefect main global-concurrency-limit inspect`



```command
prefect main global-concurrency-limit inspect [OPTIONS] NAME
```
...
## `prefect main global-concurrency-limit delete`



```command
prefect main global-concurrency-limit delete [OPTIONS] NAME
```
...
## `prefect main global-concurrency-limit enable`



```command
prefect main global-concurrency-limit enable [OPTIONS] NAME
```
...
## `prefect main global-concurrency-limit disable`



```command
prefect main global-concurrency-limit disable [OPTIONS] NAME
```
...
## `prefect main global-concurrency-limit update`



```command
prefect main global-concurrency-limit update [OPTIONS] NAME
```
...
## `prefect main global-concurrency-limit create`



```command
prefect main global-concurrency-limit create [OPTIONS] NAME
```
