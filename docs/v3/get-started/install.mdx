...
keywords: ["install", "pip", "setup", "installation", "uv", "conda", "requirements"]
---
...
<Note>
If you self-host a Prefect server, keep your client version compatible with the server (generally, client version less than or equal to server version). Prefect Cloud is compatible with all client versions. See [Versioning and compatibility](/v3/release-notes/versioning) for the rules.
</Note>
...
<Note>
Prefect Cloud is compatible with all client versions. If you self-host a Prefect server, keep your client version compatible with the server (generally, client version less than or equal to server version). See [Versioning and compatibility](/v3/release-notes/versioning) for the rules.
</Note>
