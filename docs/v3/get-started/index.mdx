...
See the [Prefect MCP server guide](/v3/how-to-guides/ai/use-prefect-mcp-server) for detailed setup instructions, credential configuration, and advanced usage.

**Documentation-only access:**

For AI-powered documentation search without connecting to your workflows, use the docs proxy at `https://docs.prefect.io/mcp` in Claude Desktop, Cursor, or VS Code.
