...
<CardGroup cols={3}>
  ...
  <Card title="Prefect Cloud" icon="cloud" href="manage/cloud/index">
    Supercharge Prefect with enhanced governance, security, and performance capabilities.
  </Card>
  <Card title="Upgrade to Prefect 3" icon="sparkles" href="resources/upgrade-to-prefect-3">
