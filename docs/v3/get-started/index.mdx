...
<CardGroup cols={3}>
  <Card title="Flow examples" icon="play" href="/v3/examples/flows">
    Explore example flows for common patterns and use cases.
  </Card>
  <Card title="Deployment examples" icon="rocket" href="/v3/examples/deployments">
    See examples of deploying flows to different infrastructure.
  </Card>
  <Card title="Infrastructure examples" icon="server" href="/v3/examples/infrastructure">
    Examples of using Prefect with various infrastructure platforms.
  </Card>
</CardGroup>
