...
The Prefect MCP server connects AI assistants to your Prefect workflows, enabling them to monitor deployments, debug flow runs, and query your infrastructure.
...
See the [MCP Servers documentation](/v3/mcp-servers) for setup options, or jump directly to the [Prefect MCP Server guide](/v3/how-to-guides/ai/use-prefect-mcp-server) for detailed installation instructions.

**Documentation-only access:**

For AI-powered documentation search without connecting to your workflows, see the [Prefect Docs MCP guide](/v3/mcp-servers/prefect-docs-mcp) to configure the hosted docs server at `https://docs.prefect.io/mcp`.
