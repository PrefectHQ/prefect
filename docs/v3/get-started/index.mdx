...
Use the Prefect MCP server to give AI assistants both live Prefect documentation and read-only runtime visibility into your Prefect instance.

<CardGroup cols={1}>
  <Card title="Prefect MCP Server" icon="chart-network" href="/v3/how-to-guides/ai/use-prefect-mcp-server">
    Install once to inspect deployments, flow runs, task runs, and logs while also using integrated docs search.
  </Card>
</CardGroup>
