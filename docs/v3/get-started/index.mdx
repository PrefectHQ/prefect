...
See the [MCP Servers documentation](/v3/mcp-servers) for setup options, or jump directly to the [Prefect MCP Server guide](/v3/mcp-servers/prefect-mcp-server) for detailed installation instructions.
