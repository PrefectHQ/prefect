...
<CardGroup cols={3}>
  ...
  <Card title="Connect AI assistants" icon="robot" href="/v3/how-to-guides/ai/index">
    Set up Prefect MCP integrations for docs search and workflow diagnostics.
  </Card>
...
Use MCP to give AI assistants live Prefect documentation and (optionally) read-only runtime visibility into your Prefect instance.

<CardGroup cols={2}>
  <Card title="Prefect Docs MCP" icon="book" href="/v3/how-to-guides/ai/prefect-docs-mcp">
    Connect to the hosted docs endpoint at `https://docs.prefect.io/mcp` for documentation search.
  </Card>
  <Card title="Prefect MCP Server" icon="chart-network" href="/v3/how-to-guides/ai/use-prefect-mcp-server">
    Install the MCP server to inspect deployments, flow runs, task runs, and logs from your assistant.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Use AI assistants" icon="robot" href="/v3/how-to-guides/ai/index">
    Connect AI assistants with Prefect MCP integrations.
  </Card>
</CardGroup>
