...
> **Note**: This example uses **dbt Core** (the open-source CLI). For dbt Cloud integration, see the [dbt Cloud guide](/integrations/prefect-dbt/dbt-cloud) in the Prefect documentation.
...
*For more on integrating Prefect with dbt, see the [`prefect-dbt` guide](/integrations/prefect-dbt).*
