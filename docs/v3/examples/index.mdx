...
<CardGroup cols={3}>
          ...
          <Card title="Simple web scraper" icon="globe" href="/v3/examples/simple_web_scraper">
            Learn how to scrape article content from web pages with Prefect tasks, retries, and automatic logging.
          </Card>

          
          <Card title="API-sourced ETL – Prefect + pandas" icon="database" href="/v3/examples/run_api_sourced_etl">
          ...
          <Card title="dbt Model Orchestration – Prefect + dbt" icon="database" href="/v3/examples/run_dbt_with_prefect">
