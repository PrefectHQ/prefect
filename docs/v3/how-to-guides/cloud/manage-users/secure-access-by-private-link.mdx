...
- Run `nslookup api.private.prefect.cloud` to confirm DNS resolves. If you get `NXDOMAIN`, Private DNS is not enabled on the VPC Endpoint or you are running the command from outside the VPC.
