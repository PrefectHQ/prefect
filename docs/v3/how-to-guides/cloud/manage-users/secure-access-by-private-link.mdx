...
Your Prefect team will provide two VPC Endpoint Service names (one for API, one for UI). Create a VPC Endpoint in your AWS account for each service you want to use.
...
Prefect will match your pending connection and accept it once approved.
