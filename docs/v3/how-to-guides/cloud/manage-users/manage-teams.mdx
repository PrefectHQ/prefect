...
In SCIM environments:
- **Teams**: Governed by identity provider directory groups
- **Users**: Governed by identity provider (automatic provisioning/deprovisioning)
- **Service accounts**: Manually managed (can be added to any team)
