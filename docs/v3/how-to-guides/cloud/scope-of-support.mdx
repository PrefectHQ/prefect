...
| Component | Prefect Open Source | Prefect Cloud (hybrid execution) | Prefect Cloud (Prefect Serverless) | Prefect Horizon | FastMCP |
| --- | --- | --- | --- | --- | --- |
| Control plane / API | You | **Prefect** | **Prefect** | **Prefect** | — |
| Execution infrastructure | You | You | **Prefect** | **Prefect** | You |
| Your code (flows, tasks, and MCP tools) | You | You | You | You | You |
| Networking from your environment | You | You | You | You | You |
| Third-party services | You | You | You | You | You |
