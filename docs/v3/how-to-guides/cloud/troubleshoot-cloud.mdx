...
If your environment restricts outbound traffic, allow the endpoints listed in 
[Configure network access for restricted environments](/v3/how-to-guides/configuration/configure-network-access).
