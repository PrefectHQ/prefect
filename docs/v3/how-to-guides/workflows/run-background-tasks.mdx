...
{/* pmd-metadata: notest */}
```pythonfrom prefect import task
from prefect import task
...
Check out the [prefect-background-task-examples](https://github.com/PrefectHQ/prefect-background-task-examples) repository for reference implementations of applications leveraging background tasks.