---
title: How to serve flows in a long-lived Docker container
sidebarTitle: Serve Flows in a static container
description: Learn how to serve a flow in a long-lived Docker container
---

The `.serve` method allows you to easily elevate a flow to a deployment, listening for scheduled work to execute [as a local process](/v3/how-to-guides/deployments/run-flows-in-local-processes).
