...
Any kwargs passed to the infrastructure decorator will override the corresponding default value in the [base job template](/v3/how-to-guides/deployments/manage-work-pools#base-job-template) for the specified work pool.
