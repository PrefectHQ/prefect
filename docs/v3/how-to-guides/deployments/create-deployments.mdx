...
keywords: ["deployment", "create", "CLI", "Python", "Terraform", "deploy"]
---
...
Prefect offers two options for creating deployments with [dynamic infrastructure](/v3/concepts/work-pools):
- [Deployments created with the Python SDK](/v3/how-to-guides/deployments/deploy-via-python)
- [Deployments created with a YAML file](/v3/how-to-guides/deployments/prefect-yaml)
...
To learn more about the `deploy` method, see [Deploy flows with Python](/v3/how-to-guides/deployments/deploy-via-python).

### Create a deployment with a YAML file

If you'd rather take a declarative approach to defining a deployment through a YAML file, use a [`prefect.yaml` file](/v3/how-to-guides/deployments/prefect-yaml).
...
Learn more about creating deployments with a YAML file in [Define deployments with YAML](/v3/how-to-guides/deployments/prefect-yaml).

Prefect also provides [CI/CD options](/v3/advanced/deploy-ci-cd) for automatically creating YAML-based deployments. 
