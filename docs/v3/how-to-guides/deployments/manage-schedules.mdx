...
description: Learn how to pause, resume, and remove deployment schedules using the Prefect CLI.
keywords: ["schedule", "pause", "resume", "clear", "remove", "manage", "CLI"]
---
...
```bash
prefect deployment schedule clear my-flow/my-deployment
```
...
```bash
prefect deployment schedule clear my-flow/my-deployment -y
```
