...
Add the Prefect MCP server to Kiro by creating or editing `.kiro/settings/mcp.json` in your workspace:
...
Click the Kiro (ghost) logo on the Activity Bar, and check the "MCP Servers" view for your server listing.
