...
the generated Dockerfile, or rely on Prefect's [runtime `uv` behavior](/v3/how-to-guides/deployments/store-flow-code#python-project-dependencies-in-custom-images)
