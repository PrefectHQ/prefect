...
keywords: ["Modal", "push work pool", "serverless", "GPU", "cloud compute"]
---
...
To keep things simple, this tutorial will use the default queue name that comes with every new pool.
