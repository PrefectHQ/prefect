...
target namespace as well. If you manage RBAC entirely outside of Helm, apply the
permissions described below.

### Required permissions

At minimum, the worker needs a Role (or ClusterRole) in the namespace(s) where it
creates jobs:
...
rules:
  ...
  # Receive Kubernetes events for the observer
  - apiGroups: [""]
    resources: ["events"]
    verbs: ["get", "watch", "list"]
...
rules:
  # Required by the kopf operator framework
  - apiGroups: [""]
