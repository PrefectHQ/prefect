...
[triggers](/v3/automate/events/custom-triggers/) for more on Prefect Events concepts
...
See this [example](/v3/automate/events/automations-triggers#trigger-a-downstream-deployment-with-an-event) that triggers downstream work on upstream events.
</Tip>
...
See [Serve flows in a long-lived Docker container](/v3/deploy/static-infrastructure-examples/docker) for a guide.
