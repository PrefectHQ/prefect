...
2.  **Retrieve code from storage at runtime:** The [worker](/v3/deploy/infrastructure-concepts/workers/) pulls code from a specified location before starting the flow run.
...
1. [Install the Prefect Cloud GitHub App](https://github.com/apps/{github_app_name}/installations/new?) and authorize it to access your repositories.
