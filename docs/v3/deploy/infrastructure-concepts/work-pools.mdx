...
- Allow work pools to prioritize (or limit) flow runs through the use of [work queues](deploy/infrastructure-concepts/work-pools/#work-queues).
...
2. [Push work pools](deploy/infrastructure-examples/serverless): These submit runs directly to serverless infrastructure providers.
3. [Managed work pools](deploy/infrastructure-examples/managed): These are administered by Prefect and handle both submission and execution of code.
...
Learn more about [customizing job variables](deploy/infrastructure-concepts/customize).
...
**Advanced customization of the base job template**
    ...
    See more information about [overriding a work pool's job variables](deploy/infrastructure-concepts/customize).
</Tip>
...
- Learn more about [workers](deploy/infrastructure-concepts/workers) and how they interact with work pools
- Learn how to [deploy flows](deploy/infrastructure-concepts/prefect-yaml) that run in work pools
- Learn how to set up work pools for:
  - [Kubernetes](deploy/infrastructure-examples/kubernetes)
  - [Docker](deploy/infrastructure-examples/docker)
  - [Serverless platforms](deploy/infrastructure-examples/serverless)
  - [Infrastructure managed by Prefect Cloud](deploy/infrastructure-examples/managed)
