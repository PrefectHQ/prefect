...
Workers poll for work every 15 seconds by default. You can configure this interval in your [profile settings](manage/settings-and-profiles/) 
with the
...
See how to [daemonize a Prefect worker](resources/daemonize-processes/).

See more information on [overriding a work pool's job variables](deploy/infrastructure-concepts/customize).
