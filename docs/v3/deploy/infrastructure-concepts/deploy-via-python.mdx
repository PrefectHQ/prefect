...
the Prefect UI or using the Prefect CLI. For more information, see the [Work Pools](deploy/infrastructure-concepts/work-pools/) guide. 
...
- `schedules`
    ...
    Learn more about schedules [here](automate/add-schedules).
...
Learn more about remote code storage [here](deploy/infrastructure-concepts/store-flow-code/).
...
You can learn more about job variables [here](deploy/infrastructure-concepts/customize).
...
- [Work Pools](deploy/infrastructure-concepts/work-pools/)
- [Store Flow Code](deploy/infrastructure-concepts/store-flow-code/)
- [Customize Infrastructure](deploy/infrastructure-concepts/customize/)
- [Schedules](automate/add-schedules/)
