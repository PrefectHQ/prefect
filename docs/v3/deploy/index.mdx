...
In Prefect Cloud, deployment configuration is versioned, and a new [deployment version](/v3/deploy/deployment-versioning) is created each time a deployment is updated.
...
### Create a deployment with dynamic infrastructure
