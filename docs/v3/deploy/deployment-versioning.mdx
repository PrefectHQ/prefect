...
The examples in this section use GitHub as their source control management platform, so be sure to replace URLs and environment variables with the ones relevant to your platform.
