...
1. With your [CLI authenticated to your Prefect Cloud workspace](manage/cloud/manage-users/api-keys/), run the script to create your deployment:
...
Alternatively, you can create a `requirements.txt` file and reference it in your [prefect.yaml pull step](deploy/infrastructure-concepts/prefect-yaml#utility-steps).
...
Read more about creating deployments in [Run flows in Docker containers](deploy/infrastructure-examples/docker/).

For more control over your infrastructure, such as the ability to run 
custom Docker images, [serverless push work pools](deploy/infrastructure-examples/serverless/) 
