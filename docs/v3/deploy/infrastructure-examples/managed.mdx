...
Flows running on Prefect Managed infrastructure can be assigned static IP addresses on outbound traffic, such as interacting with your system or database.
...
Include these addresses in your firewall rules to explicitly allow flows to communicate with your environment.
