...
3. Python and Prefect [installed](get-started/install/)
...
[Work pools](deploy/infrastructure-concepts/work-pools/) allow you to manage deployment 
infrastructure.
...
[Workers](deploy/infrastructure-examples/docker/).

The [`prefect.yaml`](deploy/infrastructure-concepts/prefect-yaml/#managing-deployments) file is used 
