...
In a production setting this worker should run as a [daemonized or managed process](/v3/develop/daemonize-processes/).
...
- [Daemonize workers](/v3/develop/daemonize-processes/)
