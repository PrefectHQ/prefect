...
- A basic understanding of Prefect flows. Start with the [Getting Started](/2.17.1/getting-started/quickstart/) guide if you're new.
- A recent version of Prefect installed in your command line environment. Follow the instructions in the [docs](/2.17.1/getting-started/installation/) if you have any issues.
...
When you need to run shell commands on a schedule, the `serve` command creates a Prefect [deployment](/2.17.1/concepts/deployments/ for regular execution. This is an extremely quick way to create a deployment that is served by Prefect.
...
- **Configurable execution:** Tailor execution frequency, [concurrency limits](/2.17.1/guides/global-concurrency-limits/), and other parameters to suit your project's needs and resources.
...
Check out the [tutorial](/2.17.1/tutorial/) and explore other Prefect docs to learn how to gain more observability and orchestration capabilities in your workflows. 
