...
![Generating a configuration link for single sign-on in the Prefect Cloud UI.](/2.17.1/img/ui/cloud-sso-provider.png)
...
![Opening the Identity Provider Configuration dashboard.](/2.17.1/img/ui/cloud-sso-dashboard.png)
...
![Cloud UI with SSO & SCIM provisioned](/2.17.1/img/ui/sso-scim-enabled.png)
