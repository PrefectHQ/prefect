...
# User and Service Account Roles <span class="badge cloud"></span>
...
See [Role permissions](#role-permissions) for details of permissions you may set for custom roles.
