...
- [Work Queues](/ui/work-pools/) enable you to create and manage work queues that distribute flow runs to agents.
...
| **Work Queues** | Displays configured [work queues](/ui/work-pools/) and enables creating new work queues. |
