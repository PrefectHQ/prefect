...
![Viewing all available workspaces in the Prefect Cloud UI.](/2.14.21/img/ui/all-workspaces.png)
...
!!! cloud-ad "Workspace-specific features"
    ...
    - [Flow runs](/2.14.21/ui/flow-runs/) and task runs executed in an environment that is [syncing with the workspace](/2.14.21/ui/cloud/#workspaces)
    - [Flows](/2.14.21/concepts/flows/) associated with flow runs or deployments observed by the Prefect Cloud API
    - [Deployments](/2.14.21/concepts/deployments/)
    - [Work pools](/2.14.21/concepts/work-pools/)
    - [Blocks](/2.14.21/ui/blocks/) and [Storage](/2.14.21/concepts/storage/)
...
![Creating a new workspace in the Prefect Cloud UI.](/2.14.21/img/ui/create-workspace.png)
...
![Managing a workspace in the Prefect Cloud UI.](/2.14.21/img/ui/workspace-settings.png)
...
Within a Prefect Cloud Pro or Enterprise tier account, Workspace Owners can invite other people to be members and provision [service accounts](/2.14.21/ui/service-accounts/) to a workspace.
In addition to giving the user access to the workspace, a Workspace Owner assigns a [workspace role](/2.14.21/ui/roles/) to the user.
...
![Managing sharing in a workspace in the Prefect Cloud UI.](/2.14.21/img/ui/workspace-sharing.png)
...
![Initiating a workspace transfer in the Prefect Cloud UI.](/2.14.21/img/ui/workspace-transfer.png)
