...
sidebarTitle: Connecting & Troubleshooting
---
...
2. [Install Prefect](/2.14.21/getting-started/installation/) in the environment in which you want to execute flow runs.
