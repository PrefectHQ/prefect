...
[events](/2.14.21/cloud/events/) for use in [automations](/2.14.21/cloud/automations/).
...
Cloud](/2.14.21/cloud/connecting#manually-configure-prefect-api-settings).

### Via Prefect Cloud

Webhooks can be created and managed from the Prefect Cloud UI.

![Managing a webhook in the Prefect Cloud UI.](/2.14.21/img/ui/webhook.png)
...
As with the [templates available in Prefect Cloud Automation](/2.14.21/cloud/automations) for
...
this phase, you may find the [Event Feed](/2.14.21/cloud/events/#event-feed) in the UI to be
