...
- Prefect [installed](/2.14.21/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.14.21/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.14.21/guides/host/) instance)
...
We can create [blocks](/2.14.21/concepts/blocks/) via the UI or Python code.
