---
title: How to move data to and from cloud providers
sidebarTit;e: Moving Data
---
...
- Prefect [installed](/2.11.5/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.11.5/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.11.5/guides/host/) instance)
...
We can create [blocks](/2.11.5/concepts/blocks/) via the UI or Python code.
