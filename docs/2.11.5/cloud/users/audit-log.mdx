...
![Viewing audit logs for an organization in the Prefect Cloud UI.](/2.11.5/img/ui/audit-log.png)
...
Audit logs may also be filtered by date range. Audit log retention period varies by [Prefect Cloud plan](https://www.prefect.io/pricing). See your [organization profile page](/2.11.5/cloud/organizations/) for the current audit log retention period.
