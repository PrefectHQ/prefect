...
!!! tip "Other work pool types"
    ...
    These are expanded upon in the [Guides](/2.12/guides) section.
...
You can learn more about them in the [work queue documentation](/2.12/concepts/work-pools/#work-queues).
...
- Learn about deploying multiple flows and CI/CD with our [`prefect.yaml`](/2.12/concepts/projects/#the-prefect-yaml-file).
- Check out some of our other [work pools](/2.12/concepts/work-pools/).
- [Concepts](/2.12/concepts/) contain deep dives into Prefect components.
- [Guides](/2.12/guides/) provide step-by-step recipes for common Prefect operations including:
    - [Deploying on Kubernetes](/2.12/guides/deployment/helm-worker/)
    - [Deploying flows in Docker](/2.12/guides/deployment/docker/)
    - [Writing tests](/2.12/guides/testing)
