...
3. [Install](/2.12/getting-started/installation/) Python and Prefect
...
[Work pools](/2.12/concepts/work-pools/) allow you to manage deployment infrastructure.
...
The [`prefect.yaml`](/2.12/concepts/deployments/#managing-deployments) file is used by the `prefect deploy` command to deploy our flows.
