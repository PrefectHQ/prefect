...
- Prefect [installed](/2.13.8/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.13.8/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.13.8/guides/host/) instance)
...
We can create [blocks](/2.13.8/concepts/blocks/) via the UI or Python code.
