...
!!! success "Getting Started with Prefect Cloud"
    Ready to jump right in and start running with Prefect Cloud? See the [Quickstart](/2.13.8/getting-started/quickstart/) and follow the instructions on the **Cloud** tabs to write and deploy your first Prefect Cloud-monitored flow run.

![Viewing a workspace dashboard in the Prefect Cloud UI](/2.13.8/img/ui/cloud-dashboard.png)
...
!!! cloud-ad "Prefect Cloud features"
    ...
    - [Email notifications](/2.13.8/cloud/automations/) &mdash; send email alerts from Prefect's server based on automation triggers.
    ...
    - [Push work pool](/2.13.8/guides/deployment/push-work-pools/) &mdash; run flows on your serverless infrastructure without running a worker.
...
See the [Workspaces](/2.13.8/cloud/workspaces/) documentation for more information about configuring and using workspaces.

Each workspace keeps track of its own:

- [Flow runs](/2.13.8/concepts/flows/) and task runs executed in an environment that is [syncing with the workspace](/2.13.8/cloud/#workspaces)
- [Flows](/2.13.8/concepts/flows/) associated with flow runs and deployments observed by the Prefect Cloud API
- [Deployments](/2.13.8/concepts/deployments/)
- [Work pools](/2.13.8/concepts/work-pools/)
- [Blocks](/2.13.8/concepts/blocks/) and [storage](/2.13.8/concepts/storage/)
- [Automations](/2.13.8/cloud/automations/)

![Viewing a workspace dashboard in the Prefect Cloud UI.](/2.13.8/img/ui/cloud-new-workspace.png)

## Events

Prefect Cloud allows you to see your [events](/2.13.8/cloud/events/).
![Prefect UI](/2.13.8/img/ui/event-feed.png)

## Automations

Prefect Cloud [automations](/2.13.8/cloud/automations/) provide additional notification capabilities as the open-source Prefect server.
...
A Prefect Cloud [organization](/2.13.8/cloud/organizations/) account type enables more fine-grained control over workspace collaboration.
...
See the [Organizations](/2.13.8/cloud/organizations/) documentation for more information about managing users, service accounts, and workspaces in a Prefect Cloud organization.
...
See the [service accounts](/2.13.8/cloud/users/service-accounts/) documentation for more information about creating and managing service accounts in a Prefect Cloud organization.
...
Prefect Cloud's [Organization and Enterprise plans](https://www.prefect.io/pricing) offer [single sign-on (SSO)](/2.13.8/cloud/users/sso/) authentication integration with your team’s identity provider. SSO integration can bet set up with identity providers that support OIDC and SAML.
...
Prefect Cloud's [Organization and Enterprise plans](https://www.prefect.io/pricing) offer [Audit Log](/2.13.8/cloud/users/audit-log/) compliance and transparency tools.
...
The [Prefect REST API](/2.13.8/api-ref/rest-api/) is used for communicating data from Prefect clients to Prefect Cloud or a local Prefect server so that orchestration can be performed.
...
Then follow the steps in the UI to deploy your first Prefect Cloud-monitored flow run. For more details, see the [Prefect Quickstart](/2.13.8/getting-started/quickstart/) and follow the instructions on the **Cloud** tabs.
