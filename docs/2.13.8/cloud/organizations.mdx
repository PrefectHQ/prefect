...
![Organizations icon in Prefect Cloud.](/2.13.8/img/ui/organizations.png)
...
- [**Workspaces**](/2.13.8/cloud/workspaces/) enables you to access and manage workspaces within the organization.
- **Members** enables you to invite and manage users who are members of the organization, if you're an Admin.
- [**Audit Log**](/2.13.8/cloud/users/audit-log/) exists for Admins of Enterprise accounts only. Enables you to view a log of all actions taken by users in the organization.
- [**Service Accounts**](/2.13.8/cloud/users/service-accounts/) enables you to view, create, or edit service accounts for your organization.
- [**Roles**](/2.13.8/cloud/users/roles/) enables you to view details for all workspace roles, and configure custom workspace roles with permission scopes for your organization.
- [**SSO**](/2.13.8/cloud/users/sso/) Enables Admins to configure single sign-on (SSO) authentication using an identity provider.
...
![Invite new members to an organization in Prefect Cloud.](/2.13.8/img/ui/org-invite-members.png)
...
- [Role Based Access Controls (RBAC)](/2.13.8/cloud/users/roles/) to configure user permissions at organization and workspace levels.
- [Service accounts](/2.13.8/cloud/users/service-accounts/) to generate credentials for specific workloads.
- [Expanded and customizable Flow Run Retention Policy](/2.13.8/ui/flow-runs/#flow-run-retention-policy).
- [Enhanced rate limits](/2.13.8/cloud/rate-limits/) for higher volume workloads.
- [Audit Logs](/2.13.8/cloud/users/audit-log/) for monitoring user actions (Enterprise plans).
- [Single Sign-on (SSO)](/2.13.8/cloud/users/sso/) authentication.
