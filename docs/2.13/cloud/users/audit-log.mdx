...
![Viewing audit logs for an organization in the Prefect Cloud UI.](/2.13/img/ui/audit-log.png)
...
See your [organization profile page](/2.13/cloud/organizations/) for the current audit log retention period.
