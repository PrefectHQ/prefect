...
As described in the [Deploying Flows to Work Pools and Workers](/2.18.3/guides/prefect-deploy/) guide, there are two ways to deploy flows to work pools: using a `prefect.yaml` file or using the `.deploy()` method.
...
![Job variables in the UI](/2.18.3/img/guides/job-variables.png)
...
![Job variables via custom run](/2.18.3/img/ui/deployment-job-variables.png)
...
![Job variables via automation action](/2.18.3/img/ui/automations-action-job-variable.png)
