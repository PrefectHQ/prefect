...
![Work pool options](/2.18.3/img/ui/work-pools.png)
...
!!! note "Push work pools don't require a worker"
    ...
    Read more in the [Serverless Push Work Pool Guide](/2.18.3/guides/deployment/push-work-pools/).
...
- [Azure Container Instances guide](/2.18.3/integrations/prefect-azure/aci_worker/)
