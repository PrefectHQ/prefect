...
- Prefect [installed](/2.18.3/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.18.3/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.18.3/guides/host/) instance)
...
We can create [blocks](/2.18.3/concepts/blocks/) via the UI or Python code.
