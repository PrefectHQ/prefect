...
Google Cloud Run is a fully managed compute platform that automatically scales your containerized apps.
...
For next steps, take a look at some of the other [work pools](/3.0rc/deploy/infrastructure-examples/serverless) Prefect has to offer.
