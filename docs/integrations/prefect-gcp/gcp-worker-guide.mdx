...
If you're looking for a general introduction to workers, work pools, and deployments, check out the [workers and work pools tutorial](https://docs.prefect.io/latest/deploy/dynamic-infra/push-runs-remote/).
...
- A Prefect server instance. You can sign up for a forever free [Prefect Cloud Account](https://app.prefect.cloud/) or, alternatively, self-host a [Prefect server](https://docs.prefect.io/latest/cloud/self-host/).
...
- Take a look at some of the other [work pools](https://docs.prefect.io/latest/deploy/dynamic-infra/control-runs/) Prefect has to offer
