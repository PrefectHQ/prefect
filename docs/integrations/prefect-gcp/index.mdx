...
- [Prefect 3 installed](3.0rc/get-started/install) in a virtual environment.
...
See the [Google Cloud Run Worker Guide](/3.0rc/gcp-worker-guide/) for a walkthrough of using Google Cloud Run to run workflows with a hybrid work pool.

If you're using Prefect Cloud, [Google Cloud Run push work pools](https://docs.prefect.io/latest/deploy/dynamic-infra/push-runs-serverless/#__tabbed_1_3) provide all the benefits of Google Cloud Run along with a quick setup and no worker needed.
