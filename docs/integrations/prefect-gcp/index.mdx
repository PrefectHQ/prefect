...
If you're using Prefect Cloud, [Google Cloud Run push work pools](/3.0rc/deploy/infrastructure/serverless) provide all the benefits of Google Cloud Run along with a quick setup and no worker needed.
