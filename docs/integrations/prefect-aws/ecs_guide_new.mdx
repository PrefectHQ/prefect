...
Running your ECS workers *on* ECS means that they will also be ECS tasks, though unlike the ECS tasks that run flows, they will run perpetually and be maintained by an ECS **service**.
