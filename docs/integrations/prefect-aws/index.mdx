...
If you're using Prefect Cloud, [ECS push work pools](/3.0rc/deploy/infrastructure/serverless) provide all the benefits of ECS with a quick setup and no worker needed.
