...
### `upload_bundle_to_s3` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/prefect_aws/experimental/bundles/upload.py#L29" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `UploadResult` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/prefect_aws/experimental/bundles/upload.py#L18" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
