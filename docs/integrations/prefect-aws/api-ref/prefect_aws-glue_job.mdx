...
### `GlueJobRun` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/prefect_aws/glue_job.py#L17" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `fetch_result` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/prefect_aws/glue_job.py#L50" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `wait_for_completion` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/prefect_aws/glue_job.py#L55" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `GlueJobBlock` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/prefect_aws/glue_job.py#L78" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### `trigger` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/prefect_aws/glue_job.py#L149" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
