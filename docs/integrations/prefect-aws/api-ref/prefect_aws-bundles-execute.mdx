...
### `download_bundle_from_s3` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-aws/prefect_aws/bundles/execute.py#L29" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `execute_bundle_from_s3` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-aws/prefect_aws/bundles/execute.py#L70" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
### `DownloadResult` <sup><a href="https://github.com/PrefectHQ/prefect/blob/main/src/integrations/prefect-aws/prefect_aws/bundles/execute.py#L22" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
