...
Note, to use the `load` method on a block, you must already have a block document [saved through code](https://docs.prefect.io/develop/connect-third-party/#saving-blocks) or saved through the UI.
...
Register blocks in this module to [view and edit them](https://docs.prefect.io/ui/blocks/) on Prefect Cloud:
