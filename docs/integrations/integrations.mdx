...
mode: "wide"
keywords: ["integration", "library", "PyPI", "third-party", "plugin", "connector"]
---
...
<CardGroup cols={4}  className="text-center">
    ...
    <Card title="jCodeMunch">
        <a href="https://github.com/jgravelle/prefect-jcodemunch"> <img src="/images/integrations/jcodemunch.png" noZoom alt="prefect-jcodemunch"/>
        </a>
        Maintained by <a href="https://github.com/jgravelle/jcodemunch-mcp"> jMunch, LLC </a>
    </Card>
    ...
    <Card title="Slurm">
        <a href="https://github.com/EBI-Metagenomics/prefect-slurm"> <img src="/images/integrations/slurm.png" noZoom alt="prefect-slurm"/>
        </a>
