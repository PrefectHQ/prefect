...
### Using a Bitbucket Repository Block in `prefect.yaml`

If you want to pull your deployment's code from a Bitbucket Repository **using a repository block**, you can do so by using the `pull_with_block` step in your `prefect.yaml` file.
...
Make sure you have created the Bitbucket Repository block before running the deployment:
