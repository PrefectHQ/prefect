...
![Configuring an ACI work pool's identities.](/3.0rc/img/guides/aci-worker-identities.png)
...
![Configuring an ACI work pool's ACR Managed Identity.](/3.0rc/img/guides/aci-worker-acridentity.png)
...
![Configuring an ACI work pool.](/3.0rc/img/guides/aci-worker-subscription.png)
