...
The following command will install a version prefect-azure compatible with your installed version of Prefect. 
If you don't already have Prefect installed, it will install the latest version of Prefect as well.
