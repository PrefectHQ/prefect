...
If you're using Prefect Cloud, [ACI push work pools](/3.0rc/deploy/infrastructure/serverless/#__tabbed_1_2) provide all the benefits of ACI with a quick setup and no worker needed.
