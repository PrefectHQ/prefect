...
accept `tls_insecure` and `tls_ca_file`. All other query parameters are treated as
standard [redis-py](https://redis-py.readthedocs.io/) connection options
(`socket_timeout`, `max_connections`, `health_check_interval`, ...) and apply to the
