...
To use the `load` method on Blocks, you must have a block document [saved through code](https://docs.prefect.io/develop/connect-third-party/#saving-blocks) or saved through the UI.
