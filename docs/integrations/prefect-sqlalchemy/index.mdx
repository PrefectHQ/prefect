...
- [Prefect 3 installed](/3.0rc/get-started/install/).
...
To use the `load` method on Blocks, you must have a block [saved through code](https://docs.prefect.io/develop/connect-third-party/#saving-blocks) or saved through the UI.
