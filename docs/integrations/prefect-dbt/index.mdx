...
If you are already using Prefect blocks such as the Snowflake Connector block, you can use those blocks to [create a new profiles.yml with a DbtCliProfile block](#create-a-new-profile-with-blocks). 
...
To see all of the pre-built tasks, visit the SDK docs.
