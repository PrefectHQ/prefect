...
Prefect integrations may provide pre-built [blocks](/latest/develop/blocks), [flows](/latest/develop/write-flows), or [tasks](/latest/develop/write-tasks) for interacting with external systems.
