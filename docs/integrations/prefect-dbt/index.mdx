...
With `prefect-dbt`, you can execute dbt Core from a Prefect flow with per-node observability, trigger and observe dbt Cloud jobs, and incorporate other tools, such as [Snowflake](/integrations/prefect-snowflake/index), into your dbt runs.
