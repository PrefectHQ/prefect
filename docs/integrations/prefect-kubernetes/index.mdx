...
This library is most commonly used to installation with a Kubernetes worker. See the [Prefect docs on deploying with Kubernetes](3.0rc/deploy/dynamic-infra/deploy-kubernetes) to learn how to create and run deployments in Kubernetes.
