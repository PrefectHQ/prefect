...
Caching allows you to efficiently reuse [results of tasks](/3.1/develop/results/) that may be expensive to compute
...
This behavior can be configured - see [customizing the cache](/3.1/develop/write-tasks#customizing-the-cache) below.
...
See [managing results](/3.1/develop/results/) for more details on managing your result configuration, and
[settings](/3.1/manage/settings-and-profiles) for more details on managing Prefect settings.
</Warning>
...
a single [_transaction_](/3.1/develop/transactions).
...
Read more about [transactions](/3.1/develop/transactions). 
...
See [settings](/3.1/manage/settings-and-profiles) for more details on managing Prefect settings.
