...
As an additional step, you can use an [automation](/3.1/automate/events/automations-triggers) to alert the user to the error.
...
Consider using a [block](/3.1/develop/blocks/), such as a `JSONBlock`.
