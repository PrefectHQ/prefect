...
![Markdown artifact sales report screenshot](/3.1/img/ui/md-artifact-info.png)
...
![Link artifact details with multiple versions](/3.1/img/ui/link-artifact-info.png)
...
![Progress artifact example](/3.1/img/ui/progress-artifact-example.png)
...
![Markdown sales report screenshot](/3.1/img/ui/md-artifact-info.png)
...
![Table artifact with customer info](/3.1/img/ui/table-artifact-info.png)
...
![Image artifact example](/3.1/img/ui/image-artifact-example.png)
...
Create, read, or delete artifacts programmatically through the [Prefect REST API](/3.1/api-ref/rest-api/).
...
See the [Prefect REST API documentation](/3.1/api-ref/rest-api/) on artifacts for more information.
