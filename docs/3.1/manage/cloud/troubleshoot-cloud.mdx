...
In many cases, there is an informative stack trace in Prefect's [logs](/3.1/develop/logging/). 
...
[Service accounts](/3.1/manage/cloud/manage-users/service-accounts/) (sometimes referred to as bots),  
...
Actors can be members of [workspaces](/3.1/manage/cloud/workspaces/). An actor attempting an action in a 
...
an actor has a [role](/3.1/manage/cloud/manage-users/manage-roles/) which grants them certain permissions. 
...
through a [deployment](/3.1/deploy/infrastructure-examples/docker/) (optionally on different infrastructure).
