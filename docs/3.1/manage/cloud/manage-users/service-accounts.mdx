...
- Prefect Cloud [API keys](/3.1/manage/cloud/manage-users/api-keys/)
- [Roles](/3.1/manage/cloud/manage-users/manage-roles/) and permissions

With service account credentials, you can 
[configure an execution environment](/3.1/manage/cloud/connect-to-cloud/#configure-a-local-execution-environment) 
...
See [workspace sharing](/3.1/manage/cloud/workspaces/#workspace-sharing) for more information.
...
[added to a workspace](/3.1/manage/cloud/workspaces/#workspace-sharing).
</Note>
