...
You can define your own custom trigger to fire based on a custom [event](/3.1/automate/events/custom-triggers/) defined in Python code.
With Prefect Cloud you can even create [webhooks](/3.1/automate/events/webhook-triggers/) that can receive data for use in actions.
...
![Viewing automations for a workspace in Prefect Cloud.](/3.1/img/ui/automations.png)
...
![Configuring a trigger for an automation in Prefect Cloud.](/3.1/img/ui/automations-trigger.png)
...
![Configuring an action for an automation in Prefect Cloud.](/3.1/img/ui/automations-action.png)
...
[grammar](/3.1/automate/events/events/#event-grammar). Each trigger definition may include a [jinja template](https://en.wikipedia.org/wiki/Jinja_(template_engine))
...
![Configuring notifications for an automation in Prefect Cloud.](/3.1/img/ui/automations-notifications.png)
...
![Configuring notifications for an automation in Prefect Cloud.](/3.1/img/ui/templated-notification.png)
...
![Final notification](/3.1/img/guides/final-automation.png)
...
![webhook-simple](/3.1/img/guides/webhook-simple.png)
...
![Webhook created](/3.1/img/guides/webhook-created.png)

Go into the event feed to automate straight from this event:
![Webhook automate](/3.1/img/guides/webhook-automate.png)
...
![Automation custom](/3.1/img/guides/automation-custom.png)
...
- To learn more about Prefect events, which can trigger automations, see the [events docs](/3.1/automate/events/events/).
- See the [webhooks guide](/3.1/automate/events/webhook-triggers/)
