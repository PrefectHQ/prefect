...
[events](/3.1/automate/events/) for use in [automations](/3.1/automate/events/automations-triggers/).
...
[authentication methods](/3.1/manage/cloud/connect-to-cloud#manually-configure-prefect-api-settings) you use with Prefect
Cloud.
...
![Managing a webhook in the Prefect Cloud UI.](/3.1/img/ui/webhook.png)
...
As with the [templates available in Prefect Cloud Automation](/3.1/automate/events/automations-triggers) for
...
this phase, lean upon the [event feed](/3.1/automate/events/#event-feed) in the UI to see events as they happen.
