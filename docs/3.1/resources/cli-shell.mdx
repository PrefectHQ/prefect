...
- A basic understanding of Prefect flows. Start with the [Getting started](/3.1/get-started/quickstart/) 
guide if necessary.
- A recent version of Prefect installed in your command line environment. 
Follow these [instructions](/3.1/get-started/install/) if you have any issues.
...
[deployment](/3.1/deploy/infrastructure-examples/docker/) for regular execution. 
...
[concurrency limits](/3.1/develop/global-concurrency-limits/), 
