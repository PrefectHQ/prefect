...
1. Prefect [installed](/3.1/get-started/install)
...
Now you can turn your flow into a [deployment](/3.1/deploy/infrastructure-examples/docker/) so you and your team 
