...
![A simple flow visualized with the .visualize() method](/3.1/img/orchestration/hello-flow-viz.png)
...
![A flow with return values visualized with the .visualize() method](/3.1/img/orchestration/viz-return-value-tracked.png)