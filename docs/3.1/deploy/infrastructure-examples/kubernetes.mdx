...
3. Python and Prefect [installed](/3.1/get-started/install/)
...
[Work pools](/3.1/deploy/infrastructure-concepts/work-pools/) allow you to manage deployment 
infrastructure.
...
[Workers](/3.1/deploy/infrastructure-examples/docker/).

The [`prefect.yaml`](/3.1/deploy/infrastructure-concepts/prefect-yaml/#managing-deployments) file is used 
