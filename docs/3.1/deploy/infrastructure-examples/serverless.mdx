...
<span class="badge cloud"></span> Push [work pools](/3.1/deploy/infrastructure-concepts/work-pools/) are a special type of work pool. They allow 
...
<Tabs>
  ...
  <Tab title="Google Cloud Run">
    ...
    ![Configuring service account permissions in GCP](/3.1/img/guides/gcr-service-account-setup.png)
...
<Tabs>
  ...
  <Tab title="Google Cloud Run">
    ...
    ![Configuring GCP Credentials block for use in cloud run push work pools](/3.1/img/guides/gcp-creds-block-setup.png)
...
<Tabs>
  <Tab title="AWS ECS">
    ...
    Each step has several optional fields that are detailed in the
     [work pools documentation](/3.1/deploy/infrastructure-concepts/work-pools/). 
 ...
 <Tab title="Google Cloud Run">
    ...
    [Manage infrastructure with work pools](/3.1/deploy/infrastructure-concepts/work-pools/). 
...
You need to configure your [deployment](/3.1/deploy/infrastructure-examples/docker/) to send flow runs to your push work pool.
...
Learn more about [work pools](/3.1/deploy/infrastructure-concepts/work-pools/) and [workers](/3.1/deploy/infrastructure-concepts/workers/).

Learn about installing dependencies at runtime or baking them into your Docker image in the [Deploy to Docker](/3.1/deploy/infrastructure-examples/docker#automatically-build-a-custom-docker-image-with-a-local-dockerfile) guide.
