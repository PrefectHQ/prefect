...
There are two ways to deploy flows to work pools: with a [`prefect.yaml` file](/3.1/deploy/infrastructure-concepts/prefect-yaml) or using the [Python `deploy` method](/3.1/deploy/infrastructure-concepts/deploy-via-python). 
...
![Job variables in the UI](/3.1/img/guides/job-variables.png)
...
![Job variables through custom run](/3.1/img/ui/deployment-job-variables.png)
...
![Job variables through automation action](/3.1/img/ui/automations-action-job-variable.png)
