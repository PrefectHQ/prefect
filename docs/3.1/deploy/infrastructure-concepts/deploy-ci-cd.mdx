...
Prefect [deployments](/3.1/deploy/infrastructure-examples/docker).
...
![Creating a GitHub Actions secret](/3.1/img/guides/github-secrets.png)
...
![A GitHub Action triggered via push](/3.1/img/guides/github-actions-trigger.png)
