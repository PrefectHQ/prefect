...
As discussed above, if you use [blocks](/3.1/develop/blocks/), you can template the credentials section with 
...
- **blocks**: you can reference [Prefect blocks](/3.1/develop/blocks) with the  
...
- **variables**: you can reference [Prefect variables](/3.1/develop/variables) with the  
...
| `schedule`                                 | An optional [schedule](/3.1/automate/add-schedules) to assign to the deployment. Fields for this section are documented in the [Schedule Fields](#schedule-fields) section.                                                                                                                      |
| `concurrency_limit`                        | An optional [deployment concurrency limit](/3.1/deploy/index#concurrency-limiting). Fields for this section are documented in the [Concurrency Limit Fields](#concurrency-limit-fields) section.                                                                                                                      |
| `triggers`                                  | An optional array of [triggers](/3.1/automate/events/automations-triggers/#custom-triggers) to assign to the deployment |
...
| `job_variables`                                | Values used to override the default values in the specified work pool's [base job template](/3.1/deploy/infrastructure-concepts/work-pools/#base-job-template). Maps directly to a created deployments `infra_overrides` attribute. |
...
- [Managed work pools](/3.1/deploy/infrastructure-examples/managed/)
- [Push work pools](/3.1/deploy/infrastructure-examples/serverless/)
- [Kubernetes work pools](/3.1/deploy/infrastructure-examples/kubernetes/)
- [Serverless hybrid work pools](/3.1/deploy/infrastructure-examples/docker/)
