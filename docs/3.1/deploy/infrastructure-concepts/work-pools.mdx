...
- Allow work pools to prioritize (or limit) flow runs through the use of [work queues](/3.1/deploy/infrastructure-concepts/work-pools/#work-queues).
...
2. [Push work pools](/3.1/deploy/infrastructure-examples/serverless): These submit runs directly to serverless infrastructure providers.
3. [Managed work pools](/3.1/deploy/infrastructure-examples/managed): These are administered by Prefect and handle both submission and execution of code.
...
- [Prefect REST API](/3.1/api-ref/rest-api/)
...
![The UI displays a list of configured work pools](/3.1/img/ui/work-pool-list.png)
...
![process work pool configuration options](/3.1/img/ui/process-work-pool-config.png)
...
Learn more about [customizing job variables](/3.1/deploy/infrastructure-concepts/customize).
...
**Advanced customization of the base job template**
    ...
    See more information about [overriding a work pool's job variables](/3.1/deploy/infrastructure-concepts/customize).
</Tip>
...
- Learn more about [workers](/3.1/deploy/infrastructure-concepts/workers) and how they interact with work pools
- Learn how to [deploy flows](/3.1/deploy/infrastructure-concepts/prefect-yaml) that run in work pools
- Learn how to set up work pools for:
  - [Kubernetes](/3.1/deploy/infrastructure-examples/kubernetes)
  - [Docker](/3.1/deploy/infrastructure-examples/docker)
  - [Serverless platforms](/3.1/deploy/infrastructure-examples/serverless)
  - [Infrastructure managed by Prefect Cloud](/3.1/deploy/infrastructure-examples/managed)
