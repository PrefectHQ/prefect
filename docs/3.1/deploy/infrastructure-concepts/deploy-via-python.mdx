...
and follow the [Connect to Prefect Cloud](/3.1/manage/cloud/connect-to-cloud/) guide.

2. A Prefect flow: You should have a flow defined in your Python script. If you haven't created a flow yet, refer to the 
[Write Flows](/3.1/develop/write-flows/) guide.
...
the Prefect UI or using the Prefect CLI. For more information, see the [Work Pools](/3.1/deploy/infrastructure-concepts/work-pools/) guide. 
...
- `schedules`
    ...
    Learn more about schedules [here](/3.1/automate/add-schedules).
...
Learn more about remote code storage [here](/3.1/deploy/infrastructure-concepts/store-flow-code/).
...
You can learn more about job variables [here](/3.1/deploy/infrastructure-concepts/customize).
...
- [Work Pools](/3.1/deploy/infrastructure-concepts/work-pools/)
- [Store Flow Code](/3.1/deploy/infrastructure-concepts/store-flow-code/)
- [Customize Infrastructure](/3.1/deploy/infrastructure-concepts/customize/)
- [Schedules](/3.1/automate/add-schedules/)
- [Write Flows](/3.1/develop/write-flows/)
