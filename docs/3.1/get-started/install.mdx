...
* [Prefect Cloud](/3.1/manage/cloud/), a managed solution that provides strong scaling, performance, and security, or
* [Self-hosted Prefect server](/3.1/manage/self-host/), an API server that you run on your own infrastructure where you are responsible for scaling and any authentication and authorization.

Now that you have Prefect installed, go through the [quickstart](/3.1/get-started/quickstart/) to try it out.
