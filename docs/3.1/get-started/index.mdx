...
<CardGroup cols={3}>
  <Card title="Quickstart" icon="play" href="/3.1/get-started/quickstart">
    Learn how to schedule a script to run on remote infrastructure and observe its state.
  </Card>
  <Card title="Prefect Cloud" icon="cloud" href="/3.1/manage/cloud/index">
    Supercharge Prefect with enhanced governance, security, and performance capabilities.
  </Card>
  <Card title="Upgrade to Prefect 3" icon="sparkles" href="/3.1/resources/upgrade-to-prefect-3">
...
<CardGroup cols={3}>
  <Card title="Develop" icon="code" href="/3.1/develop/write-flows">
    Write, run, configure, and observe workflows and their tasks, results, artifacts, and more.
  </Card>
  <Card title="Deploy" icon="rocket" href="/3.1/deploy/index">
    Run workflows in local processes or deploy them to dynamically provisioned infrastructure.
  </Card>
  <Card title="Automate" icon="robot" href="/3.1/automate/events/automations-triggers">
