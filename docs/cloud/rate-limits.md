...
Flow runs in Prefect Cloud are retained according to the Flow Run Retention Policy setting in your account profile. The policy setting applies to all workspaces owned by the account.
