...
Agents poll for work every 15 seconds by default. This interval is configurable in your [profile settings](/2.19.4/concepts/settings/) with the `PREFECT_AGENT_QUERY_INTERVAL` setting.
