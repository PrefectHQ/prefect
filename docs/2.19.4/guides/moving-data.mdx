...
- Authenticated with [Prefect Cloud](/2.19.4/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.19.4/guides/host/) instance)
...
We can create [blocks](/2.19.4/concepts/blocks/) via the UI or Python code.
