...
<ul class="ul-line-height-compress" style="columns: 2">
    <li> <a href="/2.10/concepts/schedules"> scheduling </a> </li>
    <li> <a href="/2.10/concepts/tasks/#task-arguments"> retries </a> </li>
    <li> <a href="/2.10/concepts/logs/"> logging </a> </li>
    <li> <a href="/2.10/concepts/tasks/#caching"> caching</a> </li>
    <li> <a href="/2.10/concepts/task-runners/#task-runners"> async</a> </li>
    <li> <a href="/2.10/cloud/automations/"> notifications</a> </li>
    <li> <a href="/2.10/cloud/overview/"> observability</a> </li>
</ul>
...
<figure markdown>
![screenshot of Cloud UI timeline view with menu](/2.10/img/ui/dashboard-cloud.png)
