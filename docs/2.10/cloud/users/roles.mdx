...
[Organizations](/2.10/cloud/organizations/) in Prefect Cloud let you give people in your organization access to the appropriate Prefect functionality within your organization and within specific workspaces. 
...
![Creating a custom role for a workspace using inherited permissions in Prefect Cloud](/2.10/img/ui/org-inherited-role.png)
