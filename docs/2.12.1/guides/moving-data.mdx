...
- Prefect [installed](/2.12.1/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.12.1/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.12.1/guides/host/) instance)
...
We can create [blocks](/2.12.1/concepts/blocks/) via the UI or Python code.
