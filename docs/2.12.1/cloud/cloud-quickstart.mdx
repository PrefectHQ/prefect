...
![Creating a new Prefect Cloud account.](/2.12.1/img/ui/cloud-sign-in.png)
...
![Creating a new Prefect Cloud account.](/2.12.1/img/ui/cloud-new-login.png)

Select **Create Workspace**. You'll be prompted to provide a name and description for your workspace.

![Creating a new workspace in the Cloud UI.](/2.12.1/img/ui/cloud-workspace-details.png)
...
[Install Prefect](/2.12.1/getting-started/installation/) in the environment in which you want to execute flow runs.
...
!!! note "Installation requirements"
    Prefect requires Python 3.8 or later. If you have any questions about Prefect installations requirements or dependencies in your preferred development environment, check out the [Installation](/2.12.1/getting-started/installation/) documentation.
...
Okay, you're all set to run a flow locally, orchestrated with Prefect Cloud. Notice that everything works just like [running local flows](/2.12.1/tutorial/flows/). However, because you logged into Prefect Cloud, your local flow runs show up in Prefect Cloud!
...
![Viewing flow run results in the Prefect Cloud UI Flow Runs dashboard.](/2.12.1/img/ui/cloud-flow-run.png)
...
![Viewing local flow run details in the Prefect Cloud UI.](/2.12.1/img/ui/cloud-flow-run-details.png)
...
If you're new to Prefect, learn more about writing and running flows in the [Prefect Flows First Steps](/2.12.1/tutorial/flows/) tutorial. If you're already familiar with Prefect flows and want to try creating deployments and kicking off flow runs with Prefect Cloud, check out the [Deployments](/2.12.1/tutorial/deployments/) tutorial.

Want to learn more about the features available in Prefect Cloud? Start with the [Prefect Cloud Overview](/2.12.1/ui/cloud/).
