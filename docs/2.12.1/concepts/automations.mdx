...
!!! cloud-ad "Automations are only available in Prefect Cloud"
    [Notifications](/2.12.1/concepts/notifications/) in an open-source Prefect server provide a subset of the notification message-sending features available in Automations.

## Automations overview

The **Automations** page provides an overview of all configured automations for your workspace.

![Viewing automations for a workspace in Prefect Cloud.](/2.12.1/img/ui/automations.png)
...
![Viewing details and events that triggered an automation in Prefect Cloud.](/2.12.1/img/ui/automations-detail-tab.png)
...
![Configuring a trigger for an automation in Prefect Cloud.](/2.12.1/img/ui/automations-trigger.png)
...
![Viewing a custom trigger for automations for a workspace in Prefect Cloud.](/2.12.1/img/ui/automations-custom.png)
...
![Configuring an action for an automation in Prefect Cloud.](/2.12.1/img/ui/automations-action.png)
...
![Configuring details for an automation in Prefect Cloud.](/2.12.1/img/ui/automations-details.png)
...
![Configuring notifications for an automation in Prefect Cloud.](/2.12.1/img/ui/automations-notifications.png)
...
- [flow_run](/2.12.1/api-ref/server/schemas/core/#prefect.server.schemas.core.FlowRun)
- [flow](/2.12.1/api-ref/server/schemas/core/#prefect.server.schemas.core.Flow)
- [deployment](/2.12.1/api-ref/server/schemas/core/#prefect.server.schemas.core.Deployment)
- [work_queue](/2.12.1/api-ref/server/schemas/core/#prefect.server.schemas.core.WorkQueue)
...
![Configuring notifications for an automation in Prefect Cloud.](/2.12.1/img/ui/templated-notification.png)
