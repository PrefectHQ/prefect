---
title: Connecting & Troubleshooting
...
2. [Install Prefect](/2.18/getting-started/installation/) in the environment in which you want to execute flow runs.
