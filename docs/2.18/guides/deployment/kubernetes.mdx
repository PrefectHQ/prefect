...
3. [Install](/2.18/getting-started/installation/) Python and Prefect
...
[Work pools](/2.18/concepts/work-pools/) allow you to manage deployment infrastructure.
...
To learn about the Python deployment creation method with `flow.deploy` refer to the [Workers & Work Pools tutorial page](/2.18/tutorial/workers/).

The [`prefect.yaml`](/2.18/concepts/deployments/#managing-deployments) file is used by the `prefect deploy` command to deploy our flows.
