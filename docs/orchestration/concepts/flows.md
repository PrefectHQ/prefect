...
The flow group id is a UUID and is not currently editable.  The flow group id can be used when editing [flow group settings](orchestration/ui/flow.html#flow-group-settings) such as default parameters and labels.
