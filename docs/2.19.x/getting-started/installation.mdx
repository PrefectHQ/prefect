---
title: Installation 
description: Prefect requires Python 3.8 or newer.
---
...
See our [Contributing guide](https://docs.prefect.io/contributing/overview/) for instructions on installing Prefect for development and see the [section below](#installing_unreleased_code) to install directly from the `main` branch.
...
Now that you have Prefect installed and your environment configured, check out the [Tutorial](https://docs.prefect.io/tutorial/) to get more familiar with Prefect.