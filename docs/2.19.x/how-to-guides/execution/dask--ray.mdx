...
Because task runners are specified on flows, you can assign different task runners to tasks by using [subflows](https://docs.prefect.io/concepts/flows/#composing-flows) to organize those tasks.
