...
!!! cloud-ad "Automations are only available in Prefect Cloud"
    [Notifications](/2.15.0/concepts/notifications/) in an open-source Prefect server provide a subset of the notification message-sending features available in Automations.

## Automations overview

The **Automations** page provides an overview of all configured automations for your workspace.

![Viewing automations for a workspace in Prefect Cloud.](/2.15.0/2.15.0/img/ui/automations.png)
...
![Configuring a trigger for an automation in Prefect Cloud.](/2.15.0/2.15.0/img/ui/automations-trigger.png)
...
![Configuring an action for an automation in Prefect Cloud.](/2.15.0/2.15.0/img/ui/automations-action.png)
...
![Viewing a custom trigger for automations for a workspace in Prefect Cloud.](/2.15.0/2.15.0/img/ui/automations-custom.png)
...
At deployment time, this will create a linked automation that is triggered by events matching your chosen [grammar](/2.15.0/concepts/events/#event-grammar), which will pass the templatable `event` as a parameter to the deployment's flow run.
...
![Configuring notifications for an automation in Prefect Cloud.](/2.15.0/2.15.0/img/ui/automations-notifications.png)
...
- [flow_run](/2.15.0/api-ref/server/schemas/core/#prefect.server.schemas.core.FlowRun)
- [flow](/2.15.0/api-ref/server/schemas/core/#prefect.server.schemas.core.Flow)
- [deployment](/2.15.0/api-ref/server/schemas/core/#prefect.server.schemas.core.Deployment)
- [work_queue](/2.15.0/api-ref/server/schemas/core/#prefect.server.schemas.core.WorkQueue)
- [work_pool](/2.15.0/api-ref/server/schemas/core/#prefect.server.schemas.core.WorkPool)
...
![Configuring notifications for an automation in Prefect Cloud.](/2.15.0/2.15.0/img/ui/templated-notification.png)
