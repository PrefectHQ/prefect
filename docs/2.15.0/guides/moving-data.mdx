...
- Prefect [installed](/2.15.0/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.15.0/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.15.0/guides/host/) instance)
...
We can create [blocks](/2.15.0/concepts/blocks/) via the UI or Python code.
