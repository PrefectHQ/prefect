...
[Work Queues](/2.7.11/concepts/work-queues/) and agents work together to bridge your orchestration environment &mdash; a local Prefect API server or Prefect Cloud &mdash; and your execution environments. Work queues gather flow runs for scheduled deployments, and agents pick up work from their configured work queues.
...
You can create, edit, manage, and delete work queues through the Prefect API server, Prefect Cloud UI, or [Prefect CLI commands](/2.7.11/concepts/work-queues/#work-queue-configuration).
...
See the [Work Queues and Agents](/2.7.11/concepts/work-queues/) documentation for details on configuring agents and work queues, including creating work queues from the Prefect CLI.
