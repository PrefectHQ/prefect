...
!!! cloud-ad "Automations are only available in Prefect Cloud"
    [Notifications](/2.7.11/ui/notifications/) in the open-source Prefect Orion server provide a subset of the notification message-sending features avaiable in Automations.
...
- [flow_run](/2.7.11/api-ref/orion/schemas/core/#prefect.orion.schemas.core.FlowRun)
- [flow](/2.7.11/api-ref/orion/schemas/core/#prefect.orion.schemas.core.Flow)
- [deployment](/2.7.11/api-ref/orion/schemas/core/#prefect.orion.schemas.core.Deployment)
- [work_queue](/2.7.11/api-ref/orion/schemas/core/#prefect.orion.schemas.core.WorkQueue)
