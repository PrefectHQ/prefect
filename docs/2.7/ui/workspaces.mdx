...
- Workspaces in an [organization](/2.7.11/ui/organizations/) to which you've been invited and have been given access to organization workspaces.
...
!!! cloud-ad "Workspace-specific features"
    ...
    - [Flows](/2.7.11/concepts/flows/) associated with flow runs or deployments observed by the Prefect Cloud API
...
Your user permissions within workspaces may vary. [Organizations](/2.7.11/ui/organizations/) can assign roles and permissions at the workspace level.
...
Within a Prefect Cloud [organization](/2.7.11/ui/organizations/), Admins and workspace Owners may invite users and [service accounts](/2.7.11/ui/service-accounts/) to work in an organization workspace. In addition to giving the user access to the workspace, the Admin or Owner assigns a [workspace role](/2.7.11/ui/roles/) to the user. The role specifies the scope of permissions for the user within the workspace.
