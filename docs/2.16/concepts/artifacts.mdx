...
![Markdown artifact sales report screenshot](/2.16/img/ui/md-artifact-info.png)
...
![Link artifact details with multiple versions](/2.16/img/ui/link-artifact-info.png)
...
![Markdown sales report screenshot](/2.16/img/ui/md-artifact-info.png)
...
![Table artifact with customer info](/2.16/img/ui/table-artifact-info.png)
