...
- An introductory understanding of Prefect and flow concepts. Start with the [Getting Started](/2.16/getting-started/quickstart/) guide if you're new.
- Prefect CLI installed, following the instructions in the [Prefect documentation](/2.16/getting-started/installation/).
