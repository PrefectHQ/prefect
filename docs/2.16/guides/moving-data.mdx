...
- Prefect [installed](/2.16/getting-started/installation/)
- Authenticated with [Prefect Cloud](/2.16/cloud/cloud-quickstart/) (or self-hosted [Prefect server](/2.16/guides/host/) instance)
...
We can create [blocks](/2.16/concepts/blocks/) via the UI or Python code.
