...
- Workspaces in an [organization](/2.8.7/ui/organizations/) to which you've been invited and have been given access to organization workspaces.
...
!!! cloud-ad "Workspace-specific features"
    ...
    - [Flows](/2.8.7/concepts/flows/) associated with flow runs or deployments observed by the Prefect Cloud API
    ...
    - [Notifications](/2.8.7/ui/notifications/)

Your user permissions within workspaces may vary. [Organizations](/2.8.7/ui/organizations/) can assign roles and permissions at the workspace level.
...
Within a Prefect Cloud [organization](/2.8.7/ui/organizations/), Admins and workspace Owners may invite users and [service accounts](/2.8.7/ui/service-accounts/) to work in an organization workspace. In addition to giving the user access to the workspace, the Admin or Owner assigns a [workspace role](/2.8.7/ui/roles/) to the user. The role specifies the scope of permissions for the user within the workspace.
