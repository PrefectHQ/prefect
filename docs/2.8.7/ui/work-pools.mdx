...
You can create, edit, manage, and delete work pools through the Prefect API server, Prefect Cloud UI, or [Prefect CLI commands](/2.8.7/concepts/work-pools/#work-pool-configuration).
...
See the [Agents & Work Pools](/2.8.7/concepts/work-pools/) documentation for details on configuring agents and work pools, including creating work pools from the Prefect CLI.
