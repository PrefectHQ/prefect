...
2. [Install Prefect](/2.8.7/getting-started/installation/) in the environment in which you want to execute flow runs.
...
You can also log in by providing a [Prefect Cloud API key](/2.8.7/ui/cloud-api-keys/).
