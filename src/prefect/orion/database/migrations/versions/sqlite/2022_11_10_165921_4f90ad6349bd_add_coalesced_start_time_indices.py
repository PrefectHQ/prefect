...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("flow_run", schema=None) as batch_op:
        batch_op.drop_index("ix_flow_run__coalesce_start_time_expected_start_time_desc")
        batch_op.drop_index("ix_flow_run__coalesce_start_time_expected_start_time_asc")
        batch_op.create_index(
            "ix_flow_run__scheduler_deployment_id_auto_scheduled_next_scheduled_start_time",
