...
def upgrade():
    ...
    op.add_column('flow_run', sa.Column('restarts', sa.Integer(), server_default='0', nullable=False))
    op.add_column('task_run', sa.Column('flow_retry_attempt', sa.Integer(), server_default='0', nullable=False))
    op.add_column('task_run', sa.Column('flow_restart_attempt', sa.Integer(), server_default='0', nullable=False))
