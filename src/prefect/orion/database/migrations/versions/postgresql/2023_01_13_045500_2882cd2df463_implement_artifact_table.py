...
def upgrade():
    ...
    sa.Column('task_run_state_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.Column('flow_run_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.Column('flow_run_state_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['flow_run_id'], ['flow_run.id'], name=op.f('fk_artifact__flow_run_id__flow_run')),
    sa.ForeignKeyConstraint(['flow_run_state_id'], ['flow_run_state.id'], name=op.f('fk_artifact__flow_run_state_id__flow_run_state')),
    sa.ForeignKeyConstraint(['task_run_id'], ['task_run.id'], name=op.f('fk_artifact__task_run_id__task_run')),
    sa.ForeignKeyConstraint(['task_run_state_id'], ['task_run_state.id'], name=op.f('fk_artifact__task_run_state_id__task_run_state')),
    ...
    op.add_column('flow_run_state', sa.Column('result_artifact_id', prefect.orion.utilities.database.UUID(), nullable=True))
    ...
    op.add_column('task_run_state', sa.Column('result_artifact_id', prefect.orion.utilities.database.UUID(), nullable=True))
