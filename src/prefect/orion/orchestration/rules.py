    ...
    async def _validate_proposed_state(
        ...
        if self.proposed_state is None:
            ...
            if state_data is not None:
                state_result_artifact = core.Artifact(artifact_data=state_data, flow_run_id=self.run.id)
...
class TaskOrchestrationContext(OrchestrationContext):
    ...
    async def _validate_proposed_state(
        ...
        if self.proposed_state is None:
            ...
            if state_data is not None:
                state_result_artifact = core.Artifact(artifact_data=state_data, task_run_id=self.run.id)
