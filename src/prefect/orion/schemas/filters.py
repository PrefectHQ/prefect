...
class FlowFilterId(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.any_ is not None:
            filters.append(db_interface.Flow.id.in_(self.any_))
        return filters
...
class FlowFilterName(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.Flow.name.in_(self.any_))
        return filters
...
class FlowFilterTags(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.all_ is not None:
            filters.append(json_has_all_keys(db_interface.Flow.tags, self.all_))
        if self.is_null_ is not None:
            filters.append(
                db_interface.Flow.tags == []
                if self.is_null_
                else db_interface.Flow.tags != []
            )
        return filters
...
class FlowFilter(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.id is not None:
            filters.append(await self.id.as_sql_filter())
        if self.name is not None:
            filters.append(await self.name.as_sql_filter())
        if self.tags is not None:
            filters.append(await self.tags.as_sql_filter())
...
class FlowRunFilterId(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.FlowRun.id.in_(self.any_))
        if self.not_any_ is not None:
            filters.append(db_interface.FlowRun.id.not_in(self.not_any_))
        return filters
...
class FlowRunFilterName(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.FlowRun.name.in_(self.any_))
        return filters
...
class FlowRunFilterTags(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        filters = []
        if self.all_ is not None:
            filters.append(json_has_all_keys(db_interface.FlowRun.tags, self.all_))
        if self.is_null_ is not None:
            filters.append(
                db_interface.FlowRun.tags == []
                if self.is_null_
                else db_interface.FlowRun.tags != []
            )
        return filters
...
class FlowRunFilterDeploymentId(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.FlowRun.deployment_id.in_(self.any_))
        if self.is_null_ is not None:
            filters.append(
                db_interface.FlowRun.deployment_id == None
                if self.is_null_
                else db_interface.FlowRun.deployment_id != None
            )
        return filters
...
class FlowRunFilterStateType(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.FlowRun.state_type.in_(self.any_))
        return filters
        ...
        if self.any_ is not None:
            filters.append(
                db_interface.FlowRun.state.has(
                    db_interface.FlowRunState.name.in_(self.any_)
                )
            )
        return filters
...
class FlowRunFilterState(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.type is not None:
            filters.extend(await self.type._get_filter_list())
        if self.name is not None:
            filters.extend(await self.name._get_filter_list())
        return filters
...
class FlowRunFilterFlowVersion(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.FlowRun.flow_version.in_(self.any_))
        return filters
...
class FlowRunFilterStartTime(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.before_ is not None:
            filters.append(db_interface.FlowRun.start_time <= self.before_)
        if self.after_ is not None:
            filters.append(db_interface.FlowRun.start_time >= self.after_)
        if self.is_null_ is not None:
            filters.append(
                db_interface.FlowRun.start_time == None
                if self.is_null_
                else db_interface.FlowRun.start_time != None
            )
        return filters
...
class FlowRunFilterExpectedStartTime(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.before_ is not None:
            filters.append(db_interface.FlowRun.expected_start_time <= self.before_)
        if self.after_ is not None:
            filters.append(db_interface.FlowRun.expected_start_time >= self.after_)
        return filters
...
class FlowRunFilterNextScheduledStartTime(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.before_ is not None:
            filters.append(
                db_interface.FlowRun.next_scheduled_start_time <= self.before_
            )
        if self.after_ is not None:
            filters.append(
                db_interface.FlowRun.next_scheduled_start_time >= self.after_
            )
        return filters
...
class FlowRunFilterParentTaskRunId(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.FlowRun.parent_task_run_id.in_(self.any_))
        if self.is_null_ is not None:
            filters.append(
                db_interface.FlowRun.parent_task_run_id == None
                if self.is_null_
                else db_interface.FlowRun.parent_task_run_id != None
            )
        return filters
...
class FlowRunFilter(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.deployment_id is not None:
            filters.append(await self.deployment_id.as_sql_filter())
        if self.flow_version is not None:
            filters.append(await self.flow_version.as_sql_filter())
        if self.state is not None:
            filters.append(await self.state.as_sql_filter())
        if self.start_time is not None:
            filters.append(await self.start_time.as_sql_filter())
        if self.expected_start_time is not None:
            filters.append(await self.expected_start_time.as_sql_filter())
        if self.next_scheduled_start_time is not None:
            filters.append(await self.next_scheduled_start_time.as_sql_filter())
        if self.parent_task_run_id is not None:
            filters.append(await self.parent_task_run_id.as_sql_filter())
...
class TaskRunFilterId(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.TaskRun.id.in_(self.any_))
        return filters
...
class TaskRunFilterName(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.TaskRun.name.in_(self.any_))
        return filters
...
class TaskRunFilterTags(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        filters = []
        if self.all_ is not None:
            filters.append(json_has_all_keys(db_interface.TaskRun.tags, self.all_))
        if self.is_null_ is not None:
            filters.append(
                db_interface.TaskRun.tags == []
                if self.is_null_
                else db_interface.TaskRun.tags != []
            )
        return filters
...
class TaskRunFilterStateType(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.TaskRun.state_type.in_(self.any_))
        return filters
        ...
        if self.any_ is not None:
            filters.append(
                db_interface.TaskRun.state.has(
                    db_interface.TaskRunState.name.in_(self.any_)
                )
            )
        return filters
...
class TaskRunFilterSubFlowRuns(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.exists_ is True:
            filters.append(db_interface.TaskRun.subflow_run.has())
        elif self.exists_ is False:
            filters.append(sa.not_(db_interface.TaskRun.subflow_run.has()))
        return filters
...
class TaskRunFilterStartTime(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.before_ is not None:
            filters.append(db_interface.TaskRun.start_time <= self.before_)
        if self.after_ is not None:
            filters.append(db_interface.TaskRun.start_time >= self.after_)
        if self.is_null_ is not None:
            filters.append(
                db_interface.TaskRun.start_time == None
                if self.is_null_
                else db_interface.TaskRun.start_time != None
            )
        return filters
...
class TaskRunFilter(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.subflow_runs is not None:
            filters.append(await self.subflow_runs.as_sql_filter())
...
class DeploymentFilterId(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.Deployment.id.in_(self.any_))
        return filters
...
class DeploymentFilterName(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        filters = []
        if self.any_ is not None:
            filters.append(db_interface.Deployment.name.in_(self.any_))
        return filters
...
class DeploymentFilterIsScheduleActive(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.eq_ is not None:
            filters.append(db_interface.Deployment.is_schedule_active.is_(self.eq_))
        return filters
...
class DeploymentFilterTags(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        filters = []
        if self.all_ is not None:
            filters.append(json_has_all_keys(db_interface.Deployment.tags, self.all_))
        if self.is_null_ is not None:
            filters.append(
                db_interface.Deployment.tags == []
                if self.is_null_
                else db_interface.Deployment.tags != []
            )
        return filters
...
class DeploymentFilter(PrefectFilterBaseModel):
    ...
    async def _get_filter_list(self, db_interface=None) -> List:
        ...
        if self.is_schedule_active is not None:
            filters.append(await self.is_schedule_active.as_sql_filter())
        if self.tags is not None:
            filters.append(await self.tags.as_sql_filter())
