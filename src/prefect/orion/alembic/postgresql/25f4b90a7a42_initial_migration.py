...
def upgrade():
    ...
    sa.Column('id', prefect.orion.utilities.database.UUID(), server_default=sa.text('(GEN_RANDOM_UUID())'), nullable=False),
    sa.Column('created', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('tags', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='[]', nullable=False),
    ...
    sa.Column('flow_run_id', prefect.orion.utilities.database.UUID(), nullable=False),
    sa.Column('task_run_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.Column('message', sa.Text(), nullable=False),
    sa.Column('timestamp', prefect.orion.utilities.database.Timestamp(timezone=True), nullable=False),
    ...
    sa.Column('updated', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('filters', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='{}', nullable=False),
    ...
    op.create_table('task_run_state_cache',
    sa.Column('id', prefect.orion.utilities.database.UUID(), server_default=sa.text('(GEN_RANDOM_UUID())'), nullable=False),
    sa.Column('created', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('cache_key', sa.String(), nullable=False),
    sa.Column('cache_expiration', prefect.orion.utilities.database.Timestamp(timezone=True), nullable=True),
    sa.Column('task_run_state_id', prefect.orion.utilities.database.UUID(), nullable=False),
    ...
    sa.Column('updated', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('schedule', prefect.orion.utilities.database.Pydantic(prefect.orion.schemas.schedules.SCHEDULE_TYPES), nullable=True),
    sa.Column('is_schedule_active', sa.Boolean(), server_default='1', nullable=False),
    sa.Column('tags', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='[]', nullable=False),
    sa.Column('parameters', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='{}', nullable=False),
    sa.Column('flow_data', prefect.orion.utilities.database.Pydantic(prefect.orion.schemas.data.DataDocument), nullable=True),
    sa.Column('flow_runner_type', sa.String(), nullable=True),
    sa.Column('flow_runner_config', prefect.orion.utilities.database.JSON(astext_type=Text()), nullable=True),
    sa.Column('flow_id', prefect.orion.utilities.database.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['flow_id'], ['flow.id'], name=op.f('fk_deployment__flow_id__flow'), ondelete='CASCADE'),
    ...
    sa.Column('updated', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('state_type', sa.Enum('SCHEDULED', 'PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='state_type'), nullable=True),
    sa.Column('run_count', sa.Integer(), server_default='0', nullable=False),
    sa.Column('expected_start_time', prefect.orion.utilities.database.Timestamp(timezone=True), nullable=True),
    sa.Column('next_scheduled_start_time', prefect.orion.utilities.database.Timestamp(timezone=True), nullable=True),
    sa.Column('start_time', prefect.orion.utilities.database.Timestamp(timezone=True), nullable=True),
    sa.Column('end_time', prefect.orion.utilities.database.Timestamp(timezone=True), nullable=True),
    ...
    sa.Column('context', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='{}', nullable=False),
    sa.Column('empirical_policy', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='{}', nullable=False),
    sa.Column('tags', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='[]', nullable=False),
    sa.Column('flow_runner_type', sa.String(), nullable=True),
    sa.Column('flow_runner_config', prefect.orion.utilities.database.JSON(astext_type=Text()), nullable=True),
    sa.Column('empirical_config', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='{}', nullable=False),
    sa.Column('auto_scheduled', sa.Boolean(), server_default='0', nullable=False),
    sa.Column('flow_id', prefect.orion.utilities.database.UUID(), nullable=False),
    sa.Column('deployment_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.Column('parent_task_run_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.Column('state_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['deployment_id'], ['deployment.id'], name=op.f('fk_flow_run__deployment_id__deployment'), ondelete='set null'),
    sa.ForeignKeyConstraint(['flow_id'], ['flow.id'], name=op.f('fk_flow_run__flow_id__flow'), ondelete='cascade'),
    sa.ForeignKeyConstraint(['parent_task_run_id'], ['task_run.id'], name=op.f('fk_flow_run__parent_task_run_id__task_run'), ondelete='SET NULL', use_alter=True),
    sa.ForeignKeyConstraint(['state_id'], ['flow_run_state.id'], name=op.f('fk_flow_run__state_id__flow_run_state'), ondelete='SET NULL', use_alter=True),
    ...
    op.create_table('flow_run_state',
    sa.Column('id', prefect.orion.utilities.database.UUID(), server_default=sa.text('(GEN_RANDOM_UUID())'), nullable=False),
    sa.Column('created', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('type', sa.Enum('SCHEDULED', 'PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='state_type'), nullable=False),
    sa.Column('timestamp', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('message', sa.String(), nullable=True),
    sa.Column('state_details', prefect.orion.utilities.database.Pydantic(prefect.orion.schemas.states.StateDetails), server_default='{}', nullable=False),
    sa.Column('data', prefect.orion.utilities.database.Pydantic(prefect.orion.schemas.data.DataDocument), nullable=True),
    sa.Column('flow_run_id', prefect.orion.utilities.database.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['flow_run_id'], ['flow_run.id'], name=op.f('fk_flow_run_state__flow_run_id__flow_run'), ondelete='cascade'),
    ...
    sa.Column('empirical_policy', prefect.orion.utilities.database.Pydantic(prefect.orion.schemas.core.TaskRunPolicy), server_default='{}', nullable=False),
    sa.Column('task_inputs', prefect.orion.utilities.database.Pydantic(Dict[str, List[Union[prefect.orion.schemas.core.TaskRunResult, prefect.orion.schemas.core.Parameter, prefect.orion.schemas.core.Constant]]]), server_default='{}', nullable=False),
    sa.Column('tags', prefect.orion.utilities.database.JSON(astext_type=Text()), server_default='[]', nullable=False),
    sa.Column('flow_run_id', prefect.orion.utilities.database.UUID(), nullable=False),
    sa.Column('state_id', prefect.orion.utilities.database.UUID(), nullable=True),
    sa.ForeignKeyConstraint(['flow_run_id'], ['flow_run.id'], name=op.f('fk_task_run__flow_run_id__flow_run'), ondelete='cascade'),
    sa.ForeignKeyConstraint(['state_id'], ['task_run_state.id'], name=op.f('fk_task_run__state_id__task_run_state'), ondelete='SET NULL', use_alter=True),
    ...
    op.create_table('task_run_state',
    sa.Column('id', prefect.orion.utilities.database.UUID(), server_default=sa.text('(GEN_RANDOM_UUID())'), nullable=False),
    sa.Column('created', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated', prefect.orion.utilities.database.Timestamp(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('type', sa.Enum('SCHEDULED', 'PENDING', 'RUNNING', 'COMPLETED', 'FAILED', 'CANCELLED', name='state_type'), nullable=False),
    ...
    sa.Column('state_details', prefect.orion.utilities.database.Pydantic(prefect.orion.schemas.states.StateDetails), server_default='{}', nullable=False),
    sa.Column('data', prefect.orion.utilities.database.Pydantic(prefect.orion.schemas.data.DataDocument), nullable=True),
    sa.Column('task_run_id', prefect.orion.utilities.database.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['task_run_id'], ['task_run.id'], name=op.f('fk_task_run_state__task_run_id__task_run'), ondelete='cascade'),
    ...
    op.create_foreign_key(constraint_name='fk_flow_run__parent_task_run_id__task_run', source_table='flow_run', referent_table='task_run', local_cols=['parent_task_run_id'], remote_cols=['id'], ondelete='SET NULL')
    op.create_foreign_key(constraint_name='fk_flow_run__state_id__flow_run_state', source_table='flow_run', referent_table='flow_run_state', local_cols=['state_id'], remote_cols=['id'], ondelete='SET NULL')
    op.create_foreign_key(constraint_name='fk_task_run__state_id__task_run_state', source_table='task_run', referent_table='task_run_state', local_cols=['state_id'], remote_cols=['id'], ondelete='SET NULL')
...
def downgrade():
    ...
    op.drop_constraint(constraint_name='fk_flow_run__parent_task_run_id__task_run', table_name='flow_run')
    op.drop_constraint(constraint_name='fk_flow_run__state_id__flow_run_state', table_name='flow_run')
    op.drop_constraint(constraint_name='fk_task_run__state_id__task_run_state', table_name='task_run')
