...
_public_api = {
    ...
    "PendingClaimCreateFields": (__package__, ".pending_claims"),
    "PendingClaimOperationResult": (__package__, ".pending_claims"),
    "PendingClaimReference": (__package__, ".pending_claims"),
    "PendingClaimRunningFields": (__package__, ".pending_claims"),
    "PendingClaimStateDetails": (__package__, ".pending_claims"),
