...
_public_api: dict[str, tuple[str, str]] = {
    ...
    "BlockDocumentReferenceCreate": (
        __spec__.parent,
        ".block_document_reference_create",
    ),
    ...
    "FlowRunNotificationPolicyCreate": (
        __spec__.parent,
        ".flow_run_notification_policy_create",
    ),
    "FlowRunNotificationPolicyUpdate": (
        __spec__.parent,
        ".flow_run_notification_policy_update",
    ),
    "FlowRunUpdate": (__spec__.parent, ".flow_run_update"),
    "FlowUpdate": (__spec__.parent, ".flow_update"),
    "GlobalConcurrencyLimitCreate": (
        __spec__.parent,
        ".global_concurrency_limit_create",
    ),
    "GlobalConcurrencyLimitUpdate": (
        __spec__.parent,
        ".global_concurrency_limit_update",
    ),
