...
class WorkPoolAsyncClient(BaseAsyncClient):
    async def send_worker_heartbeat(
        ...
        resp = await self.request(
            method="POST",
            path="/work_pools/{work_pool_name}/workers/heartbeat",
    ...
    async def read_workers_for_work_pool(
        ...
        response = await self.request(
            method="POST",
            path="/work_pools/{work_pool_name}/workers/filter",
            path_params={"work_pool_name": work_pool_name},
            json={
                "workers": (
    ...
    async def read_work_pools(
        ...
        response = await self.request(
            method="POST", path="/work_pools/filter", json=body
        )
    ...
    async def get_scheduled_flow_runs_for_work_pool(
        ...
        try:
            response = await self.request(
                method="POST",
                path="/work_pools/{name}/get_scheduled_flow_runs",
                path_params={"name": work_pool_name},
                json=body,
            )
        except HTTPStatusError as e:
