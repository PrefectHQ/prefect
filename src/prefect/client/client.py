...
class Client:
    ...
    def __init__(self, api_server: str = None, api_token: str = None):
        ...
        # store api token
        self._api_token = api_token or prefect.config.cloud.get("api_token", None)
    ...
    def _save_local_settings(self, settings: dict) -> None:
        ...
        """
        os.makedirs(self._local_settings_path().parent, exist_ok=True)
        with open(self._local_settings_path(), "w+") as f:
