    ...
    async def create_work_queue(
        ...
        Args:
            ...
            tags: DEPRECATED: an optional list of tags to filter on; only work scheduled with these tags
                will be included in the queue. This feature is planned to be fully deprecated on 2023-02-23.
        ...
        if tags:
            warnings.warn(
                "The use of tags for creating work queue filters is deprecated. This feature is planned to be fully deprecated on 2023-02-23.",
                DeprecationWarning,
            )
