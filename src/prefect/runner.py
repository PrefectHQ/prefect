...
class ProcessJobConfiguration(BaseModel):
...
class Runner:
    ...
    def _event_related_resources(
        self,
        configuration: Optional[ProcessJobConfiguration] = None,
    ...
    def _emit_flow_run_submitted_event(
        self, configuration: ProcessJobConfiguration
    ) -> Event:
        return emit_event(
    ...
    def _emit_flow_run_cancelled_event(
        self, flow_run: "FlowRun", configuration: ProcessJobConfiguration
    ):
        related = self._event_related_resources(configuration=configuration)
