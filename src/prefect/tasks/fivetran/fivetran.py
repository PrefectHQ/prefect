...
class FivetranSyncTask(Task):
    ...
    def run(
        ...
        URL_CONNECTOR: str = "https://api.fivetran.com/v1/connectors/{}".format(connector_id)

        self.logger.info("Attempting start of Fivetran connector {}, sleep time set to {} seconds.".format(
