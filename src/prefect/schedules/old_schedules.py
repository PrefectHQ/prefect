"""
TODO: These schedule classes are DEPRECATED and remain for compatibility only.
"""
...
class Schedule:
    ...
    def __init__(self, start_date: datetime = None, end_date: datetime = None):
        warnings.warn(
            "This Schedule class (prefect.schedules.old_schedules.Schedule) is deprecated "
            "and will be removed from Prefect in the future. "
            "Use prefect.schedules.Schedule instead.",
            UserWarning,
        )
