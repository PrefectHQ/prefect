...
from prefect.types._datetime import create_datetime_instance, to_datetime_string
        ...
        while more_logs:
            ...
            for log in reversed(page_logs) if tail and not reverse else page_logs:
                app.console.print(
                    ...
                    (
                        f"{to_datetime_string(create_datetime_instance(log.timestamp))}.{log.timestamp.microsecond // 1000:03d} |"
