...
def prompt_interval_schedule(console):
    ...
    # The interval value given to `IntervalSchedule` must
    # be a timedelta object in order to pass validation as a `PositiveDuration` type.
    ...
    # rather than seconds, which would confuse users since we ask them to enter
