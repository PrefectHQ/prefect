...
# NOTE: SLA helpers are imported inside functions from the package namespace to
# respect test monkeypatches at `prefect.cli.deploy.*`.
...
async def _run_single_deploy(
    ...
    # Import monkeypatchable helpers from the package at runtime
    from . import (
        confirm,
        is_interactive,
        prompt,
...
async def _run_multi_deploy(
    ...
    # Import monkeypatchable helpers from the package at runtime
    from . import confirm, is_interactive, prompt
