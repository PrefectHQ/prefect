...
class Flow(Generic[P, R]):
    ...
    def serve(
        ...
        paused: Optional[bool] = None,
        schedules: Optional["FlexibleScheduleList"] = None,
        global_deployment_limit: Optional[int] = None,
        triggers: Optional[List[Union[DeploymentTriggerTypes, TriggerTypes]]] = None,
        parameters: Optional[dict] = None,
        description: Optional[str] = None,
        tags: Optional[List[str]] = None,
        ...
        Args:
            ...
            global_deployment_limit: The maximum number of runs using the deployment created that can run concurrently.
            parameters: A dictionary of default parameter values to pass to runs of this deployment.
            description: A description for the created deployment. Defaults to the flow's
                description if not provided.
            tags: A list of tags to associate with the created deployment for organizational
            ...
            limit: The maximum number of runs that can be executed concurrently locally using the created runner.
        ...
        deployment_id = runner.add_flow(
            ...
            paused=paused,
            schedules=schedules,
            concurrency_limit=global_deployment_limit,
            parameters=parameters,
            description=description,
            tags=tags,
            version=version,
