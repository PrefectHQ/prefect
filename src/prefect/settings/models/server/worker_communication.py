...
class ServerWorkerCommunicationSettings(PrefectBaseSettings):
    """
    Settings for server-side worker communication storage and delivery policy.
    """

    model_config: ClassVar[SettingsConfigDict] = build_settings_config(
        ("server", "worker_communication")
    )
