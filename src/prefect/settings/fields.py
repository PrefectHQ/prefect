...
class BasePrefectSettings(BaseSettings):
    ...
    PREFECT_API_DATABASE_CONNECTION_URL: Optional[SecretStr] = Field(
        default=None,
    ...
    PREFECT_API_DATABASE_PASSWORD: Optional[SecretStr] = Field(
        default=None,
    ...
    PREFECT_LOGGING_INTERNAL_LEVEL: Literal[
    ...
    PREFECT_LOGGING_SERVER_LEVEL: Literal[
        "NOTSET", "DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"
    ] = Field(
        default="WARNING",
