...
class Task(Generic[P, R]):
    ...
    def create_local_run_sync(
        ...
        """
        Sync version of create_local_run for use by SyncTaskRunEngine.

        Note: This method does not support deferred tasks. Use create_local_run
        for deferred task creation.
        """
        from prefect.utilities._engine import dynamic_key_for_task_run
        from prefect.utilities.engine import (
            collect_task_run_inputs_sync,
