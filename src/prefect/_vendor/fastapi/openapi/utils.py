...
from prefect._vendor.fastapi._compat import (
    GenerateJsonSchema,
    JsonSchemaValue,
    ModelField,
    Undefined,
...
from prefect._vendor.fastapi.openapi.constants import (
    METHODS_WITH_BODY,
    REF_PREFIX,
    REF_TEMPLATE,
)
...
from prefect._vendor.fastapi.types import ModelNameMap
