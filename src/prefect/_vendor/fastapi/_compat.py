...
from prefect._vendor.fastapi.exceptions import RequestErrorModel
from prefect._vendor.fastapi.types import IncEx, ModelNameMap, UnionType
...
if PYDANTIC_V2:
    ...
    from prefect._vendor.fastapi.openapi.constants import REF_PREFIX as REF_PREFIX
