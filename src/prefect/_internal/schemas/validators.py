...
def raise_on_name_alphanumeric_underscores_only(value: str, field_name: str = "value"):
...
def validate_schema(schema: Union[dict[str, Any], None]):
    """
    ...
    try:
        if schema is not None:
            ...
            jsonschema.Draft202012Validator.check_schema(schema)  # type: ignore
...
def validate_values_conform_to_schema(
    values: dict[str, Any], schema: dict[str, Any], ignore_required: bool = False
):
    """
