...
if HAS_PYDANTIC_V2 and USE_PYDANTIC_V2:
    ...
    class BaseModel(PydanticBaseModel):
        """This class is a compatibility layer for Pydantic v1 models - it exposes select Pydantic v2 functionality.

        Usage docs: https://docs.pydantic.dev/1.10/usage/models/
        """
