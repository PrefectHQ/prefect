            ...
            "variables": {
                ...
                "properties": {
                    "command": {
                        "title": "Command",
                        "description": (
                            "The command to use when starting a flow run. In most"
                            " cases, this should be left blank and the command will be"
                    ...
                    "image": {
                        "title": "Image",
                        "description": (
                            "The image reference of a container image to use for"
                            " created jobs. If not set, the latest Prefect image will"
                            " be used."
                        ),
                    ...
                    "stream_output": {
                        "title": "Stream Output",
                        "description": (
                            "If set, the output from created containers will be"
                    ...
                    "mem_limit": {
                        ...
                        "description": (
                            ...
                            " unit identifier (e.g. 100000b, 1000k, 128m, 1g.) If a"
                            " value is given without a unit, bytes are assumed."
                        ),
                        "type": "string",
                    },
                    "memswap_limit": {
                        ...
                        "description": (
                            "Total memory (memory + swap), -1 to disable swap. Should"
                            " only be set if `mem_limit` is also set. If `mem_limit` is"
                            " set, this defaults toallowing the container to use as"
                            " much swap as memory. For example, if `mem_limit` is 300m"
                            " and `memswap_limit` is not set, containers can use 600m"
                            " in total of memory and swap."
                        ),
                        "type": "string",
                    },
                    "privileged": {
