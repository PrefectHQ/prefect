...
class BaseJobConfiguration(BaseModel):
    ...
    @classmethod
    def _coerce_env(cls, v: dict[str, str | None]) -> dict[str, str | None]:
    ...
    @staticmethod
    def _base_flow_labels(flow: "FlowSchema") -> dict[str, str]:
        return {
...
class BaseWorker(abc.ABC):
    ...
    job_configuration_variables: type[BaseVariables] | None = None
    ...
    def __init__(
        ...
        *,
        ...
        self.backend_id: UUID | None = None
        self._logger = get_worker_logger(self)

        self.is_setup: bool = False
        self._create_pool_if_not_found: bool = create_pool_if_not_found
        self._base_job_template: dict[str, Any] | None = base_job_template
        self._work_pool_name: str = work_pool_name
        ...
        self._worker_metadata_sent: bool = False
    ...
    @staticmethod
    def get_worker_class_from_type(type: str) -> type["BaseWorker"] | None:
        """
    ...
    async def _schedule_task(
        ...
        async def wrapper(task_status: anyio.abc.TaskStatus[Any]) -> None:
