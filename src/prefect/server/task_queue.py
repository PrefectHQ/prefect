...
class TaskQueue:
    ...
    default_scheduled_max_size: int = SETTINGS.task_scheduling_max_scheduled_queue_size
    default_retry_max_size: int = SETTINGS.task_scheduling_max_retry_queue_size
