...
def test_cloud_run_decorator_sync_flow(mock_submit: AsyncMock) -> None:
...
async def test_cloud_run_decorator_async_flow(mock_submit: AsyncMock) -> None:
...
def test_cloud_run_decorator_return_state() -> None:
...
@pytest.mark.usefixtures("mock_submit")
def test_cloud_run_decorator_preserves_flow_attributes() -> None:
