...
def temp_profiles_dir(tmp_path: Path) -> Path:
    """Create a temporary profiles directory with a profiles.yml file."""
...
def temp_project_dir(tmp_path: Path) -> Path:
    """Create a temporary project directory with a dbt_project.yml file."""
...
class TestValidateForOrchestrator:
    ...
    def test_valid_paths_pass_validation(
        ...
        """Test that valid paths pass validation without errors."""
        settings = PrefectDbtSettings(
...
class TestPrefectDbtSettingsInitialization:
    ...
    def test_initializes_with_defaults(
        ...
        mock_get_current_settings: Mock,
    ):
    ...
    def test_uses_prefect_logging_level_when_not_set(
        ...
        temp_profiles_dir: Path,
        temp_project_dir: Path,
        mock_get_current_settings_error: Mock,
    ):
    ...
    def test_environment_variable_loading(
        ...
        monkeypatch.setenv("DBT_PROJECT_DIR", str(temp_project_dir))
...
class TestPrefectDbtSettingsProfilesLoading:
    ...
    def test_load_profiles_yml_success(
        ...
        temp_profiles_dir: Path,
        temp_project_dir: Path,
        sample_profiles_yml: dict[str, Any],
    ):
    ...
    def test_load_profiles_yml_invalid_yaml(
        self, temp_profiles_dir: Path, temp_project_dir: Path
    ):
    ...
    def test_load_profiles_yml_empty_file(
        self, temp_profiles_dir: Path, temp_project_dir: Path
    ):
