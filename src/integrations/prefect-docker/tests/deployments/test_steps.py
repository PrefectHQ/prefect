...
def mock_datetime(monkeypatch: pytest.MonkeyPatch):
    mock_datetime = MagicMock(name="prefect_datetime")
...
class TestBuildxBackend:
    @mock.patch("prefect._internal.buildx.buildx_build_image")
    ...
    @mock.patch("prefect._internal.buildx.buildx_push_image")
