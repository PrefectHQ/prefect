...
#             - name: docker-desktop
#             user:
#                 client-certificate: {self._cert_file}
#                 client-key: {self._cert_key}
#         """
...
#         ],
#     )
#     async def test_client_return_type(self,kubernetes_credentials, resource_type, client_type):
...
#     async def test_instantiation_from_str(self):
#         cluster_config = KubernetesClusterConfig(
