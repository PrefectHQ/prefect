...
- Add ability to restart Kubernetes job events watch by allowing `KubernetesJob._watch_job` to track long-running jobs - https://github.com/PrefectHQ/prefect/pull/8189
