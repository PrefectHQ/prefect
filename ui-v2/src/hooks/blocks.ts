...
type BlockDocumentKeys = {
  ...
  count: (options?: components["schemas"]["BlockDocumentFilter"]) => readonly string[];
};
...
const buildBlockDocumentsQuery = (params: Parameters<typeof getBlockDocuments>[0] = {}) =>
  queryOptions({
...
export const useBlockDocuments = (
  ...
  options: Omit<UseQueryOptions<BlockDocumentsResponse>, 'queryKey' | 'queryFn'> = {}
) => {
  return useQuery({
...
type BlockDocumentsCountResponse = Awaited<ReturnType<typeof getBlockDocumentsCount>>;
...
const buildBlockDocumentsCountQuery = (params: Parameters<typeof getBlockDocumentsCount>[0] = {}) =>
  queryOptions({
...
export const useBlockDocumentsCount = (
  ...
  options: Omit<UseQueryOptions<BlockDocumentsCountResponse>, 'queryKey' | 'queryFn'> = {}
) => {
  return useQuery({
...
export const useBlockDocument = (
  id: string,
  options: Omit<UseQueryOptions<BlockDocumentResponse>, 'queryKey' | 'queryFn'> = {}
) => {
  return useQuery({
...
export const useCreateBlockDocument = () => {
  ...
  const { mutate: createBlockDocument, ...rest } = useMutation({
    mutationFn: async (blockDocument: components["schemas"]["BlockDocument"]) => {
