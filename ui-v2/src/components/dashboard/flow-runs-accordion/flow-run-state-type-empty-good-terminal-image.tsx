...
type FlowRunStateTypeEmptyGoodTerminalImageProps = SVGProps<SVGSVGElement>;

export function FlowRunStateTypeEmptyGoodTerminalImage(
	props: FlowRunStateTypeEmptyGoodTerminalImageProps,
) {
	return (
		<svg
			viewBox="0 0 111 110"
			...
			role="img"
			aria-label="No completed flow runs"
			{...props}
		>
			<rect
				x="54.4553"
