...
type FlowRunStateTypeEmptyLiveImageProps = SVGProps<SVGSVGElement>;

export function FlowRunStateTypeEmptyLiveImage(
	props: FlowRunStateTypeEmptyLiveImageProps,
) {
	return (
		<svg
			viewBox="0 0 129 128"
			...
			role="img"
			aria-label="No running flow runs"
			{...props}
		>
			<rect
				x="52.4965"
