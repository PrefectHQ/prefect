...
type FlowRunStateTypeEmptyBadTerminalImageProps = SVGProps<SVGSVGElement>;

export function FlowRunStateTypeEmptyBadTerminalImage(
	props: FlowRunStateTypeEmptyBadTerminalImageProps,
) {
	return (
		<svg
			viewBox="0 0 157 128"
			...
			role="img"
			aria-label="No failed flow runs"
			{...props}
		>
			<rect
				x="16.2571"
