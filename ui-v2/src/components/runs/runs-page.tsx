...
type RunsPageProps = {
	...
	taskRunPagination: PaginationState;
	onTaskRunPaginationChange: (pagination: PaginationState) => void;
	onPrefetchTaskRunPage?: (page: number) => void;
	taskRunSort: TaskRunSortFilters;
	onTaskRunSortChange: (sort: TaskRunSortFilters) => void;
...
export const RunsPage = ({
	...
	taskRunsPages,
	taskRunPagination,
	onTaskRunPaginationChange,
	onPrefetchTaskRunPage,
	taskRunSort,
	onTaskRunSortChange,
	taskRunSearch,
					...
					<div className="flex flex-col gap-4">
						<div className="flex items-center justify-between">
							<TaskRunsRowCount
								count={taskRunsCount}
								results={taskRuns}
								selectedRows={selectedTaskRunRows}
								setSelectedRows={setSelectedTaskRunRows}
							/>
							<div className="flex items-center gap-4">
								<SearchInput
									value={taskRunSearch}
						...
						<FlowRunsPagination
							count={taskRunsCount}
							pages={taskRunsPages}
							pagination={taskRunPagination}
							onChangePagination={onTaskRunPaginationChange}
							onPrefetchPage={onPrefetchTaskRunPage}
						/>
						<TaskRunsList
							taskRuns={taskRuns}
							selectedRows={selectedTaskRunRows}
