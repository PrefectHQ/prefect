...
export type PrefectKindWorkspaceVariable = BasePrefectKindValue<
	"workspace_variable",
	{
...
export function isPrefectKindWorkspaceVariable(
	value: unknown,
): value is PrefectKindWorkspaceVariable {
	return (
