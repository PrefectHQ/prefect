 ...
 */
export function isObjectSchema(schema: SchemaObject | ReferenceObject): schema is SchemaObject {
 ...
 */
export function hasProperties(schema: SchemaObject): schema is SchemaObject & { properties: Record<string, unknown> } {
 ...
 */
export function getParameterValues(value: unknown, schema: SchemaObject | ReferenceObject): unknown {
