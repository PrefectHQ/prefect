...
import type { SchemaObject, ReferenceObject } from "openapi-typescript";
...
describe("SchemaFormInputAnyOf", () => {
  it.only("renders the correct fields for each model and preserves shared parameter values", () => {
    let value = { shared_parameter: "foo", unique_1: 1 };
    const handleChange = vi.fn(v => { value = v; });
