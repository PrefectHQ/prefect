...
import { ConcurrencyLimitTaskRunCard } from "./concurrency-limit-task-run-card";
...
const meta: Meta<typeof ConcurrencyLimitTaskRunCard> = {
	title: "UI/ConcurrencyLimitTaskRunCard",
	decorators: [routerDecorator],
	component: ConcurrencyLimitTaskRunCard,
	args: {
		flow: MOCK_FLOW,
...
export const story: StoryObj = { name: "ConcurrencyLimitTaskRunCard" };
