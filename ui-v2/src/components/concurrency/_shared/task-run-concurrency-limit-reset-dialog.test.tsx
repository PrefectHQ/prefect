import { TaskRunConcurrencyLimitResetDialog } from "./task-run-concurrency-limit-reset-dialog";
...
test("TaskRunConcurrencyLimitResetDialog can successfully call delete", async () => {
