...
export const StatusCell = ({
	getValue,
}: CellContext<components["schemas"]["WorkPool"], boolean>) => {
...
export const ConcurrencyCell = ({
	getValue,
}: CellContext<components["schemas"]["WorkPool"], number | null>) => {
...
export const UpdatedCell = ({
	getValue,
}: CellContext<components["schemas"]["WorkPool"], string>) => {
...
export const ActionsCell = ({
	row,
}: CellContext<components["schemas"]["WorkPool"], unknown>) => {
			...
			<DropdownMenu>
				...
				<DropdownMenuContent align="end">
					<DropdownMenuItem asChild>
						<Link
							to="/work-pools/work-pool/$name"
							params={{ name: workPool.name }}
						>
							Edit
						</Link>
					</DropdownMenuItem>
