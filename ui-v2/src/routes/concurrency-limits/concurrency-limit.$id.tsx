import { TaskRunConcurrencyLimitDetailsPage } from "@/components/concurrency/task-run-concurrency-limit-details";
...
function RouteComponent() {
	...
	return <TaskRunConcurrencyLimitDetailsPage id={id} />;
}
