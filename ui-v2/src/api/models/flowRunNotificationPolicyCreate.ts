 ...
 */
import type { FlowRunNotificationPolicyCreateMessageTemplate } from "./flowRunNotificationPolicyCreateMessageTemplate";

/**
 * Data used by the Prefect REST API to create a flow run notification policy.
 */
export interface FlowRunNotificationPolicyCreate {
	...
	message_template?: FlowRunNotificationPolicyCreateMessageTemplate;
}
