...
export const createEventsEventsPostBody = zod.array(createEventsEventsPostBodyItem)
...
export const readEventsEventsFilterPostBodyFilterResourceDistinctDefault = false;export const readEventsEventsFilterPostBodyLimitDefault = 50;
...
export const readEventsEventsFilterPostBody = zod.object({
  ...
  "any_resource": zod.object({
  "id": zod.array(zod.string()).or(zod.null()).optional(),
  "id_prefix": zod.array(zod.string()).or(zod.null()).optional(),
  "labels": zod.record(zod.string(), zod.string().or(zod.array(zod.string()))).or(zod.null()).optional()
}).or(zod.null()).optional(),
  "resource": zod.object({
  "id": zod.array(zod.string()).or(zod.null()).optional(),
  "id_prefix": zod.array(zod.string()).or(zod.null()).optional(),
  ...
  "resources_in_roles": zod.array(zod.tuple([zod.string(),
zod.string()])).or(zod.null()).optional(),
  "labels": zod.record(zod.string(), zod.string().or(zod.array(zod.string()))).or(zod.null()).optional()
}).or(zod.null()).optional(),
  "id": zod.object({
  ...
  "limit": zod.number().min(readEventsEventsFilterPostBodyLimitMin).max(readEventsEventsFilterPostBodyLimitMax).default(readEventsEventsFilterPostBodyLimitDefault)
})
...
export const countAccountEventsEventsCountByCountablePostBodyFilterResourceDistinctDefault = false;export const countAccountEventsEventsCountByCountablePostBodyTimeIntervalDefault = 1;
...
zod.string()])).or(zod.null()).optional(),
  ...
  "time_interval": zod.number().min(countAccountEventsEventsCountByCountablePostBodyTimeIntervalMin).default(countAccountEventsEventsCountByCountablePostBodyTimeIntervalDefault)
})

export const countAccountEventsEventsCountByCountablePostResponseItem = zod.object({
  "value": zod.string(),
  "label": zod.string(),
  "count": zod.number(),
...
export const countAccountEventsEventsCountByCountablePostResponse = zod.array(countAccountEventsEventsCountByCountablePostResponseItem)
