<template>
  <div class="not-found">
    <svg width="607" height="511" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <img class="not-found__bg not-found__bg--top" src="@/assets/not-found/not-found-bg-top.svg" />
    <img class="not-found__bg not-found__bg--bottom" src="@/assets/not-found/not-found-bg-bottom.svg" />
  </div>
</template>
...
export default class NotFound extends Vue {
  ...
  private startAnimation() {
    const delay = this.randomNumber(2, 3) * 1000
    this.interval = window.setTimeout(this.animateRandomCircle, delay)
  }

  private animateRandomCircle() {
