...
export const routes = {
  ...
  deploymentOld: (id: string) => ({ name: 'deployment-old', params: { id } }) as const,
  ...
  flowOld: (id: string) => ({ name: 'flow-old', params: { id } }) as const,
  ...
  flowRunsOld: () => ({ name: 'flow-runs-old' }) as const,
  flowRunOld: (id: string) => ({ name: 'flow-run-old', params: { id } }) as const,
  ...
  workQueueOld: (id: string) => ({ name: 'work-queue-old', params: { id } }) as const,
  ...
  blockOld: (blockDocumentId: string) => ({ name: 'block-old', params: { blockDocumentId } }) as const,
