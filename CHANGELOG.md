...
- The `manual_only` trigger will pass if `resume=True` is found in context, which indicates that a `Resume` state was passed - [#666](https://github.com/PrefectHQ/prefect/pull/666)
