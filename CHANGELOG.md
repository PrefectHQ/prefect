...
- Updating ShellTask to work more like Airflow Bash Operator for streaming logs and returning values, which changes behavior of task - [#1451](https://github.com/PrefectHQ/prefect/pull/1451)
### Contributors
