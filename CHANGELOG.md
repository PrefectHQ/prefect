...
- Refactor all `State` objects to store fully hydrated `Result` objects which track information about how results should be handled - [#616](https://github.com/PrefectHQ/prefect/pull/616)
