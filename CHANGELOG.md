...
- Flow `Environment`s have been removed; use `RunConfig`s instead. - [#5072](https://github.com/PrefectHQ/prefect/pull/5072), [docs](https://docs.prefect.io/v2/orchestration/flow_config/upgrade.html)
...
- New flow run configuration system based on `RunConfig` types, see [here](https://docs.prefect.io/v2/orchestration/flow_config/overview.html) for more info
...
- Introducing new [Results](https://docs.prefect.io/v2/core/concepts/results.html) interface for working with task results - [#2507](https://github.com/PrefectHQ/prefect/pull/2507)
...
- Add option to [set secrets on Storage objects](https://docs.prefect.io/v2/orchestration/recipes/third_party_auth.html#declaring-secrets-on-storage) - [#2507](https://github.com/PrefectHQ/prefect/pull/2507)
- Add reserved [default Secret names](https://docs.prefect.io/v2/orchestration/recipes/third_party_auth.html#list-of-default-secret-names) and formats for working with cloud platforms - [#2507](https://github.com/PrefectHQ/prefect/pull/2507)
