...
- Updating ShellTask to work more like Airflow Bash Operator for streaming logs and returning values, which changes behavior of task - [#1448](https://github.com/PrefectHQ/prefect/pull/1448)
